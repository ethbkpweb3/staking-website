...
let x = class extends HTMLElement {
    ...
    addController(t) {
        ...
        this.renderRoot !== void 0 && this.isConnected && ((i = t.hostConnected) === null || i === void 0 || i.call(t))
    }
    removeController(t) {
        var n;
    ...
    createRenderRoot() {
        ...
        return un(n, this.constructor.elementStyles),
        n
    }
    connectedCallback() {
        var t;
    ...
    requestUpdate(t, n, i) {
        let r = !0;
        t !== void 0 && (((i = i || this.constructor.getPropertyOptions(t)).hasChanged || Be)(this[t], n) ? (this._$AL.has(t) || this._$AL.set(t, n),
        i.reflect === !0 && this._$El !== t && (this._$EC === void 0 && (this._$EC = new Map),
    ...
    performUpdate() {
        ...
        if (!this.isUpdatePending)
            return;
        this.hasUpdated,
        this._$Ei && (this._$Ei.forEach( (r, s) => this[s] = r),
        this._$Ei = void 0);
        let n = !1;
        const i = this._$AL;
        try {
    ...
    update(t) {
        this._$EC !== void 0 && (this._$EC.forEach( (n, i) => this._$EO(i, this[i], n)),
        this._$EC = void 0),
        this._$Ek()
    }
    updated(t) {}
...
const gn = (e, t) => {
    ...
    for (let l = 0; l < n; l++) {
        const a = e[l];
        let c, u, f = -1, h = 0;
        for (; h < a.length && (o.lastIndex = h,
        u = o.exec(a),
        u !== null); )
            h = o.lastIndex,
            o === Z ? u[1] === "!--" ? o = de : u[1] !== void 0 ? o = fe : u[2] !== void 0 ? (Re.test(u[2]) && (r = RegExp("</" + u[2], "g")),
            o = k) : u[3] !== void 0 && (o = k) : o === k ? u[0] === ">" ? (o = r ?? Z,
            f = -1) : u[1] === void 0 ? f = -2 : (f = o.lastIndex - u[2].length,
            c = u[1],
            o = u[3] === void 0 ? k : u[3] === '"' ? pe : ge) : o === pe || o === ge ? o = k : o === de || o === fe ? o = Z : (o = k,
            r = void 0);
        const d = o === k && e[l + 1].startsWith("/>") ? " " : "";
        s += o === Z ? a + dn : f >= 0 ? (i.push(c),
        a.slice(0, f) + jt + a.slice(f) + U + d) : a + U + (f === -2 ? (i.push(void 0),
        l) : d)
    }
...
class rt {
    constructor({strings: t, _$litType$: n}, i) {
        ...
        const l = t.length - 1
          , a = this.parts
          , [c,u] = gn(t, n);
        if (this.el = rt.createElement(c, i),
        F.currentNode = this.el.content,
        n === 2) {
            const f = this.el.content
              , h = f.firstChild;
            h.remove(),
            f.append(...h.childNodes)
        }
...
function J(e, t, n=e, i) {
    ...
    return (a == null ? void 0 : a.constructor) !== c && ((s = a == null ? void 0 : a._$AO) === null || s === void 0 || s.call(a, !1),
    c === void 0 ? a = void 0 : (a = new c(e),
    a._$AT(e, n, i)),
    i !== void 0 ? ((o = (l = n)._$Co) !== null && o !== void 0 ? o : l._$Co = [])[i] = a : n._$Cl = a),
...
class pn {
    ...
    u(t) {
        ...
        const {el: {content: i}, parts: r} = this._$AD
          , s = ((n = t == null ? void 0 : t.creationScope) !== null && n !== void 0 ? n : H).importNode(i, !0);
        F.currentNode = s;
        let o = F.nextNode()
          , l = 0
          , a = 0
        ...
        for (; c !== void 0; ) {
            if (l === c.index) {
                let u;
                c.type === 2 ? u = new at(o,o.nextSibling,this,t) : c.type === 1 ? u = new c.ctor(o,c.name,c.strings,this,t) : c.type === 6 && (u = new vn(o,this,t)),
                this._$AV.push(u),
                c = r[++a]
            }
            l !== (c == null ? void 0 : c.index) && (o = F.nextNode(),
            l++)
        }
        return F.currentNode = H,
        s
    }
    v(t) {
        let n = 0;
        for (const i of this._$AV)
            i !== void 0 && (i.strings !== void 0 ? (i._$AI(t, i, n),
...
class at {
    constructor(t, n, i, r) {
        ...
        this._$AM = i,
        this.options = r,
        this._$Cp = (s = r == null ? void 0 : r.isConnected) === null || s === void 0 || s
    }
    get _$AU() {
        var t, n;
    ...
    _$AI(t, n=this) {
        t = J(this, t, n),
        it(t) ? t === b || t == null || t === "" ? (this._$AH !== b && this._$AR(),
        this._$AH = b) : t !== this._$AH && t !== z && this._(t) : t._$litType$ !== void 0 ? this.g(t) : t.nodeType !== void 0 ? this.$(t) : fn(t) ? this.T(t) : this._(t)
    }
    k(t) {
    ...
    _(t) {
        this._$AH !== b && it(this._$AH) ? this._$AA.nextSibling.data = t : this.$(H.createTextNode(t)),
        this._$AH = t
    }
    g(t) {
        var n;
        const {values: i, _$litType$: r} = t
          , s = typeof r == "number" ? this._$AC(t) : (r.el === void 0 && (r.el = rt.createElement(Ue(r.h, r.h[0]), this.options)),
        r);
    ...
    _$AC(t) {
        ...
        return n === void 0 && me.set(t.strings, n = new rt(t)),
        n
    }
    T(t) {
        Ne(this._$AH) || (this._$AH = [],
        this._$AR());
        const n = this._$AH;
        let i, r = 0;
        for (const s of t)
            r === n.length ? n.push(i = new at(this.k(nt()),this.k(nt()),this,this.options)) : i = n[r],
            i._$AI(s),
            r++;
        r < n.length && (this._$AR(i && i._$AB.nextSibling, r),
        n.length = r)
    }
...
ye == null || ye(rt, at),
((Bt = pt.litHtmlVersions) !== null && Bt !== void 0 ? Bt : pt.litHtmlVersions = []).push("2.8.0");
const wn = (e, t, n) => {
    var i, r;
...
class ft extends x {
    ...
    createRenderRoot() {
        ...
        return (t = (n = this.renderOptions).renderBefore) !== null && t !== void 0 || (n.renderBefore = i.firstChild),
        i
    }
    update(t) {
        const n = this.render();
        ...
        super.update(t),
        this._$Do = wn(n, this.renderRoot, this.renderOptions)
    }
    connectedCallback() {
        var t;
...
ft.finalized = !0,
ft._$litElement$ = !0,
(Nt = globalThis.litElementHydrateSupport) === null || Nt === void 0 || Nt.call(globalThis, {
    LitElement: ft
});
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const lr = e => t => typeof t == "function" ? ( (n, i) => (customElements.define(n, i),
i))(e, t) : ( (n, i) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const $n = (e, t) => t.kind === "method" && t.descriptor && !("value"in t.descriptor) ? {
    ...t,
    finisher(n) {
...
const ur = bn(class extends Tn {
    constructor(e) {
        var t;
        if (super(e),
        e.type !== Sn.ATTRIBUTE || e.name !== "class" || ((t = e.strings) === null || t === void 0 ? void 0 : t.length) > 2)
    ...
    update(e, [t]) {
        ...
        if (this.it === void 0) {
            this.it = new Set,
            e.strings !== void 0 && (this.nt = new Set(e.strings.join(" ").split(/\s/).filter(s => s !== "")));
            for (const s in t)
                t[s] && !(!((n = this.nt) === null || n === void 0) && n.has(s)) && this.it.add(s);
        ...
        for (const s in t) {
            const o = !!t[s];
            o === this.it.has(s) || !((i = this.nt) === null || i === void 0) && i.has(s) || (o ? (r.add(s),
            this.it.add(s)) : (r.remove(s),
            this.it.delete(s)))
        }
        return z
    }
...
class ze {
    constructor(t, n=[0, 1], {easing: i, duration: r=P.duration, delay: s=P.delay, endDelay: o=P.endDelay, repeat: l=P.repeat, offset: a, direction: c="normal"}={}) {
        ...
        this.tick = f => {
            ...
            s = s;
            let d = 0;
            this.pauseTime !== void 0 ? d = this.pauseTime : d = (f - this.startTime) * this.rate,
            this.t = d,
            d /= 1e3,
            d = Math.max(d - s, 0),
            this.playState === "finished" && this.pauseTime === void 0 && (d = this.totalDuration);
            ...
            const E = d >= this.totalDuration ? 1 : Math.min(C, 1)
              , p = u(this.easing(E));
            t(p),
            this.pauseTime === void 0 && (this.playState === "finished" || d >= this.totalDuration + o) ? (this.playState = "finished",
            (h = this.resolve) === null || h === void 0 || h.call(this, p)) : this.playState !== "idle" && (this.frameRequestId = requestAnimationFrame(this.tick))
        }
        ,
        this.play()
    }
...
const jn = (e, t) => At.indexOf(e) - At.indexOf(t)
  ...
  , Jn = (e, t) => {
    yt[t] && (t = yt[t]);
    const {transforms: n} = xe(e);
    Pn(n, t),
    e.style.transform = Yn(n)
}
...
const ct = {
    ...
    set: (e, t, n) => {
        t = Yt(t),
        Jt(t) ? e.style.setProperty(t, n) : e.style[t] = n
    }
};
function je(e, t=!0) {
...
function ii(e, t, n, i={}, r) {
    const s = ni()
      , o = i.record !== !1 && s;
    let l, {duration: a=P.duration, delay: c=P.delay, endDelay: u=P.endDelay, repeat: f=P.repeat, easing: h=P.easing, persist: d=!1, direction: A, offset: y, allowWebkitAcceleration: C=!1} = i;
    const m = xe(e)
      , E = Ve(t);
    let p = V.waapi();
    E && Jn(e, t);
    ...
    () => {
        ...
        if (Jt(g) && (V.cssRegisterProperty() ? Gn(g) : p = !1),
        E && !V.linearEasing() && (Y(h) || j(h) && h.some(Y)) && (p = !1),
        p) {
            w && ($ = $.map(N => mt(N) ? w.toDefaultUnit(N) : N)),
            ...
            l.finished || (l.finished = new Promise( (N, R) => {
                l.onfinish = N,
                l.oncancel = R
            }
            ));
...
function si(e, t) {
    var n;
    return typeof e == "string" ? t ? ((n = t[e]) !== null && n !== void 0 || (t[e] = document.querySelectorAll(e)),
...
const oi = e => e()
  ...
  , li = {
    get: (e, t) => {
        ...
        case "finished":
            return e.finished || (e.finished = Promise.all(e.animations.map(ci)).catch(Oe)),
            e.finished;
        case "stop":
            return () => {
...
(function(e) {
    ...
    e.getPositions = function(i) {
        ...
        for (let l = 0; l < o; l++)
            for (let a = 0; a < o; a++)
                l === 0 && a === 0 || l === 0 && a === o - 1 || l === o - 1 && a === 0 || r.push([s[l], s[a]]);
        return r
    }
}
)(qe);
...
(function(e) {
    ...
    e.getPenaltyN1 = function(r) {
        ...
        for (let f = 0; f < s; f++) {
            ...
            for (let h = 0; h < s; h++) {
                let d = r.get(f, h);
                d === c ? l++ : (l >= 5 && (o += t.N1 + (l - 5)),
                c = d,
                l = 1),
                d = r.get(h, f),
                d === u ? a++ : (a >= 5 && (o += t.N1 + (a - 5)),
                u = d,
                a = 1)
            }
            l >= 5 && (o += t.N1 + (l - 5)),
    ...
    e.getPenaltyN3 = function(r) {
        ...
        for (let c = 0; c < s; c++) {
            l = a = 0;
            for (let u = 0; u < s; u++)
                l = l << 1 & 2047 | r.get(c, u),
                u >= 10 && (l === 1488 || l === 93) && o++,
                a = a << 1 & 2047 | r.get(u, c),
                u >= 10 && (a === 1488 || a === 93) && o++
        }
        return o * t.N3
    }
    ...
    e.applyMask = function(r, s) {
        ...
        for (let l = 0; l < o; l++)
            for (let a = 0; a < o; a++)
                s.isReserved(a, l) || s.xor(a, l, n(r, a, l))
    }
    ,
...
ie.prototype.initialize = function(t) {
    this.degree = t,
    this.genPoly = Ze.generateECPolynomial(this.degree)
}
;
...
(function(e) {
    ...
    function f(h, d) {
        for (let A = 1; A <= 40; A++)
            if (u(h, A) <= e.getCapacity(A, d, r.MIXED))
                return A
    }
    e.from = function(d, A) {
    ...
    e.getEncodedBits = function(d) {
        if (!s.isValid(d) || d < 7)
            throw new Error("Invalid QR Code version");
        let A = d << 12;
        for (; t.getBCHDigit(A) - l >= 0; )
            A ^= o << t.getBCHDigit(A) - l;
        return d << 12 | A
    }
}
)(Xe);
...
en.getEncodedBits = function(t, n) {
    const i = t.bit << 3 | n;
    let r = i << 10;
    for (; qt.getBCHDigit(r) - be >= 0; )
        r ^= nn << qt.getBCHDigit(r) - be;
    return (i << 10 | r) ^ Si
}
;
var rn = {};
...
q.prototype.write = function(t) {
    ...
    for (n = 0; n + 3 <= this.data.length; n += 3)
        i = this.data.substr(n, 3),
        r = parseInt(i, 10),
        t.put(r, 10);
    const s = this.data.length - n;
    s > 0 && (i = this.data.substr(n),
    r = parseInt(i, 10),
    t.put(r, s * 3 + 1))
}
;
  ...
  , Mi = function(t) {
    for (var n = [], i = t.length, r = 0; r < i; r++) {
        ...
        if (s >= 55296 && s <= 56319 && i > r + 1) {
            ...
            o >= 56320 && o <= 57343 && (s = (s - 55296) * 1024 + o - 56320 + 65536,
            r += 1)
        }
        if (s < 128) {
            n.push(s);
...
(function(e) {
    var t = {
        ...
        PriorityQueue: {
            make: function(n) {
                var i = t.PriorityQueue, r = {}, s;
                n = n || {};
                for (s in i)
                    i.hasOwnProperty(s) && (r[s] = i[s]);
                return r.queue = [],
                r.sorter = n.sorter || i.default_sorter,
                r
            },
...
(function(e) {
    ...
    function f(m) {
        ...
        let g, v;
        return l.isKanjiModeEnabled() ? (g = u(o.BYTE, t.BYTE, m),
        v = u(o.KANJI, t.KANJI, m)) : (g = u(o.BYTE_KANJI, t.BYTE, m),
        v = []),
        E.concat(p, g, v).sort(function(S, $) {
    ...
    function d(m) {
        return m.reduce(function(E, p) {
            ...
            return g && g.mode === p.mode ? (E[E.length - 1].data += p.data,
            E) : (E.push(p),
            E)
        }, [])
    }
        ...
        for (let w = 0; w < m.length; w++) {
            ...
            for (let B = 0; B < S.length; B++) {
                ...
                for (let N = 0; N < v.length; N++) {
                    const R = v[N];
                    p[R] && p[R].node.mode === _.mode ? (g[R][M] = h(p[R].lastCount + _.length, _.mode) - h(p[R].lastCount, _.mode),
                    p[R].lastCount += _.length) : (p[R] && (p[R].lastCount = _.length),
                    g[R][M] = h(_.length, _.mode) + 4 + t.getCharCountIndicator(_.mode, E))
                }
            }
            v = $
        }
 ...
 Suggested mode is: ` + t.toString(g));
    ...
    e.fromArray = function(E) {
        return E.reduce(function(p, g) {
            return typeof g == "string" ? p.push(C(g, null)) : g.data && p.push(C(g.data, g.mode)),
            p
        }, [])
    }
    ,
...
function Ki(e, t) {
    ...
    for (let r = 0; r < i.length; r++) {
        ...
        for (let l = -1; l <= 7; l++)
            if (!(s + l <= -1 || n <= s + l))
                for (let a = -1; a <= 7; a++)
                    o + a <= -1 || n <= o + a || (l >= 0 && l <= 6 && (a === 0 || a === 6) || a >= 0 && a <= 6 && (l === 0 || l === 6) || l >= 2 && l <= 4 && a >= 2 && a <= 4 ? e.set(s + l, o + a, !0, !0) : e.set(s + l, o + a, !1, !0))
    }
}
function Ji(e) {
    const t = e.size;
...
function Yi(e, t) {
    ...
    for (let i = 0; i < n.length; i++) {
        ...
        for (let o = -2; o <= 2; o++)
            for (let l = -2; l <= 2; l++)
                o === -2 || o === 2 || l === -2 || l === 2 || o === 0 && l === 0 ? e.set(r + o, s + l, !0, !0) : e.set(r + o, s + l, !1, !0)
    }
}
function qi(e, t) {
    const n = e.size
...
function Ht(e, t, n) {
    ...
    for (s = 0; s < 15; s++)
        o = (r >> s & 1) === 1,
        s < 6 ? e.set(s, 8, o, !0) : s < 8 ? e.set(s + 1, 8, o, !0) : e.set(i - 15 + s, 8, o, !0),
        s < 8 ? e.set(8, i - s - 1, o, !0) : s < 9 ? e.set(8, 15 - s - 1 + 1, o, !0) : e.set(8, 15 - s - 1, o, !0);
    e.set(i - 8, 8, 1, !0)
}
function Gi(e, t) {
    const n = e.size;
...
function Wi(e, t, n) {
    ...
    n.forEach(function(a) {
        i.put(a.mode.bit, 4),
        i.put(a.getLength(), ji.getCharCountIndicator(a.mode, e)),
        a.write(i)
    });
...
`);
    ...
    t >= 7 && qi(a, t),
    Gi(a, o),
    isNaN(i) && (i = Gt.getBestMask(a, Ht.bind(null, a, n))),
    Gt.applyMask(i, a),
    Ht(a, n, i),
    {
        modules: a,
...
Je.create = function(t, n) {
    ...
    let i = kt.M, r, s;
    return typeof n < "u" && (i = kt.from(n.errorCorrectionLevel, kt.M),
    r = vt.from(n.version),
    s = Gt.from(n.maskPattern),
...
(function(e) {
    ...
    e.render = function(s, o, l) {
        ...
        return t.qrToImageData(h.data, s, a),
        n(f, c, u),
...
function tr(e, t, n) {
    ...
    for (let l = 0; l < e.length; l++) {
        ...
        !a && !s && (s = !0),
        e[l] ? (o++,
        l > 0 && a > 0 && e[l - 1] || (i += s ? zt("M", a + n, .5 + c + n) : zt("m", r, 0),
        r = 0,
        s = !1),
        a + 1 < t && e[l + 1] || (i += zt("h", o),
        o = 0)) : r++
    }
    return i
}
...
`;
    return typeof i == "function" && i(null, h),
    h
}
;
const er = gi
...
function oe(e, t, n, i, r) {
    ...
    if (l) {
        ...
        o === 2 ? (r = n,
        n = t,
        t = i = void 0) : o === 3 && (t.getContext && typeof r > "u" ? (r = i,
        i = void 0) : (r = i,
        i = n,
        n = t,
        t = void 0))
        ...
        if (o < 1)
            throw new Error("Too few arguments provided");
        return o === 1 ? (n = t,
        t = i = void 0) : o === 2 && !t.getContext && (i = n,
        n = t,
        t = void 0),
 ...
 */
const dr = e => e ?? b;
export {hr as a, ar as b, $t as c, lr as e, rr as i, dr as l, Cn as n, ur as o, ft as s, cr as t, or as x};
