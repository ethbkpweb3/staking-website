...
function ki(t, e, n, s) {
    const {
        visualElement: i
    } = S.useContext(Xt), r = S.useContext(cs), o = S.useContext(Ce), a = S.useContext(ls).reducedMotion, l = S.useRef();
...
function Be(t, e, n, s) {
    ...
    if (e.transform || (l || s ? i.transform = Ki(t.transform, n, u, s) : i.transform && (i.transform = "none")), c) {
        const {
            originX: h = "50%",
            originY: f = "50%",
            originZ: d = 0
...
function vs(t, e, n) {
    for (const s in e) !O(e[s]) && !ds(s, n) && (t[s] = e[s])
}
...
function Qi(t, e, n) {
    const s = t.style || {},
        i = {};
    return vs(i, s, t), Object.assign(i, Ji(t, e, n)), t.transformValues ? t.transformValues(i) : i
}
...
function so(t, e, n) {
    const s = {};
    for (const i in t) i === "values" && typeof t.values == "object" || (xs(i) || n === !0 && Wt(i) || !e && !Wt(i) || t.draggable && i.startsWith("onDrag")) && (s[i] = t[i]);
    return s
}
...
function Fe(t, {
    ...
    d.transform && (p && (m.transform = d.transform), delete d.transform), p && (i !== void 0 || r !== void 0 || m.transform) && (m.transformOrigin = io(p, i !== void 0 ? i : .5, r !== void 0 ? r : .5)), e !== void 0 && (d.x = e), n !== void 0 && (d.y = n), s !== void 0 && (d.scale = s), o !== void 0 && ao(d, o, a, l, !1)
}
const Ps = () => ({ ...ke(),
        attrs: {}
    }),
...
function lo(t, e, n, s) {
    const i = S.useMemo(() => {
        ...
        }, Ee(s), t.transformTemplate), { ...r.attrs,
            style: { ...r.style
            }
        }
    }, [e]);
...
function Vs(t, e, n, s) {
    Ts(t, e, void 0, s);
    for (const i in e.attrs) t.setAttribute(bs.has(i) ? i : De(i), e.attrs[i])
}
...
function je(t, e) {
    ...
    for (const i in n)(O(n[i]) || e.style && O(e.style[i]) || ds(i, t)) && (s[i] = n[i]);
    return s
}
        ...
        useVisualState: As({
            ...
            onMount: (t, e, {
                ...
                A.read(() => {
                    ...
                    Fe(n, s, {
                        enableHardwareAcceleration: !1
                    }, Ee(e.tagName), t.transformTemplate), Vs(e, n)
                })
            }
        })
    },
...
function un(t, e) {
    const n = "pointer" + (e ? "enter" : "leave"),
        ...
        i = (r, o) => {
            if (r.type === "touch" || Ms()) return;
            const a = t.getProps();
            t.animationState && a.whileHover && t.animationState.setActive("whileHover", e), a[s] && A.update(() => a[s](r, o))
        };
...
class bo extends st {
    constructor() {
        super(...arguments), this.removeStartListeners = L, this.removeEndListeners = L, this.removeAccessibleListeners = L, this.startPointerPress = (e, n) => {
            ...
            this.removeEndListeners = Q(r, o), this.startPress(e, n)
            ...
            const e = r => {
                    ...
                    this.removeEndListeners(), this.removeEndListeners = $(this.node.current, "keyup", o), ne("down", (a, l) => {
                        this.startPress(a, l)
                    })
                },
    ...
    checkPressEnd() {
        return this.removeEndListeners(), this.isPressing = !1, this.node.getProps().whileTap && this.node.animationState && this.node.animationState.setActive("whileTap", !1), !Ms()
    }
    cancelPress(e, n) {
        if (!this.checkPressEnd()) return;
        const {
...
function Es(t) {
    if (t) return Bs(t) ? bt(t) : Array.isArray(t) ? t.map(Es) : Fs[t]
}
...
function Uo(t, e, n, s, i) {
    let r, o, a = 0;
    do o = e + (n - e) / 2, r = js(o, s, i) - t, r > 0 ? n = o : e = o; while (Math.abs(r) > Oo && ++a < Io);
    return o
}
...
const No = kt(.42, 0, 1, 1),
    ...
    hn = t => {
        if (Array.isArray(t)) {
            ...
            const [e, n, s, i] = t;
            return kt(e, n, s, i)
        } else if (typeof t == "string") return Ko[t];
        return t
    },
    ...
    lt = {
        ...
        transform: ({
            ...
            blue: n,
            alpha: s = 1
        }) => "rgba(" + ie.transform(t) + ", " + ie.transform(e) + ", " + ie.transform(n) + ", " + St(Vt.transform(s)) + ")"
    };
...
const pe = {
    ...
    dt = {
        ...
        transform: ({
            ...
            lightness: n,
            alpha: s = 1
        }) => "hsla(" + Math.round(t) + ", " + W.transform(St(e)) + ", " + W.transform(St(n)) + ", " + St(Vt.transform(s)) + ")"
    },
    j = {
...
const Hs = (t, e) => {
    ...
    return r => (i.red = re(n.red, s.red, r), i.green = re(n.green, s.green, r), i.blue = re(n.blue, s.blue, r), i.alpha = D(n.alpha, s.alpha, r), lt.transform(i))
};
...
function ae(t, {
    ...
    r && (t["num" + n] = r.length, t.tokenised = t.tokenised.replace(e, s), t.values.push(...r.map(i)))
}
...
function Ht(t) {
    ...
    return n.value.includes("var(--") && ae(n, $s), ae(n, zs), ae(n, Ks), n
}
...
function Xs(t) {
    ...
    return o => {
        let a = i;
        for (let l = 0; l < r; l++) l < s ? a = a.replace($s.token, o[l]) : l < s + n ? a = a.replace(zs.token, j.transform(o[l])) : a = a.replace(Ks.token, St(o[l]));
        return a
    }
}
...
const Zs = (t, e) => {
    ...
    er = (t, e) => {
        const n = { ...t,
            ...
            s = {};
        for (const i in n) t[i] !== void 0 && e[i] !== void 0 && (s[i] = qs(t[i], e[i]));
        return i => {
...
function Qs(t, e, {
    ...
    const r = t.length;
    if (Ie(r === e.length), r === 1) return () => e[0];
...
function fr({
    ...
    ko(t <= tt(mn));
    let o = 1 - e;
    o = et(ur, hr, o), t = et(cr, mn, K(t)), o < 1 ? (i = c => {
        const u = c * o,
            h = u * t,
            f = u - n,
            d = ge(c, o),
...
function mr(t, e, n) {
    let s = n;
    for (let i = 1; i < dr; i++) s = s - t(s) / e(s);
    return s
}
...
function ni({
    ...
    } else if (m === 1) y = g => r - Math.exp(-x * g) * (p + (d + x * p) * g);
    else {
...
function gn({
    ...
    const y = V => -p * Math.exp(-V / s),
        ...
        P = V => {
            const M = y(V),
                G = g(V);
            f.done = Math.abs(M) <= c, f.value = f.done ? T : G
        };
    let b, E;
    const C = V => {
        d(f.value) && (b = V, E = ni({
    ...
    return C(0), {
        ...
        next: V => {
            let M = !1;
            return !E && b === void 0 && (M = !0, P(V), C(V)), b !== void 0 && V > b ? E.next(V - b) : (!M && P(V), f)
        }
    }
}
const vr = t => {
...
function vn(t) {
    ...
    const n = 50;
    let s = t.next(e);
    for (; !s.done && e < yn;) e += n, s = t.next(e);
    return e >= yn ? 1 / 0 : e
}
const xr = {
    decay: gn,
...
function zt({
    ...
    let X = 1 / 0,
        Y = 1 / 0;
    H !== null && (X = H + o, Y = X * (r + 1) - o);
    let k = 0;
    const B = w => {
            if (M === null) return;
            d > 0 && (M = Math.min(M, w)), d < 0 && (M = Math.min(w - Y / d, M)), V !== null ? k = V : k = Math.round(w - M) * d;
            const vt = k - e * (d >= 0 ? 1 : -1),
                qe = d >= 0 ? vt < 0 : vt > Y;
            k = Math.max(vt, 0), C === "finished" && V === null && (k = Y);
            let Ze = k,
                Je = b;
            if (r) {
                const te = k / X;
                let Ft = Math.floor(te),
                    it = te % 1;
                !it && te >= 1 && (it = 1), it === 1 && Ft--, Ft = Math.min(Ft, r + 1);
                const tn = !!(Ft % 2);
                tn && (a === "reverse" ? (it = 1 - it, o && (it -= o / X)) : a === "mirror" && (Je = E));
                let en = et(0, 1, it);
                k > Y && (en = a === "reverse" && tn ? 1 : 0), Ze = en * X
            }
            const xt = qe ? {
                done: !1,
                value: s[0]
            ...
            return h && h(xt.value), Mi && Di(), xt
        },
        q = () => {
            y && y.stop(), y = void 0
        },
        ht = () => {
            C = "idle", q(), p(), T(), M = G = null
        },
        Di = () => {
            C = "finished", u && u(), q(), p()
        },
        Xe = () => {
            ...
            y || (y = n(B));
            const w = y.now();
            l && l(), V !== null ? M = w - V : (!M || C === "finished") && (M = w), C === "finished" && T(), G = M, V = null, C = "running", y.start()
        };
    t && Xe();
    const Ye = {
        then(w, vt) {
        ...
        set time(w) {
            w = tt(w), k = w, V !== null || !y || d === 0 ? V = w : M = y.now() - w / d
        },
        get duration() {
...
function Ar(t, e, {
    ...
    if (!(Tr() && br.has(e) && !i.repeatDelay && i.repeatType !== "mirror" && i.damping !== 0 && i.type !== "inertia")) return !1;
    let o = !1,
        a, l;
    const c = () => {
        l = new Promise(y => {
    ...
    if (Sr(e, i)) {
        ...
        const P = [];
        let b = 0;
        for (; !g.done && b < Vr;) g = y.sample(b), P.push(g.value), b += jt;
        d = void 0, u = P, h = b - jt, f = "linear"
    }
    const m = Eo(t.owner.current, e, u, { ...i,
            duration: h,
            ease: f,
            times: d
        }),
    ...
    return m.onfinish = () => {
        ...
        attachTimeline(y) {
            return m.timeline = y, m.onfinish = null, L
        },
        get time() {
...
const wr = {
    ...
    Rr = (t, {
        keyframes: e
    }) => e.length > 2 ? Mr : ct.has(t) ? t.startsWith("scale") ? Dr(e[1]) : wr : Lr,
...
function jr(t) {
    ...
    if (t !== null) return t === "none" || t === "0" || ii(t)
}
...
function Or(t, e, n, s) {
    ...
    let a;
    const l = [];
    for (let c = 0; c < r.length; c++) r[c] === null && (r[c] = c === 0 ? o : r[c - 1]), jr(r[c]) && l.push(c), typeof r[c] == "string" && r[c] !== "none" && r[c] !== "0" && (a = r[c]);
    if (i && l.length && a)
...
const $e = (t, e, n, s = {}) => i => {
    ...
    if (Ir(r) || (d = { ...d,
            ...Rr(t, d)
        }), d.duration && (d.duration = tt(d.duration)), d.repeatDelay && (d.repeatDelay = tt(d.repeatDelay)), !h || !f || Fo.current || r.type === !1) return Cr(d);
...
class _e {
    ...
    add(e) {
        return ze(this.subscriptions, e), () => Ke(this.subscriptions, e)
    }
    notify(e, n, s) {
...
class Nr {
    constructor(e, n = {}) {
        this.version = "10.16.16", this.timeDelta = 0, this.lastUpdated = 0, this.canTrackVelocity = !1, this.events = {}, this.updateAndNotify = (s, i = !0) => {
        ...
        }, this.hasAnimated = !1, this.prev = this.current = e, this.canTrackVelocity = Ur(this.current), this.owner = n.owner
    }
    onChange(e) {
    ...
    if (o)
        for (let a = 0; a < o; a++) {
            const l = r[a],
                c = e[l];
            let u = null;
            Array.isArray(c) && (u = c[0]), u === null && (u = (i = (s = n[l]) !== null && s !== void 0 ? s : t.readValue(l)) !== null && i !== void 0 ? i : e[l]), u != null && (typeof u == "string" && (oi(u) || ii(u)) ? u = parseFloat(u) : !Hr(u) && nt.test(c) && (u = si(l, c)), t.addValue(l, gt(u, {
                owner: t
...
function li(t, e, {
    ...
    for (const h in a) {
        const f = t.getValue(h),
            d = a[h];
        if (!f || d === void 0 || u && Yr(u, h)) continue;
        const m = {
            delay: n,
            elapsed: 0,
            ...He(r || {}, h)
        ...
        if (m.type === "spring" && (f.getVelocity() || m.velocity) && (p = !1), f.animation && (p = !1), p) continue;
        f.start($e(h, f, d, t.shouldReduceMotion && ct.has(h) ? {
            type: !1
        } : m));
        const x = f.animation;
        Kt(l) && (l.add(h), x.then(() => l.remove(h))), c.push(x)
    }
...
function Zr(t, e, n = 0, s = 0, i = 1, r) {
    ...
    return Array.from(t.variantChildren).sort(Jr).forEach((c, u) => {
        c.notify("AnimationStart", e), o.push(xe(c, e, { ...r,
            delay: n + l(u)
...
function Qr(t, e, n = {}) {
    ...
    if (Array.isArray(e)) {
        ...
        s = Promise.all(i)
    } else if (typeof e == "string") s = xe(t, e, n);
    else {
...
function sa(t) {
    ...
    function o(l, c) {
        ...
        for (let T = 0; T < ea; T++) {
            ...
            E === !1 && (p = T);
            let C = P === h[y] && P !== u[y] && b;
            if (C && s && t.manuallyAnimateOnMount && (C = !1), g.protectedKeys = { ...m
                }, !g.isActive && E === null || !P && !g.prevProp || Yt(P) || typeof P == "boolean") continue;
            ...
            const {
                ...
                M = !0, d.delete(B), g.needsAnimating[B] = !0
            };
            for (const B in Y) {
                const q = H[B],
                    ht = X[B];
            ...
            g.prevProp = P, g.prevResolvedValues = H, g.isActive && (m = { ...m,
                ...H
            }), s && t.blockInitialAnimation && (M = !1), M && !C && f.push(...G.map(B => ({
                animation: B,
                options: {
                    type: y,
                    ...l
        ...
        let x = !!f.length;
        return s && (u.initial === !1 || u.initial === u.animate) && !t.manuallyAnimateOnMount && (x = !1), s = !1, x ? e(f) : Promise.resolve()
    }
...
class ra extends st {
    ...
    updateAnimationControlsSubscription() {
        ...
        this.unmount(), Yt(e) && (this.unmount = e.subscribe(this.node))
    }
    mount() {
...
class ci {
    constructor(e, n, {
        ...
        if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.updatePoint = () => {
                ...
                h || (p && p(this.lastMoveEvent, u), this.startEvent = this.lastMoveEvent), x && x(this.lastMoveEvent, u)
            }, this.handlePointerMove = (u, h) => {
                this.lastMoveEvent = u, this.lastMoveEventInfo = ce(h, this.transformPagePoint), A.update(this.updatePoint, !0)
            }, this.handlePointerUp = (u, h) => {
                if (this.end(), !(this.lastMoveEvent && this.lastMoveEventInfo)) return;
                const {
                    onEnd: f,
                    onSessionEnd: d
                } = this.handlers, m = ue(u.type === "pointercancel" ? this.lastMoveEventInfo : ce(h, this.transformPagePoint), this.history);
                this.startEvent && f && f(u, m), d && d(u, m)
            }, !Cs(e)) return;
        this.handlers = n, this.transformPagePoint = s, this.contextWindow = i || window;
        const r = Jt(e),
        ...
        c && c(e, ue(o, this.history)), this.removeListeners = Q(z(this.contextWindow, "pointermove", this.handlePointerMove), z(this.contextWindow, "pointerup", this.handlePointerUp), z(this.contextWindow, "pointercancel", this.handlePointerUp))
    }
    updateHandlers(e) {
        this.handlers = e
    }
...
function Tn(t, e, n, s = .5) {
    t.origin = s, t.originPoint = D(e.min, e.max, t.origin), t.scale = I(n) / I(e), (Pe(t.scale, 1, 1e-4) || isNaN(t.scale)) && (t.scale = 1), t.translate = D(n.min, n.max, t.origin) - t.originPoint, (Pe(t.translate) || isNaN(t.translate)) && (t.translate = 0)
}

function At(t, e, n, s) {
    Tn(t.x, e.x, n.x, s ? s.originX : void 0), Tn(t.y, e.y, n.y, s ? s.originY : void 0)
}
...
function ya(t, e) {
    ...
    const s = I(t),
        i = I(e);
    return i > s ? n = Mt(e.min, e.max - s, t.min) : s > i && (n = Mt(t.min, t.max - i, e.min)), et(0, 1, n)
}
...
function Rn(t, e, n, s, i) {
    return i !== void 0 && (t = _t(t, i, s)), _t(t, n, s) + e
}

function Ve(t, e = 0, n = 1, s, i) {
    t.min = Rn(t.min, e, n, s, i), t.max = Rn(t.max, e, n, s, i)
}
...
function ba(t, e, n, s = !1) {
    ...
    for (let a = 0; a < i; a++) {
        ...
        l && l.style && l.style.display === "contents" || (s && r.options.layoutScroll && r.scroll && r !== r.root && pt(t, {
            x: -r.scroll.offset.x,
            y: -r.scroll.offset.y
        }), o && (e.x *= o.x.scale, e.y *= o.y.scale, di(t, o)), s && rt(r.latestValues) && pt(t, r.latestValues))
    }
    e.x = Bn(e.x), e.y = Bn(e.y)
}
...
class wa {
    constructor(e) {
        this.openGlobalLock = null, this.isDragging = !1, this.currentDirection = null, this.originPoint = {
            x: 0,
            y: 0
        }, this.constraints = !1, this.hasMutatedConstraints = !1, this.elastic = R(), this.visualElement = e
    }
    start(e, {
        snapToCursor: n = !1
    } = {}) {
        ...
        const i = l => {
                this.stopAnimation(), n && this.snapToCursor(Jt(l, "page").point)
            },
            r = (l, c) => {
                const {
                    drag: u,
                ...
                if (u && !h && (this.openGlobalLock && this.openGlobalLock(), this.openGlobalLock = Ds(u), !this.openGlobalLock)) return;
                this.isDragging = !0, this.currentDirection = null, this.resolveConstraints(), this.visualElement.projection && (this.visualElement.projection.isAnimationBlocked = !0, this.visualElement.projection.target = void 0), N(m => {
            ...
            o = (l, c) => {
                ...
                if (h && this.currentDirection === null) {
                    this.currentDirection = Da(m), this.currentDirection !== null && f && f(this.currentDirection);
                    return
                }
                this.updateAxis("x", c.point, m), this.updateAxis("y", c.point, m), this.visualElement.render(), d && d(l, c)
            },
            a = (l, c) => this.stop(l, c);
    ...
    resolveConstraints() {
        ...
        n && ft(n) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : n && i ? this.constraints = pa(i.layoutBox, n) : this.constraints = !1, this.elastic = xa(s), r !== this.constraints && i && this.constraints && !this.hasMutatedConstraints && N(o => {
    ...
    scalePositionWithinConstraints() {
        ...
        this.visualElement.current.style.transform = r ? r({}, "") : "none", s.root && s.root.updateScroll(), s.updateLayout(), this.resolveConstraints(), N(o => {
...
class Ma extends st {
    constructor(e) {
        super(e), this.removeGroupControls = L, this.removeListeners = L, this.controls = new wa(e)
    }
    mount() {
        const {
            dragControls: e
...
class La extends st {
    ...
    createPanHandlers() {
        ...
        return {
            ...
            onMove: s,
            onEnd: (r, o) => {
                delete this.session, i && A.update(() => i(r, o))
            }
        }
    }
    mount() {
...
function Ra() {
    ...
    return S.useEffect(() => s(i), []), !e && n ? [!1, () => n && n(i)] : [!0]
}
const Ut = {
...
class ka extends as.Component {
    componentDidMount() {
        ...
        Hi(Fa), r && (n.group && n.group.add(r), s && s.register && i && s.register(r), r.root.didUpdate(), r.addEventListener("animationComplete", () => {
            this.safeToRemove()
    ...
    getSnapshotBeforeUpdate(e) {
        ...
        return o && (o.isPresent = r, i || e.layoutDependency !== n || n === void 0 ? o.willUpdate() : this.safeToRemove(), e.isPresent !== r && (r ? o.promote() : o.relegate() || A.postRender(() => {
            const a = o.getStack();
...
function gi(t) {
    const [e, n] = Ra(), s = S.useContext(rs);
    return as.createElement(ka, { ...t,
        layoutGroup: s,
...
function ja(t, e, n, s, i, r) {
    i ? (t.opacity = D(0, n.opacity !== void 0 ? n.opacity : 1, Oa(s)), t.opacityExit = D(e.opacity !== void 0 ? e.opacity : 1, 0, Ia(s))) : r && (t.opacity = D(e.opacity !== void 0 ? e.opacity : 1, n.opacity !== void 0 ? n.opacity : 1, s));
    for (let o = 0; o < Ea; o++) {
        const a = `border${yi[o]}Radius`;
        let l = In(e, a),
            c = In(n, a);
        if (l === void 0 && c === void 0) continue;
        l || (l = 0), c || (c = 0), l === 0 || c === 0 || On(l) === On(c) ? (t[a] = Math.max(D(jn(l), jn(c), s), 0), (W.test(c) || W.test(l)) && (t[a] += "%")) : t[a] = c
...
function Nn(t, e, n, s, i) {
    return t -= e, t = _t(t, 1 / n, s), i !== void 0 && (t = _t(t, 1 / i, s)), t
}

function Ua(t, e = 0, n = 1, s = .5, i, r = t, o = t) {
    if (W.test(e) && (e = parseFloat(e), e = D(o.min, o.max, e / 100) - o.min), typeof e != "number") return;
    let a = D(r.min, r.max, s);
    t === r && (a -= e), t.min = Nn(t.min, e, n, a, i), t.max = Nn(t.max, e, n, a, i)
}
...
function Gn(t, e, n, s) {
    Wn(t.x, e, Na, n ? n.x : void 0, s ? s.x : void 0), Wn(t.y, e, Wa, n ? n.y : void 0, s ? s.y : void 0)
}
...
class za {
    ...
    forEach(e) {
        this.isDirty && this.children.sort($a), this.isDirty = !1, this.children.forEach(e)
    }
}
...
function Ya(t, e, n) {
    const s = O(t) ? t : gt(t);
    return s.start($e("", s, e, n)), s.animation
}
const Kn = ["", "X", "Y", "Z"],
    qa = {
        visibility: "hidden"
...
function Ti({
    ...
    return class {
        constructor(o = {}, a = e == null ? void 0 : e()) {
            this.id = Za++, this.animationId = 0, this.children = new Set, this.options = {}, this.isTreeAnimating = !1, this.isAnimationBlocked = !1, this.isLayoutDirty = !1, this.isProjectionDirty = !1, this.isSharedProjectionDirty = !1, this.isTransformDirty = !1, this.updateManuallyBlocked = !1, this.updateBlockedByResize = !1, this.isUpdating = !1, this.isSVG = !1, this.needsReset = !1, this.shouldResetTransform = !1, this.treeScale = {
                x: 1,
                y: 1
                ...
                this.projectionUpdateScheduled = !1, at.totalNodes = at.resolvedTargetDeltas = at.recalculatedProjection = 0, this.nodes.forEach(tl), this.nodes.forEach(ol), this.nodes.forEach(rl), this.nodes.forEach(el), _a(at)
        ...
        mount(o, a = this.root.hasTreeAnimated) {
            ...
            this.isSVG = Xa(o), this.instance = o;
            const {
                layoutId: l,
                layout: c,
                visualElement: u
            ...
            if (u && !u.current && u.mount(o), this.root.nodes.add(this), this.parent && this.parent.children.add(this), a && (c || l) && (this.isLayoutDirty = !0), t) {
                ...
                t(o, () => {
                    this.root.updateBlockedByResize = !0, h && h(), h = Ka(f, 250), Ut.hasAnimatedSinceResize && (Ut.hasAnimatedSinceResize = !1, this.nodes.forEach(Yn))
                })
            }
            l && this.root.registerSharedNode(l, this), this.options.animate !== !1 && u && (l || c) && this.addEventListener("didUpdate", ({
                ...
                } else f || Yn(this), this.isLead() && this.options.onExitComplete && this.options.onExitComplete();
                this.targetLayout = m
            })
        }
        unmount() {
            ...
            o && o.remove(this), this.parent && this.parent.children.delete(this), this.instance = void 0, _(this.updateProjection)
        }
        blockUpdate() {
        ...
        update() {
            if (this.updateScheduled = !1, this.isUpdateBlocked()) {
                this.unblockUpdate(), this.clearAllSnapshots(), this.nodes.forEach(Xn);
                return
            }
            this.isUpdating || this.nodes.forEach(sl), this.isUpdating = !1, this.nodes.forEach(il), this.nodes.forEach(Ja), this.nodes.forEach(Qa), this.clearAllSnapshots();
            const a = performance.now();
            F.delta = et(0, 1e3 / 60, a - F.timestamp), F.timestamp = a, F.isProcessing = !0, ee.update.process(F), ee.preRender.process(F), ee.render.process(F), F.isProcessing = !1
        }
        didUpdate() {
            this.updateScheduled || (this.updateScheduled = !0, queueMicrotask(() => this.update()))
        }
        clearAllSnapshots() {
            this.nodes.forEach(nl), this.sharedNodes.forEach(ll)
        }
        ...
        resetTransform() {
            ...
            o && (a || rt(this.latestValues) || u) && (i(this.instance, c), this.shouldResetTransform = !1, this.scheduleRender())
        }
        measure(o = !0) {
            const a = this.measurePageBox();
            let l = this.removeElementScroll(a);
            return o && (l = this.removeTransform(l)), fl(l), {
                animationId: this.root.animationId,
                measuredBox: a,
                layoutBox: l,
                latestValues: {},
        ...
        applyTransform(o, a = !1) {
            ...
            return rt(this.latestValues) && pt(l, this.latestValues), l
        }
        removeTransform(o) {
            const a = R();
            U(a, o);
            for (let l = 0; l < this.path.length; l++) {
                const c = this.path[l];
                if (!c.instance || !rt(c.latestValues)) continue;
                be(c.latestValues) && c.updateSnapshot();
                const u = R(),
                    h = c.measurePageBox();
                U(u, h), Gn(a, c.latestValues, c.snapshot ? c.snapshot.layoutBox : void 0, u)
            }
            return rt(this.latestValues) && Gn(a, this.latestValues), a
        }
        setTargetDelta(o) {
        ...
        resolveTargetDelta(o = !1) {
            ...
            if (!(!this.layout || !(h || f))) {
                if (this.resolvedRelativeTargetAt = F.timestamp, !this.targetDelta && !this.relativeTarget) {
                    ...
                    d && d.layout && this.animationProgress !== 1 ? (this.relativeParent = d, this.forceRelativeParentToResolveTarget(), this.relativeTarget = R(), this.relativeTargetOrigin = R(), Ct(this.relativeTargetOrigin, this.layout.layoutBox, d.layout.layoutBox), U(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
                }
                if (!(!this.relativeTarget && !this.targetDelta)) {
                    if (this.target || (this.target = R(), this.targetWithTransforms = R()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target ? (this.forceRelativeParentToResolveTarget(), da(this.target, this.relativeTarget, this.relativeParent.target)) : this.targetDelta ? (this.resumingFrom ? this.target = this.applyTransform(this.layout.layoutBox) : U(this.target, this.layout.layoutBox), di(this.target, this.targetDelta)) : U(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget) {
                        this.attemptToResolveRelativeTarget = !1;
                        const d = this.getClosestProjectingParent();
                        d && !!d.resumingFrom == !!this.resumingFrom && !d.options.layoutScroll && d.target && this.animationProgress !== 1 ? (this.relativeParent = d, this.forceRelativeParentToResolveTarget(), this.relativeTarget = R(), this.relativeTargetOrigin = R(), Ct(this.relativeTargetOrigin, this.target, d.target), U(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
                    }
        ...
        getClosestProjectingParent() {
            if (!(!this.parent || be(this.parent.latestValues) || fi(this.parent.latestValues))) return this.parent.isProjecting() ? this.parent : this.parent.getClosestProjectingParent()
        }
        isProjecting() {
        ...
        calcProjection() {
            ...
            let c = !0;
            if ((this.isProjectionDirty || !((o = this.parent) === null || o === void 0) && o.isProjectionDirty) && (c = !1), l && (this.isSharedProjectionDirty || this.isTransformDirty) && (c = !1), this.resolvedRelativeTargetAt === F.timestamp && (c = !1), c) return;
            const {
                layout: u,
                layoutId: h
            } = this.options;
            if (this.isTreeAnimating = !!(this.parent && this.parent.isTreeAnimating || this.currentAnimation || this.pendingAnimation), this.isTreeAnimating || (this.targetDelta = this.relativeTarget = void 0), !this.layout || !(u || h)) return;
            U(this.layoutCorrected, this.layout.layoutBox);
            const f = this.treeScale.x,
                d = this.treeScale.y;
            ba(this.layoutCorrected, this.treeScale, this.path, l), a.layout && !a.target && (this.treeScale.x !== 1 || this.treeScale.y !== 1) && (a.target = a.layout.layoutBox);
            const {
                target: m
            } = a;
            if (!m) {
                this.projectionTransform && (this.projectionDelta = mt(), this.projectionTransform = "none", this.scheduleRender());
                return
            }
            this.projectionDelta || (this.projectionDelta = mt(), this.projectionDeltaWithTransform = mt());
            const p = this.projectionTransform;
            At(this.projectionDelta, this.layoutCorrected, m, this.latestValues), this.projectionTransform = zn(this.projectionDelta, this.treeScale), (this.projectionTransform !== p || this.treeScale.x !== f || this.treeScale.y !== d) && (this.hasProjected = !0, this.scheduleRender(), this.notifyListeners("projectionUpdate", m)), at.recalculatedProjection++
        }
        hide() {
            this.isVisible = !1
        }
        ...
        setAnimationOrigin(o, a = !1) {
            ...
            this.mixTargetDelta = P => {
                const b = P / 1e3;
                qn(h.x, o.x, b), qn(h.y, o.y, b), this.setTargetDelta(h), this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout && (Ct(f, this.layout.layoutBox, this.relativeParent.layout.layoutBox), cl(this.relativeTarget, this.relativeTargetOrigin, f, b), g && Ga(this.relativeTarget, g) && (this.isProjectionDirty = !1), g || (g = R()), U(g, this.relativeTarget)), p && (this.animationValues = u, ja(u, c, this.latestValues, b, y, T)), this.root.scheduleUpdateProjection(), this.scheduleRender(), this.animationProgress = b
            }, this.mixTargetDelta(this.options.layoutRoot ? 1e3 : 0)
        }
        startAnimation(o) {
            this.notifyListeners("animationStart"), this.currentAnimation && this.currentAnimation.stop(), this.resumingFrom && this.resumingFrom.currentAnimation && this.resumingFrom.currentAnimation.stop(), this.pendingAnimation && (_(this.pendingAnimation), this.pendingAnimation = void 0), this.pendingAnimation = A.update(() => {
                Ut.hasAnimatedSinceResize = !0, this.currentAnimation = Ya(0, _n, { ...o,
                    onUpdate: a => {
        ...
        finishAnimation() {
            this.currentAnimation && (this.mixTargetDelta && this.mixTargetDelta(_n), this.currentAnimation.stop()), this.completeAnimation()
        }
        applyTransformsToTarget() {
            ...
            if (!(!a || !l || !c)) {
                ...
                U(a, l), pt(a, u), At(this.projectionDeltaWithTransform, this.layoutCorrected, a, u)
            }
        }
        registerSharedNode(o, a) {
            this.sharedNodes.has(o) || this.sharedNodes.set(o, new Ha), this.sharedNodes.get(o).add(a);
        ...
        getProjectionStyles(o) {
            ...
            if (!this.isVisible) return qa;
            const c = {
                    visibility: ""
                },
                u = this.getTransformTemplate();
            if (this.needsReset) return this.needsReset = !1, c.opacity = "", c.pointerEvents = It(o == null ? void 0 : o.pointerEvents) || "", c.transform = u ? u(this.latestValues, "") : "none", c;
            const h = this.getLead();
            if (!this.projectionDelta || !this.layout || !h.target) {
                const p = {};
                return this.options.layoutId && (p.opacity = this.latestValues.opacity !== void 0 ? this.latestValues.opacity : 1, p.pointerEvents = It(o == null ? void 0 : o.pointerEvents) || ""), this.hasProjected && !rt(this.latestValues) && (p.transform = u ? u({}, "") : "none", this.hasProjected = !1), p
            }
            const f = h.animationValues || h.latestValues;
            this.applyTransformsToTarget(), c.transform = zn(this.projectionDeltaWithTransform, this.treeScale, f), u && (c.transform = u(f, c.transform));
            const {
                x: d,
                y: m
            ...
            for (const p in Nt) {
                ...
                const {
                    correct: x,
                    applyTo: T
                } = Nt[p], y = c.transform === "none" ? f[p] : x(f[p], h);
                if (T) {
                    const g = T.length;
                    for (let P = 0; P < g; P++) c[T[P]] = y
                } else c[p] = y
            }
            return this.options.layoutId && (c.pointerEvents = h === this ? It(o == null ? void 0 : o.pointerEvents) || "" : "none"), c
        }
        clearSnapshot() {
        ...
        resetTree() {
            ...
            }), this.root.nodes.forEach(Xn), this.root.sharedNodes.clear()
        }
    }
}
        ...
        if (!t.resumeFrom) {
            ...
            if (h && !h.resumeFrom) {
                ...
                if (f && d) {
                    ...
                    const p = R();
                    Ct(p, s, d.layoutBox), Pi(m, p) || (u = !0), h.options.layoutRoot && (t.relativeTarget = p, t.relativeTargetOrigin = m, t.relativeParent = h)
                }
            }
        }
...
function cl(t, e, n, s) {
    Zn(t.x, e.x, n.x, s), Zn(t.y, e.y, n.y, s)
}
        ...
        if (i.forEach(l => {
                ...
                if (Gt(f)) {
                    const m = f.length,
                        p = f[0] === null ? 1 : 0;
                    u = f[p], h = Pt(u);
                    for (let x = p; x < m && f[x] !== null; x++) d ? Ie(Pt(f[x]) === d) : d = Pt(f[x])
                } else d = Pt(f);
                if (h !== d)
                    if (es(h) && es(d)) {
                        const m = c.get();
                        typeof m == "string" && c.set(parseFloat(m)), typeof f == "string" ? e[l] = parseFloat(f) : Array.isArray(f) && d === v && (e[l] = f.map(parseFloat))
                    } else h != null && h.transform && (d != null && d.transform) && (u === 0 || f === 0) ? u === 0 ? c.set(d.transform(u)) : e[l] = h.transform(f) : (o || (r = bl(t), o = !0), a.push(l), s[l] = s[l] !== void 0 ? s[l] : e[l], c.jump(f))
            }), a.length) {
            const l = a.indexOf("height") >= 0 ? window.pageYOffset : null,
                c = Vl(e, t, a);
            return r.length && r.forEach(([u, h]) => {
                t.getValue(u).set(h)
            }), t.render(), we && l !== null && window.scrollTo({
                top: l
            }), {
                target: c,
                transitionEnd: s
...
const Cl = (t, e, n, s) => {
        const i = yl(t, e, s);
        return e = i.target, s = i.transitionEnd, Al(t, e, n, s)
    },
    Ae = {
        current: null
    },
...
function Dl(t, e, n) {
    ...
    for (const i in e) {
        const r = e[i],
            o = n[i];
        if (O(r)) t.addValue(i, r), Kt(s) && s.add(i);
        else if (O(o)) t.addValue(i, gt(r, {
            owner: t
        })), Kt(s) && s.remove(i);
        else if (o !== r)
            if (t.hasValue(i)) {
...
class Rl {
    constructor({
        ...
        } : {}, this.renderState = l, this.parent = e, this.props = n, this.presenceContext = s, this.depth = e ? e.depth + 1 : 0, this.reducedMotionConfig = i, this.options = o, this.isControllingVariants = qt(n), this.isVariantNode = hs(n), this.isVariantNode && (this.variantChildren = new Set), this.manuallyAnimateOnMount = !!(e && e.current);
        const {
            willChange: c,
            ...u
        ...
        for (const h in u) {
            const f = u[h];
            a[h] !== void 0 && O(f) && (f.set(a[h], !1), Kt(c) && c.add(h))
        }
    }
    ...
    unmount() {
        is.delete(this.current), this.projection && this.projection.unmount(), _(this.notifyUpdate), _(this.render), this.valueSubscriptions.forEach(e => e()), this.removeFromVariantTree && this.removeFromVariantTree(), this.parent && this.parent.children.delete(this);
        for (const e in this.events) this.events[e].clear();
    ...
    bindToMotionValue(e, n) {
        const s = ct.has(e),
            i = n.on("change", o => {
                this.latestValues[e] = o, this.props.onUpdate && A.update(this.notifyUpdate, !1, !0), s && this.projection && (this.projection.isTransformDirty = !0)
            }),
    ...
    update(e, n) {
        ...
        this.prevMotionValues = Dl(this, this.scrapeMotionValuesFromProps(e, this.prevProps), this.prevMotionValues), this.handleChildMotionValue && this.handleChildMotionValue()
    }
    getProps() {
        return this.props
    }
    ...
    getBaseTarget(e) {
        ...
        const {
            initial: s
        } = this.props, i = typeof s == "string" || typeof s == "object" ? (n = Oe(this.props, s)) === null || n === void 0 ? void 0 : n[e] : void 0;
...
class Fl extends wi {
    ...
    readValueFromInstance(e, n) {
        ...
        return n = bs.has(n) ? n : De(n), e.getAttribute(n)
    }
...
export {
    kl as H, Fl as S, Pr as a, Xa as b, vn as c, yn as d, K as e, Go as f, D as g, O as h, Ie as i, or as j, ir as k, tt as l, Nl as m, Ya as n, li as o, Mt as p, Ke as r, ni as s, is as v
};