import {i as g, n as c, b, t as f, s as m, x as l, o as P, l as it, a as rt, e as h, c as Fe} from "./if-defined-leStHEAq.js";
import {u as V, F as nt, p as D, q as k, f as W, b as O, W as x, d as I, i as u, P as A, g as j, C as L} from "./index-IT1gKaF9.js";
var qe = Object.defineProperty
  ...
  , Lt = (t, e) => {
    for (var a in e || (e = {}))
        Ke.call(e, a) && $e(t, a, e[a]);
    if (ke)
        for (var a of ke(e))
            Ye.call(e, a) && $e(t, a, e[a]);
    return t
}
;
function Qe() {
...
var to = Object.defineProperty
  ...
  , bt = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? eo(e, a) : e, i = t.length - 1, n; i >= 0; i--)
...
var ao = Object.defineProperty
  ...
  , st = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? ro(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && ao(e, a, o),
    o
}
...
let G = class extends m {
    ...
    render() {
        ...
        let e = "inverse";
        return this.variant === "ghost" && (e = "secondary"),
        this.variant === "outline" && (e = "accent"),
        l`<button class="${P(t)}" data-testid="component-button" ?disabled="${this.disabled}" @click="${this.onClick}">${this.iconLeft}<w3m-text variant="small-regular" color="${e}"><slot></slot></w3m-text>${this.iconRight}</button>`
    }
}
;
...
var no = Object.defineProperty
  ...
  , Yt = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? lo(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && no(e, a, o),
    o
}
...
var co = Object.defineProperty
  ...
  , ho = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? mo(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && co(e, a, o),
    o
}
...
;
Qt.styles = [p.globalCss, so],
Qt = ho([h("w3m-info-footer")], Qt);
const w = {
...
var po = Object.defineProperty
  ...
  , Ie = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? go(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && po(e, a, o),
    o
}
...
var vo = Object.defineProperty
  ...
  , fo = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? bo(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && vo(e, a, o),
    o
}
...
;
Xt.styles = [p.globalCss, uo],
Xt = fo([h("w3m-modal-content")], Xt);
...
var yo = Object.defineProperty
  ...
  , ko = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Co(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && yo(e, a, o),
    o
}
...
;
Jt.styles = [p.globalCss, xo],
Jt = ko([h("w3m-modal-footer")], Jt);
...
var Oo = Object.defineProperty
  ...
  , xt = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Io(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Oo(e, a, o),
    o
}
...
const Eo = {
  ...
  , R = {
    externalWallets() {
        ...
        return t = t.filter(e => e.id !== "injected"),
        t
    },
    manualWallets() {
        var t, e;
        ...
        return (e = u.isMobile() ? n == null ? void 0 : n.map( ({id: d, name: v, links: y}) => ({
            id: d,
            name: v,
            mobile: y,
            links: y
        })) : n == null ? void 0 : n.map( ({id: d, name: v, links: y}) => ({
            id: d,
            name: v,
            desktop: y,
            links: y
    ...
    installedInjectedWallets() {
        if (!W.client().isInjectedProviderInstalled())
            return [];
        const {namespace: t} = W.client()
          , {injectedWallets: e} = I.state;
        let a = e.filter( ({injected: r}) => !!r.some(o => W.client().safeCheckInjectedProvider(o.injected_id) && o.namespace === t));
        return a.length > 1 && (a = a.filter( ({injected: r}) => !!r.map( ({injected_id: i}) => i).every(i => i !== "isMetaMask"))),
        a.length ? a : [{
            name: "Browser",
            id: "browser",
            image_id: void 0
    ...
    injectedWallets() {
        const {explorerExcludedWalletIds: t, explorerRecommendedWalletIds: e} = L.state
          , a = u.isMobile();
        if (t === "ALL" || a)
            return [];
  ...
  , s = {
    ...
    handleMobileLinking(t) {
        ...
        function n(d) {
            let v = "";
            o ? v = u.formatUniversalUrl(o, d, r) : i && (v = u.formatNativeUrl(i, d, r)),
            u.openHref(v, "_self")
        }
        n(e)
    },
    handleAndroidLinking() {
        ...
        u.setWalletConnectAndroidDeepLink(t),
        u.openHref(t, "_self")
    },
    async handleUriCopy() {
        try {
    ...
    async handleConnectorConnection(t, e) {
        try {
            ...
            console.error(a),
            e ? e() : j.openToast(s.getErrorMessage(a), "error")
        }
    },
    getCustomImageUrls() {
    ...
    getCachedRouterWalletPlatforms() {
        const {id: t, desktop: e, mobile: a, injected: r} = u.getWalletRouterData()
    ...
    goToConnectingView(t) {
        ...
        const e = u.isMobile()
          , {isDesktop: a, isWeb: r, isMobile: o, isInjectedInstalled: i} = s.getCachedRouterWalletPlatforms();
...
var Po = Object.defineProperty
  ...
  , te = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Wo(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Po(e, a, o),
    o
}
...
var Lo = Object.defineProperty
  ...
  , Ee = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? To(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Lo(e, a, o),
    o
}
...
let _t = class extends m {
    constructor() {
        ...
        this.unsubscribe = j.subscribe(t => {
            t.open ? (this.open = !0,
            this.timeout = setTimeout( () => j.closeToast(), 2200)) : (this.open = !1,
...
var Zo = Object.defineProperty
  ...
  , Ae = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Ho(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Zo(e, a, o),
    o
}
...
var qo = Object.defineProperty
  ...
  , Pe = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Ko(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && qo(e, a, o),
    o
}
...
var Qo = Object.defineProperty
  ...
  , oe = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Xo(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Qo(e, a, o),
    o
}
...
var ta = Object.defineProperty
  ...
  , ae = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? ea(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && ta(e, a, o),
    o
}
...
var aa = Object.defineProperty
  ...
  , We = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? ra(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && aa(e, a, o),
    o
}
...
var na = Object.defineProperty
  ...
  , q = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? la(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && na(e, a, o),
    o
}
...
var ca = Object.defineProperty
  ...
  , Zt = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? da(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && ca(e, a, o),
    o
}
...
var ma = Object.defineProperty
  ...
  , wa = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? ha(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && ma(e, a, o),
    o
}
...
let Me = class extends m {
    constructor() {
        ...
        this.unwatchAccount = W.client().watchAccount(t => {
            ...
            t.isConnected && t.address !== e && (this.fetchProfile(t.address),
    ...
    async fetchProfile(t) {
        ...
        if (L.state.enableAccountView && a)
            try {
                ...
                console.error(r),
                j.openToast(s.getErrorMessage(r), "error")
            }
    }
    async fetchBalance(t) {
        if (L.state.enableAccountView)
            try {
                ...
                console.error(e),
                j.openToast(s.getErrorMessage(e), "error")
            }
    }
}
;
...
var pa = Object.defineProperty
  ...
  , Le = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? ga(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && pa(e, a, o),
    o
}
    ...
    async preloadListings() {
        ...
        if (L.state.enableExplorer) {
            ...
            const {recomendedWallets: a} = I.state
              ...
              , o = (t = e == null ? void 0 : e.map(d => s.getChainIcon(d.id))) != null ? t : []
...
var ua = Object.defineProperty
  ...
  , Te = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? va(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && ua(e, a, o),
    o
}
...
let ie = class extends m {
    constructor() {
        ...
        this.unwatchNetwork = W.client().watchNetwork(e => {
            const a = e.chain;
            a && this.activeChainId !== a.id && (O.setSelectedChain(a),
    ...
    async fetchBalance() {
        if (L.state.enableAccountView)
            try {
                ...
                console.error(t),
                j.openToast(s.getErrorMessage(t), "error")
            }
    }
}
;
...
var ba = Object.defineProperty
  ...
  , xa = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? fa(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && ba(e, a, o),
    o
}
...
let _e = class extends m {
    ...
    async preloadThemeImages() {
        try {
            const {themeVariables: t} = V.state
              , e = [t == null ? void 0 : t["--w3m-background-image-url"], t == null ? void 0 : t["--w3m-logo-image-url"]].filter(Boolean);
...
var ya = Object.defineProperty
  ...
  , ka = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Ca(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && ya(e, a, o),
    o
}
...
let Re = class extends m {
    constructor() {
        ...
        this.timeout = void 0,
        this.isGenerated = !1,
        this.selectedChainId = (Ne = O.state.selectedChain) == null ? void 0 : Ne.id,
        this.isAccountConnected = k.state.isConnected,
        this.lastRetry = Date.now(),
        this.unwatchOptions = O.subscribe(t => {
            var e, a;
            ((e = t.selectedChain) == null ? void 0 : e.id) !== this.selectedChainId && (this.selectedChainId = (a = t.selectedChain) == null ? void 0 : a.id,
            this.connectAndWait())
        }
        ),
        this.unwatchAccount = k.subscribe(t => {
            (this.isAccountConnected !== t.isConnected || !this.isGenerated) && (this.isAccountConnected = t.isConnected,
            this.connectAndWait())
        }
        ),
    ...
    async connectAndWait() {
        ...
        !this.isAccountConnected && t) {
            ...
            try {
                ...
                Date.now() - this.lastRetry >= Oa && (this.lastRetry = Date.now(),
                this.connectAndWait())
            }
        }
    }
...
var Ea = Object.defineProperty
  ...
  , ne = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Aa(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Ea(e, a, o),
    o
}
...
var Pa = Object.defineProperty
  ...
  , le = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Wa(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Pa(e, a, o),
    o
}
...
var La = Object.defineProperty
  ...
  , Et = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Ta(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && La(e, a, o),
    o
}
...
let J = class extends m {
    constructor() {
        ...
        this.unsubscribeAccount = k.subscribe( ({address: t, profileName: e, profileLoading: a}) => {
            this.address = t,
            this.name = e,
            this.loading = !!a
        }
...
const M = {
    ...
    recentWalletTemplate() {
        ...
        if (t)
            return l`<w3m-wallet-button name="${t.name}" walletId="${t.id}" imageId="${t.image_id}" .recent="${!0}" .onClick="${ () => this.onConnecting(t)}"></w3m-wallet-button>`
    },
...
let se = class extends m {
    ...
    render() {
        ...
        return l`<w3m-modal-header title="Connect your wallet" .onAction="${this.onGoToQrcode}" .actionIcon="${w.QRCODE_ICON}"></w3m-modal-header><w3m-modal-content><div class="w3m-title">${w.MOBILE_ICON}<w3m-text variant="small-regular" color="accent">WalletConnect</w3m-text></div><div class="w3m-slider"><div class="w3m-track">${[...Array(i)].map( (n, d) => {
            const v = e[d % e.length];
            return v ? l`<w3m-wallet-image walletId="${v.id}" imageId="${v.image_id}"></w3m-wallet-image>` : w.WALLET_PLACEHOLDER
        }
...
var Ha = Object.defineProperty
  ...
  , At = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Ba(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Ha(e, a, o),
    o
}
...
let tt = class extends m {
    constructor() {
        ...
        this.loading = !!k.state.profileLoading,
        this.unsubscribeAccount = k.subscribe( ({address: t, profileAvatar: e, profileLoading: a}) => {
            this.address = t,
            this.avatar = e,
            this.loading = !!a
        }
    ...
    render() {
        ...
        return this.avatar ? l`<img crossorigin="anonymous" class="${P(t)}" src="${this.avatar}" data-testid="partial-avatar-image">` : this.address ? (s.generateAvatarColors(this.address),
        l`<div class="${P(t)}">${this.loading ? l`<div class="w3m-loader"></div>` : null}</div>`) : null
    }
}
;
...
var Ua = Object.defineProperty
  ...
  , ce = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? za(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Ua(e, a, o),
    o
}
...
let jt = class extends m {
    ...
    render() {
        let t = "_._";
        return this.amount === "0.0" ? t = "0" : typeof this.amount == "string" && this.amount.length > 6 ? t = this.amount.substring(0, 6) : typeof this.amount == "string" && (t = this.amount),
        l`<div><w3m-token-image symbol="${it(this.symbol)}" data-testid="partial-balance-token-image"></w3m-token-image><w3m-text variant="medium-regular" color="primary" data-testid="partial-balance-token-text">${t} ${this.symbol}</w3m-text></div>`
    }
}
;
...
let mt = class extends m {
    constructor() {
        ...
        this.modalUnsub = D.subscribe(t => {
            t.open && (this.loading = !0),
            t.open || (this.loading = !1)
        }
        )
    }
    disconnectedCallback() {
...
var Ka = Object.defineProperty
  ...
  , ht = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Ya(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Ka(e, a, o),
    o
}
...
let K = class extends m {
    ...
    svgLoaderTemplate() {
        ...
        let r = 0;
        a.includes("%") ? r = 88 / 100 * parseInt(a, 10) : r = parseInt(a, 10),
        r *= 1.17;
        const o = 317 - r * 1.57
          , i = 425 - r * 1.8;
...
var Qa = Object.defineProperty
  ...
  , wt = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Xa(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Qa(e, a, o),
    o
}
...
var tr = Object.defineProperty
  ...
  , or = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? er(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && tr(e, a, o),
    o
}
...
var rr = Object.defineProperty
  ...
  , nr = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? ir(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && rr(e, a, o),
    o
}
...
;
me.styles = [p.globalCss, ar],
me = nr([h("w3m-legal-notice")], me);
...
var sr = Object.defineProperty
  ...
  , dr = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? cr(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && sr(e, a, o),
    o
}
...
var hr = Object.defineProperty
  ...
  , we = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? wr(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && hr(e, a, o),
    o
}
...
var gr = Object.defineProperty
  ...
  , Bt = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? ur(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && gr(e, a, o),
    o
}
...
var br = Object.defineProperty
  ...
  , St = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? fr(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && br(e, a, o),
    o
}
...
var $r = Object.defineProperty
  ...
  , Ir = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Or(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && $r(e, a, o),
    o
}
...
let pe = class extends m {
    ...
    render() {
        ...
        return l`<button @click="${this.onClick}" data-testid="partial-all-wallets-button"><div class="w3m-icons">${a.map(r => {
            ...
            return i ? l`<img crossorigin="anonymous" src="${i}">` : w.WALLET_PLACEHOLDER
        }
        )} ${[...Array(4 - a.length)].map( () => w.WALLET_PLACEHOLDER)}</div><w3m-text variant="xsmall-regular">View All</w3m-text></button>`
    }
}
;
...
var Ar = Object.defineProperty
  ...
  , Ut = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? jr(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Ar(e, a, o),
    o
}
...
var Wr = Object.defineProperty
  ...
  , De = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Mr(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Wr(e, a, o),
    o
}
...
let zt = class extends m {
    ...
    async onCopyAddress() {
        var t;
        try {
            await navigator.clipboard.writeText((t = k.state.address) != null ? t : ""),
...
var Lr = Object.defineProperty
  ...
  , _r = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Tr(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Lr(e, a, o),
    o
}
...
;
ge.styles = [p.globalCss],
ge = _r([h("w3m-connect-wallet-view")], ge);
...
var Rr = Object.defineProperty
  ...
  , Ze = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Dr(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Rr(e, a, o),
    o
}
...
let Vt = class extends m {
    ...
    openDesktopApp() {
        ...
        s.setRecentWallet(e),
        this.onFormatAndRedirect(t)
    }
    render() {
        const {name: t, id: e, image_id: a} = u.getWalletRouterData()
          , {isMobile: r, isInjected: o, isWeb: i} = s.getCachedRouterWalletPlatforms();
...
var Hr = Object.defineProperty
  ...
  , Sr = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Br(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Hr(e, a, o),
    o
}
...
;
ue.styles = [p.globalCss, Zr],
ue = Sr([h("w3m-get-wallet-view")], ue);
...
var zr = Object.defineProperty
  ...
  , Gr = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Vr(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && zr(e, a, o),
    o
}
...
;
ve.styles = [p.globalCss, Ur],
ve = Gr([h("w3m-help-view")], ve);
...
var qr = Object.defineProperty
  ...
  , He = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Kr(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && qr(e, a, o),
    o
}
...
let Gt = class extends m {
    ...
    render() {
        const {name: t, id: e, image_id: a} = u.getWalletRouterData()
          , {isMobile: r, isDesktop: o, isWeb: i} = s.getCachedRouterWalletPlatforms();
...
var Qr = Object.defineProperty
  ...
  , Jr = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? Xr(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Qr(e, a, o),
    o
}
...
let be = class extends m {
    ...
    render() {
        const {name: t, id: e, image_id: a, homepage: r} = u.getWalletRouterData();
...
;
be.styles = [p.globalCss, Yr],
be = Jr([h("w3m-install-wallet-view")], be);
...
var ei = Object.defineProperty
  ...
  , Be = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? oi(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && ei(e, a, o),
    o
}
...
let Ft = class extends m {
    ...
    openMobileApp(t=!1) {
        ...
        s.setRecentWallet(a),
        this.onFormatAndRedirect(e, t)
    }
    onGoToAppStore(t) {
        t && u.openHref(t, "_blank")
    }
    render() {
        const {name: t, id: e, image_id: a, app: r, mobile: o} = u.getWalletRouterData()
...
var ri = Object.defineProperty
  ...
  , ni = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? ii(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && ri(e, a, o),
    o
}
...
let fe = class extends m {
    render() {
        const {name: t, id: e, image_id: a} = u.getWalletRouterData()
          , {isInjected: r, isDesktop: o, isWeb: i} = s.getCachedRouterWalletPlatforms();
...
var li = Object.defineProperty
  ...
  , ci = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? si(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && li(e, a, o),
    o
}
...
;
xe.styles = [p.globalCss],
xe = ci([h("w3m-qrcode-view")], xe);
...
var Ge = Object.defineProperty
  ...
  , vi = (t, e) => mi(t, wi(e))
  , ye = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? hi(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Ge(e, a, o),
    o
}
    ...
    async onSelectChain(t) {
        try {
            ...
            x.reset("Account")) : x.push("SwitchNetwork", {
                SwitchNetwork: t
            }) : a ? (O.setSelectedChain(t),
            D.close()) : (O.setSelectedChain(t),
            x.push("ConnectWallet"))
        } catch (e) {
            console.error(e),
            j.openToast("Unsupported chain", "error")
        }
    }
    isUnsuportedChainId(t) {
        return typeof this.connectedChains == "string" && this.connectedChains !== "ALL" ? (this.isUnsupportedChains = !0,
        !0) : Array.isArray(this.connectedChains) && !this.connectedChains.includes(String(t)) ? (this.isUnsupportedChains = !0,
        !0) : !1
    }
    render() {
        const {chains: t} = O.state
          , e = t == null ? void 0 : t.map(r => vi(ui({}, r), {
...
var fi = Object.defineProperty
  ...
  , ze = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? xi(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && fi(e, a, o),
    o
}
...
var Ci = Object.defineProperty
  ...
  , Mt = (t, e, a, r) => {
    for (var o = r > 1 ? void 0 : r ? ki(e, a) : e, i = t.length - 1, n; i >= 0; i--)
        (n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
    return r && o && Ci(e, a, o),
    o
}
...
let at = class extends m {
    ...
    async fetchWallets() {
        ...
        if (!this.endReached && (this.firstFetch || o > Ce && r.length < o))
            try {
                ...
                await Promise.all([...d.map(async y => s.preloadImage(y)), ...v.map(async y => s.preloadImage(y)), u.wait(300)]),
                this.endReached = this.isLastPage()
            } catch (n) {
                console.error(n),
                j.openToast(s.getErrorMessage(n), "error")
            } finally {
                this.loading = !1,
                this.firstFetch = !1
            }
    ...
    render() {
        ...
        o && (i = i.filter( ({values: Z}) => s.caseSafeIncludes(Z[0], this.search)),
        n = n.filter( ({values: Z}) => s.caseSafeIncludes(Z[0], this.search)),
        d = d.filter( ({values: Z}) => s.caseSafeIncludes(Z[0], this.search))),
        i = i.filter(Z => !d.find(_ => s.caseSafeIncludes(Z.values[0], _.values[0])));
...
let Kt = class extends m {
    ...
    render() {
        const {name: t, id: e, image_id: a} = u.getWalletRouterData()
          , {isMobile: r, isInjected: o, isDesktop: i} = s.getCachedRouterWalletPlatforms()
          , n = u.isMobile();
...
export {Ot as W3mAccountButton, mt as W3mConnectButton, et as W3mCoreButton, Pt as W3mModal, pt as W3mNetworkSwitch, F as W3mQrCode};
