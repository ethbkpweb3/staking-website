...
var qe = Object.defineProperty,
    ...
    Lt = (t, e) => {
        ...
        if (ke)
            for (var a of ke(e)) Ye.call(e, a) && $e(t, a, e[a]);
        return t
    };
...
var to = Object.defineProperty,
    ...
    bt = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? eo(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let Y = class extends m {
    ...
    render() {
        return l `<button data-testid="component-button-box" @click="${this.onClick}" .disabled="${!!this.loading}"><div>${this.loading?l`<w3m-spinner size="${20}" color="fill"></w3m-spinner>`:l`${this.icon}`}</div><w3m-text variant="xsmall-regular" color="accent">${this.label}</w3m-text></button>`
    }
};
Y.styles = [p.globalCss, Je], bt([c()], Y.prototype, "icon", 2), bt([c()], Y.prototype, "label", 2), bt([c()], Y.prototype, "loading", 2), bt([c()], Y.prototype, "onClick", 2), Y = bt([h("w3m-box-button")], Y);
...
var ao = Object.defineProperty,
    ...
    st = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? ro(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let G = class extends m {
    ...
    render() {
        ...
        let e = "inverse";
        return this.variant === "ghost" && (e = "secondary"), this.variant === "outline" && (e = "accent"), l `<button class="${P(t)}" data-testid="component-button" ?disabled="${this.disabled}" @click="${this.onClick}">${this.iconLeft}<w3m-text variant="small-regular" color="${e}"><slot></slot></w3m-text>${this.iconRight}</button>`
    }
};
G.styles = [p.globalCss, oo], st([c()], G.prototype, "disabled", 2), st([c()], G.prototype, "iconLeft", 2), st([c()], G.prototype, "iconRight", 2), st([c()], G.prototype, "onClick", 2), st([c()], G.prototype, "variant", 2), G = st([h("w3m-button")], G);
...
var no = Object.defineProperty,
    ...
    Yt = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? lo(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let ft = class extends m {
    ...
    render() {
        ...
        return l `<button ?disabled="${this.disabled}" data-testid="component-big-button" class="${P(t)}"><slot></slot></button>`
    }
};
ft.styles = [p.globalCss, io], Yt([c()], ft.prototype, "disabled", 2), Yt([c()], ft.prototype, "variant", 2), ft = Yt([h("w3m-button-big")], ft);
...
var co = Object.defineProperty,
    ...
    ho = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? mo(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
var po = Object.defineProperty,
    ...
    Ie = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? go(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
        return r && o && po(e, a, o), o
    };
let Tt = class extends m {
    constructor() {
        super(), this.isHelp = !1, this.unsubscribeRouter = void 0, this.unsubscribeRouter = x.subscribe(t => {
    ...
    logoTemplate() {
        var t;
        const e = (t = V.state.themeVariables) == null ? void 0 : t["--w3m-logo-image-url"];
        return e ? l `<img crossorigin="anonymous" src="${e}" data-testid="component-modal-backcard">` : w.WALLET_CONNECT_LOGO
    }
    render() {
        const t = {
            "w3m-help-active": this.isHelp
        };
        return l `<div class="w3m-toolbar-placeholder"></div><div class="w3m-toolbar">${this.logoTemplate()}<div class="${P(t)}"><button @click="${this.onHelp}">${w.HELP_ICON}</button> <button @click="${D.close}">${w.CROSS_ICON}</button></div></div>`
    }
};
Tt.styles = [p.globalCss, wo], Ie([f()], Tt.prototype, "isHelp", 2), Tt = Ie([h("w3m-modal-backcard")], Tt);
const uo = g `main{padding:20px;padding-top:0;width:100%}`;
var vo = Object.defineProperty,
    bo = Object.getOwnPropertyDescriptor,
    fo = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? bo(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
var yo = Object.defineProperty,
    ...
    ko = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Co(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
var Oo = Object.defineProperty,
    ...
    xt = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Io(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let Q = class extends m {
    ...
    render() {
        const t = {
            ...
            a = this.title ? l `<w3m-text variant="big-bold">${this.title}</w3m-text>` : l `<slot></slot>`;
        return l `<header class="${P(t)}">${e?this.backBtnTemplate():null} ${a} ${this.onAction?this.actionBtnTemplate():null}</header>`
    }
};
Q.styles = [p.globalCss, $o], xt([c()], Q.prototype, "title", 2), xt([c()], Q.prototype, "onAction", 2), xt([c()], Q.prototype, "actionIcon", 2), xt([c()], Q.prototype, "border", 2), Q = xt([h("w3m-modal-header")], Q);
const Eo = {
    ...
    R = {
        ...
        manualWallets() {
            ...
            const {
                mobileWallets: a,
                desktopWallets: r
            } = L.state, o = (t = R.recentWallet()) == null ? void 0 : t.id, i = u.isMobile() ? a : r, n = i == null ? void 0 : i.filter(d => o !== d.id);
            return (e = u.isMobile() ? n == null ? void 0 : n.map(({
                id: d,
                name: v,
                links: y
            }) => ({
        ...
        installedInjectedWallets() {
            ...
            let a = e.filter(({
                injected: r
            }) => !!r.some(o => W.client().safeCheckInjectedProvider(o.injected_id) && o.namespace === t));
            return a.length > 1 && (a = a.filter(({
                injected: r
            }) => !!r.map(({
                injected_id: i
            }) => i).every(i => i !== "isMetaMask"))), a.length ? a : [{
                name: "Browser",
                id: "browser",
                image_id: void 0
            }]
        ...
        injectedWallets() {
            ...
            return o.filter(({
                ...
                const d = u.isArray(t) ? t : [],
                    v = u.isArray(e) ? e : [];
                return !!n.some(y => y.namespace === r && !d.includes(i) && !v.includes(i))
            })
        },
        recentWallet() {
        ...
        recomendedWallets(t = !1) {
            var e;
            const a = R.installedInjectedWallets().map(({
                    id: n
                }) => n),
    ...
    s = {
        ...
        getChainIcon(t) {
            ...
            return (e = o == null ? void 0 : o[t]) != null ? e : r && a ? I.getAssetImageUrl(a) : ""
        },
        getTokenIcon(t) {
            var e, a;
            ...
            return (a = i == null ? void 0 : i[t]) != null ? a : o && r ? I.getAssetImageUrl(r) : ""
        },
        isMobileAnimation() {
        ...
        async preloadImage(t) {
            const e = new Promise((a, r) => {
                const o = new Image;
                o.onload = a, o.onerror = r, o.crossOrigin = "anonymous", o.src = t
            });
        ...
        handleMobileLinking(t) {
            const {
                ...
                mobile: a,
                name: r
            } = t, o = a == null ? void 0 : a.native, i = a == null ? void 0 : a.universal;
            s.setRecentWallet(t);

            function n(d) {
                let v = "";
                o ? v = u.formatUniversalUrl(o, d, r) : i && (v = u.formatNativeUrl(i, d, r)), u.openHref(v, "_self")
            }
            n(e)
        },
        ...
        async handleUriCopy() {
            try {
                ...
                await navigator.clipboard.writeText(t), j.openToast("Link copied", "success")
            } catch {
        ...
        async handleConnectorConnection(t, e) {
            try {
                ...
                await W.client().connectConnector(t, a == null ? void 0 : a.id), D.close()
            } catch (a) {
        ...
        getCustomImageUrls() {
            const {
                chainImages: t,
                walletImages: e
            } = L.state, a = Object.values(t ? ? {}), r = Object.values(e ? ? {});
        ...
        generateAvatarColors(t) {
            ...
            a == null || a.forEach(i => {
                let n = 0;
                for (let v = 0; v < i.length; v += 1) n = i.charCodeAt(v) + ((n << 5) - n), n = n & n;
                const d = [0, 0, 0];
                for (let v = 0; v < 3; v += 1) {
                    const y = n >> v * 8 & 255;
                    d[v] = y
        ...
        getCachedRouterWalletPlatforms() {
            const {
                ...
                mobile: a,
                injected: r
            } = u.getWalletRouterData(), o = R.installedInjectedWallets(), i = !!(r != null && r.length), n = o.some(H => H.id === t), d = !!(e != null && e.native), v = !!(e != null && e.universal), y = !!(a != null && a.native) || !!(a != null && a.universal);
            return {
        ...
        goToConnectingView(t) {
            ...
            e ? i ? x.push("InjectedConnecting") : o ? x.push("MobileConnecting") : r ? x.push("WebConnecting") : x.push("InstallWallet") : i ? x.push("InjectedConnecting") : a ? x.push("DesktopConnecting") : r ? x.push("WebConnecting") : o ? x.push("MobileQrcodeConnecting") : x.push("InstallWallet")
        },
        getWagmiWalletType() {
...
var Po = Object.defineProperty,
    ...
    te = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Wo(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
        return r && o && Po(e, a, o), o
    };
let yt = class extends m {
    constructor() {
        super(), this.view = x.state.view, this.prevView = x.state.view, this.unsubscribe = void 0, this.oldHeight = "0px", this.resizeObserver = void 0, this.unsubscribe = x.subscribe(t => {
    ...
    firstUpdated() {
        this.resizeObserver = new ResizeObserver(([t]) => {
            ...
            this.oldHeight !== "0px" && rt(this.routerEl, {
    ...
    async onChangeRoute() {
        await rt(this.routerEl, {
            opacity: [1, 0],
            scale: [1, 1.02]
        }, {
            duration: .15,
            delay: .1
        }).finished, this.view = x.state.view, rt(this.routerEl, {
            opacity: [0, 1],
            scale: [.99, 1]
        }, {
            duration: .37,
...
yt.styles = [p.globalCss, jo], te([f()], yt.prototype, "view", 2), te([f()], yt.prototype, "prevView", 2), yt = te([h("w3m-modal-router")], yt);
...
var Lo = Object.defineProperty,
    ...
    Ee = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? To(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
        return r && o && Lo(e, a, o), o
    };
let _t = class extends m {
    constructor() {
        super(), this.open = !1, this.unsubscribe = void 0, this.timeout = void 0, this.unsubscribe = j.subscribe(t => {
            t.open ? (this.open = !0, this.timeout = setTimeout(() => j.closeToast(), 2200)) : (this.open = !1, clearTimeout(this.timeout))
        })
    }
    disconnectedCallback() {
        var t;
        (t = this.unsubscribe) == null || t.call(this), clearTimeout(this.timeout), j.closeToast()
    }
    render() {
        const {
            message: t,
        ...
        return this.open ? l `<div data-testid="component-modal-toast" class="${P(a)}">${e==="success"?w.CHECKMARK_ICON:null} ${e==="error"?w.CROSS_ICON:null}<w3m-text variant="small-regular">${t}</w3m-text></div>` : null
    }
};
_t.styles = [p.globalCss, Mo], Ee([f()], _t.prototype, "open", 2), _t = Ee([h("w3m-modal-toast")], _t);
...
let X = class extends m {
    ...
    render() {
        ...
        return l `<button data-testid="component-network-button" @click="${this.onClick}" class="${P(t)}"><w3m-network-image chainId="${this.chainId}"></w3m-network-image><w3m-text variant="xsmall-regular">${this.name}</w3m-text></button>`
    }
};
X.styles = [p.globalCss, _o], Ct([c()], X.prototype, "onClick", 2), Ct([c()], X.prototype, "name", 2), Ct([c()], X.prototype, "chainId", 2), Ct([c()], X.prototype, "unsupported", 2), X = Ct([h("w3m-network-button")], X);
...
var Zo = Object.defineProperty,
    ...
    Ae = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Ho(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
function So(t, e) {
    const a = Array.prototype.slice.call(Fe.create(t, {
            errorCorrectionLevel: e
        }).modules.data, 0),
        r = Math.sqrt(a.length);
    return a.reduce((o, i, n) => (n % r === 0 ? o.push([i]) : o[o.length - 1].push(i)) && o, [])
}
const Uo = {
        generate(t, e, a) {
            const r = "#141414",
            ...
            v.forEach(({
                ...
                for (let B = 0; B < v.length; B += 1) {
                    const lt = d * (U - B * 2);
                    i.push(b `<rect fill="${B%2===0?r:o}" height="${lt}" rx="${lt*N}" ry="${lt*N}" width="${lt}" x="${T+d*B}" y="${$+d*B}">`)
                }
            });
            ...
            n.forEach((E, C) => {
                E.forEach((T, $) => {
                    if (n[C][$] && !(C < U && $ < U || C > n.length - (U + 1) && $ < U || C < U && $ > n.length - (U + 1)) && !(C > H && C < Z && $ > H && $ < Z)) {
                        const N = C * d + d / 2,
                            B = $ * d + d / 2;
                        _.push([N, B])
                    }
            ...
            return _.forEach(([E, C]) => {
                ...
                C.forEach(([T, $]) => {
                    i.push(b `<line x1="${E}" x2="${E}" y1="${T}" y2="${$}" stroke="${r}" stroke-width="${d/(je/2)}" stroke-linecap="round">`)
                })
            }), i
        }
    },
...
let F = class extends m {
    ...
    svgTemplate() {
        ...
        return b `<svg height="${t}" width="${t}" data-testid="component-qrcode-svg">${Uo.generate(this.uri,t,t/4)}</svg>`
    }
    render() {
        const t = {
            "w3m-dark": V.state.themeMode === "dark"
        };
        return l `<div style="${`width: ${this.size}px`}" class="${P(t)}">${this.walletId||this.imageUrl?l`<w3m-wallet-image walletId="${this.walletId}" imageId="${this.imageId}" imageUrl="${this.imageUrl}"></w3m-wallet-image>`:w.WALLET_CONNECT_ICON_COLORED} ${this.svgTemplate()}</div>`
    }
};
F.styles = [p.globalCss, zo], ct([c()], F.prototype, "uri", 2), ct([c({
    type: Number
})], F.prototype, "size", 2), ct([c()], F.prototype, "imageId", 2), ct([c()], F.prototype, "walletId", 2), ct([c()], F.prototype, "imageUrl", 2), F = ct([h("w3m-qrcode")], F);
...
var qo = Object.defineProperty,
    ...
    Pe = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Ko(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
Rt.styles = [p.globalCss, Fo], Pe([c()], Rt.prototype, "onChange", 2), Rt = Pe([h("w3m-search-input")], Rt);
...
var Qo = Object.defineProperty,
    ...
    oe = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Xo(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
        return r && o && Qo(e, a, o), o
    };
...
kt.styles = [p.globalCss, Yo], oe([c()], kt.prototype, "color", 2), oe([c({
    type: Number
})], kt.prototype, "size", 2), kt = oe([h("w3m-spinner")], kt);
...
var ta = Object.defineProperty,
    ...
    ae = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? ea(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let $t = class extends m {
    ...
    render() {
        ...
        return l `<span data-testid="component-text"><slot class="${P(t)}"></slot></span>`
    }
};
$t.styles = [p.globalCss, Jo], ae([c()], $t.prototype, "variant", 2), ae([c()], $t.prototype, "color", 2), $t = ae([h("w3m-text")], $t);
...
var aa = Object.defineProperty,
    ...
    We = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? ra(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let Dt = class extends m {
    ...
    render() {
        ...
        return e ? l `<div><img crossorigin="anonymous" src="${e}" alt="${this.id}" data-testid="component-token-image"></div>` : w.TOKEN_PLACEHOLDER
    }
};
Dt.styles = [p.globalCss, oa], We([c()], Dt.prototype, "symbol", 2), Dt = We([h("w3m-token-image")], Dt);
...
var na = Object.defineProperty,
    ...
    q = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? la(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let S = class extends m {
    ...
    render() {
        var t;
        return l `<button @click="${this.handleClick.bind(this)}" data-testid="component-wallet-button-${this.name.toLowerCase()}"><div><w3m-wallet-image walletId="${this.walletId}" imageId="${this.imageId}"></w3m-wallet-image><w3m-text variant="xsmall-regular">${(t=this.label)!=null?t:s.getWalletName(this.name,!0)}</w3m-text>${this.sublabelTemplate()}</div></button>`
    }
};
S.styles = [p.globalCss, ia], q([c()], S.prototype, "onClick", 2), q([c()], S.prototype, "name", 2), q([c()], S.prototype, "walletId", 2), q([c()], S.prototype, "label", 2), q([c()], S.prototype, "imageId", 2), q([c()], S.prototype, "installed", 2), q([c()], S.prototype, "recent", 2), S = q([h("w3m-wallet-button")], S);
...
var ca = Object.defineProperty,
    ...
    Zt = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? da(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let dt = class extends m {
    ...
    render() {
        ...
        return l `${e.length?l`<div><img crossorigin="anonymous" src="${e}" alt="${this.id}"></div>`:w.WALLET_PLACEHOLDER}`
    }
};
dt.styles = [p.globalCss, sa], Zt([c()], dt.prototype, "walletId", 2), Zt([c()], dt.prototype, "imageId", 2), Zt([c()], dt.prototype, "imageUrl", 2), dt = Zt([h("w3m-wallet-image")], dt);
var ma = Object.defineProperty,
    ha = Object.getOwnPropertyDescriptor,
    wa = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? ha(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
        return r && o && ma(e, a, o), o
    };
let Me = class extends m {
    constructor() {
        super(), this.unwatchAccount = void 0, k.getAccount(), this.fetchProfile(), this.fetchBalance(), this.unwatchAccount = W.client().watchAccount(t => {
            const {
                address: e,
                isConnected: a
            } = k.state;
            t.isConnected && t.address !== e && (this.fetchProfile(t.address), this.fetchBalance(t.address), k.setAddress(t.address)), t.isConnected || k.resetAccount(), a !== t.isConnected && D.close(), !a && t.isConnected ? nt.track({
                name: "ACCOUNT_CONNECTED"
            }) : a && !t.isConnected && nt.track({
    ...
    async fetchProfile(t) {
        ...
        if (L.state.enableAccountView && a) try {
    ...
    async fetchBalance(t) {
        if (L.state.enableAccountView) try {
...
var pa = Object.defineProperty,
    ...
    Le = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? ga(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let re = class extends m {
    ...
    async preloadListings() {
        ...
        if (L.state.enableExplorer) {
            ...
            await Promise.all([I.getRecomendedWallets(), I.getInjectedWallets()]), O.setIsDataLoaded(!0);
            const {
                recomendedWallets: a
            } = I.state, r = R.installedInjectedWallets(), o = (t = e == null ? void 0 : e.map(d => s.getChainIcon(d.id))) != null ? t : [], i = a.map(d => s.getWalletIcon(d)), n = r.map(d => s.getWalletIcon(d));
...
Le([f()], re.prototype, "preload", 2), re = Le([h("w3m-explorer-context")], re);
var ua = Object.defineProperty,
    va = Object.getOwnPropertyDescriptor,
    Te = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? va(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let ie = class extends m {
    constructor() {
        ...
        this.activeChainId = t == null ? void 0 : t.id, this.unwatchNetwork = W.client().watchNetwork(e => {
            const a = e.chain;
            a && this.activeChainId !== a.id && (O.setSelectedChain(a), this.activeChainId = a.id, k.resetBalance(), this.fetchBalance())
        })
    }
    disconnectedCallback() {
        var t;
...
Te([f()], ie.prototype, "activeChainId", 2), ie = Te([h("w3m-network-context")], ie);
var ba = Object.defineProperty,
    fa = Object.getOwnPropertyDescriptor,
    xa = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? fa(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
        return r && o && ba(e, a, o), o
    };
let _e = class extends m {
    constructor() {
        super(), this.unsubscribeTheme = void 0, p.setTheme(), this.unsubscribeTheme = V.subscribe(p.setTheme), this.preloadThemeImages()
    }
    disconnectedCallback() {
        var t;
    ...
    async preloadThemeImages() {
        try {
            const {
                themeVariables: t
            } = V.state, e = [t == null ? void 0 : t["--w3m-background-image-url"], t == null ? void 0 : t["--w3m-logo-image-url"]].filter(Boolean);
...
var ya = Object.defineProperty,
    ...
    ka = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Ca(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let Re = class extends m {
    constructor() {
        super(), this.unwatchOptions = void 0, this.unwatchAccount = void 0, this.unwatchWcConnection = void 0, this.timeout = void 0, this.isGenerated = !1, this.selectedChainId = (Ne = O.state.selectedChain) == null ? void 0 : Ne.id, this.isAccountConnected = k.state.isConnected, this.lastRetry = Date.now(), this.unwatchOptions = O.subscribe(t => {
            var e, a;
    ...
    disconnectedCallback() {
        var t, e, a;
        (t = this.unwatchOptions) == null || t.call(this), (e = this.unwatchAccount) == null || e.call(this), (a = this.unwatchWcConnection) == null || a.call(this)
    }
    async connectAndWait() {
        ...
        if (clearTimeout(this.timeout), !this.isAccountConnected && t) {
            this.isGenerated = !0, this.timeout = setTimeout(this.connectAndWait.bind(this), $a);
            try {
                const {
                    selectedChain: e
                } = O.state;
                await W.client().connectWalletConnect(a => A.setPairingUri(a), e == null ? void 0 : e.id)
            } catch (e) {
                console.error(e), A.setPairingError(!0), j.openToast("Connection request declined", "error"), Date.now() - this.lastRetry >= Oa && (this.lastRetry = Date.now(), this.connectAndWait())
            }
        }
    }
};
...
var Ea = Object.defineProperty,
    ...
    ne = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Aa(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let Ot = class extends m {
    ...
    accountTemplate() {
        ...
        return l `${t?l`<w3m-avatar data-testid="partial-account-avatar"></w3m-avatar>`:null}<w3m-address-text data-testid="partial-account-address"></w3m-address-text>`
    }
    render() {
        ...
        return t ? l `<div><w3m-balance data-testid="partial-account-balance"></w3m-balance><button @click="${this.onOpen}" class="${P(e)}" data-testid="partial-account-open-button">${this.accountTemplate()}</button></div>` : l `<w3m-button-big @click="${this.onOpen}" data-testid="partial-account-open-button">${this.accountTemplate()}</w3m-button-big>`
    }
};
Ot.styles = [p.globalCss, Ia], ne([c()], Ot.prototype, "balance", 2), ne([c()], Ot.prototype, "avatar", 2), Ot = ne([h("w3m-account-button")], Ot);
...
var Pa = Object.defineProperty,
    ...
    le = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Wa(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
        return r && o && Pa(e, a, o), o
    };
let It = class extends m {
    constructor() {
        ...
        this.chainId = t == null ? void 0 : t.id, this.label = t == null ? void 0 : t.name, this.unsubscribeNetwork = O.subscribe(({
            selectedChain: e
        }) => {
    ...
    render() {
        const {
            chains: t,
            selectedChain: e
        } = O.state, a = t == null ? void 0 : t.map(i => i.id), r = e && (a == null ? void 0 : a.includes(e.id)), o = t && t.length <= 1 && r;
        return l `<button @click="${this.onClick}" ?disabled="${o}"><w3m-network-image chainId="${it(this.chainId)}"></w3m-network-image><w3m-text variant="xsmall-regular" color="accent">${this.label}</w3m-text></button>`
    }
};
It.styles = [p.globalCss, ja], le([f()], It.prototype, "chainId", 2), le([f()], It.prototype, "label", 2), It = le([h("w3m-account-network-button")], It);
...
var La = Object.defineProperty,
    ...
    Et = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Ta(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
        return r && o && La(e, a, o), o
    };
let J = class extends m {
    constructor() {
        super(), this.address = void 0, this.name = void 0, this.loading = !0, this.variant = "button", this.unsubscribeAccount = void 0, this.address = k.state.address, this.name = k.state.profileName, this.loading = !!k.state.profileLoading, this.unsubscribeAccount = k.subscribe(({
            address: t,
            profileName: e,
            profileLoading: a
        }) => {
    ...
    render() {
        ...
        return l `<w3m-text class="${P(a)}" data-testid="partial-address-text" variant="${e?"medium-regular":"big-bold"}" color="${e?"inverse":"primary"}">${this.name?this.name:s.truncate((t=this.address)!=null?t:"")}</w3m-text>`
    }
};
J.styles = [p.globalCss, Ma], Et([f()], J.prototype, "address", 2), Et([f()], J.prototype, "name", 2), Et([f()], J.prototype, "loading", 2), Et([c()], J.prototype, "variant", 2), J = Et([h("w3m-address-text")], J);
const M = {
        onConnecting(t) {
        ...
        manualWalletsTemplate() {
            return R.manualWallets().map(t => l `<w3m-wallet-button walletId="${t.id}" name="${t.name}" .onClick="${()=>this.onConnecting(t)}"></w3m-wallet-button>`)
        },
        recomendedWalletsTemplate(t = !1) {
            return R.recomendedWallets(t).map(e => l `<w3m-wallet-button name="${e.name}" walletId="${e.id}" imageId="${e.image_id}" .onClick="${()=>this.onConnecting(e)}"></w3m-wallet-button>`)
        },
        externalWalletsTemplate() {
            return R.externalWallets().map(t => l `<w3m-wallet-button name="${t.name}" walletId="${t.id}" .onClick="${()=>this.onExternal(t.id)}"></w3m-wallet-button>`)
        },
        ...
        installedInjectedWalletsTemplate() {
            return R.installedInjectedWallets().map(t => l `<w3m-wallet-button .installed="${!0}" name="${t.name}" walletId="${t.id}" imageId="${t.image_id}" .onClick="${()=>this.onConnecting(t)}"></w3m-wallet-button>`)
        },
        injectedWalletsTemplate() {
            return R.injectedWallets().map(t => l `<w3m-wallet-button name="${t.name}" walletId="${t.id}" imageId="${t.image_id}" .onClick="${()=>this.onConnecting(t)}"></w3m-wallet-button>`)
        }
    },
...
var Ha = Object.defineProperty,
    ...
    At = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Ba(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
        return r && o && Ha(e, a, o), o
    };
let tt = class extends m {
    constructor() {
        super(), this.address = void 0, this.avatar = void 0, this.loading = !0, this.size = "small", this.unsubscribeAccount = void 0, this.address = k.state.address, this.avatar = k.state.profileAvatar, this.loading = !!k.state.profileLoading, this.unsubscribeAccount = k.subscribe(({
            address: t,
            profileAvatar: e,
            profileLoading: a
        }) => {
    ...
    render() {
        ...
        return this.avatar ? l `<img crossorigin="anonymous" class="${P(t)}" src="${this.avatar}" data-testid="partial-avatar-image">` : this.address ? (s.generateAvatarColors(this.address), l `<div class="${P(t)}">${this.loading?l`<div class="w3m-loader"></div>`:null}</div>`) : null
    }
};
tt.styles = [p.globalCss, Za], At([f()], tt.prototype, "address", 2), At([f()], tt.prototype, "avatar", 2), At([f()], tt.prototype, "loading", 2), At([c()], tt.prototype, "size", 2), tt = At([h("w3m-avatar")], tt);
...
var Ua = Object.defineProperty,
    ...
    ce = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? za(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
        return r && o && Ua(e, a, o), o
    };
let jt = class extends m {
    constructor() {
        var t, e;
        super(), this.symbol = void 0, this.amount = void 0, this.unsubscribeAccount = void 0, this.symbol = (t = k.state.balance) == null ? void 0 : t.symbol, this.amount = (e = k.state.balance) == null ? void 0 : e.amount, this.unsubscribeAccount = k.subscribe(({
            balance: a
        }) => {
    ...
    render() {
        let t = "_._";
        return this.amount === "0.0" ? t = "0" : typeof this.amount == "string" && this.amount.length > 6 ? t = this.amount.substring(0, 6) : typeof this.amount == "string" && (t = this.amount), l `<div><w3m-token-image symbol="${it(this.symbol)}" data-testid="partial-balance-token-image"></w3m-token-image><w3m-text variant="medium-regular" color="primary" data-testid="partial-balance-token-text">${t} ${this.symbol}</w3m-text></div>`
    }
};
jt.styles = [p.globalCss, Sa], ce([f()], jt.prototype, "symbol", 2), ce([f()], jt.prototype, "amount", 2), jt = ce([h("w3m-balance")], jt);
...
let mt = class extends m {
    constructor() {
        super(), this.loading = !1, this.label = "Connect Wallet", this.icon = "show", this.modalUnsub = void 0, this.modalUnsub = D.subscribe(t => {
    ...
    async onConnect() {
        this.loading = !0, nt.click({
            name: "CONNECT_BUTTON"
        }), await D.open(), D.state.open || (this.loading = !1)
    }
    async onDisconnect() {
        nt.click({
    ...
    render() {
        return l `<w3m-button-big .disabled="${this.loading}" @click="${this.onClick}" data-testid="partial-connect-button">${this.loading?l`<w3m-spinner data-testid="partial-connect-spinner"></w3m-spinner><w3m-text variant="medium-regular" color="accent" data-testid="partial-connect-text">Connecting...</w3m-text>`:l`${this.iconTemplate()}<w3m-text variant="medium-regular" color="inverse" data-testid="partial-connect-text">${this.label}</w3m-text>`}</w3m-button-big>`
    }
};
mt.styles = [p.globalCss, Va], Ht([f()], mt.prototype, "loading", 2), Ht([c()], mt.prototype, "label", 2), Ht([c()], mt.prototype, "icon", 2), mt = Ht([h("w3m-connect-button")], mt);
...
var Ka = Object.defineProperty,
    ...
    ht = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Ya(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let K = class extends m {
    ...
    svgLoaderTemplate() {
        var t, e;
        const a = (e = (t = V.state.themeVariables) == null ? void 0 : t["--w3m-wallet-icon-large-border-radius"]) != null ? e : p.getPreset("--w3m-wallet-icon-large-border-radius");
        let r = 0;
    ...
    render() {
        ...
        return l `<div class="${P(t)}">${this.svgLoaderTemplate()}<w3m-wallet-image walletId="${it(this.walletId)}" imageId="${it(this.imageId)}" data-useid="partial-connector-wallet-image"></w3m-wallet-image></div><w3m-text variant="medium-regular" color="${this.isError?"error":"primary"}" data-useid="partial-connector-error-text">${this.isError?"Connection declined":this.label}</w3m-text>`
    }
};
K.styles = [p.globalCss, qa], ht([c()], K.prototype, "walletId", 2), ht([c()], K.prototype, "imageId", 2), ht([c()], K.prototype, "isError", 2), ht([c()], K.prototype, "isStale", 2), ht([c()], K.prototype, "label", 2), K = ht([h("w3m-connector-waiting")], K);
var Qa = Object.defineProperty,
    Xa = Object.getOwnPropertyDescriptor,
    wt = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Xa(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
        return r && o && Qa(e, a, o), o
    };
let et = class extends m {
    constructor() {
        super(), this.isConnected = !1, this.label = "Connect Wallet", this.icon = "show", this.avatar = "show", this.balance = "hide", this.unsubscribeAccount = void 0, this.isConnected = k.state.isConnected, this.unsubscribeAccount = k.subscribe(({
            isConnected: t
        }) => {
            this.isConnected = t
        })
    ...
    render() {
        const {
            enableAccountView: t
        } = L.state, e = this.balance, a = this.label, r = this.icon, o = this.avatar;
        return this.isConnected && t ? l `<w3m-account-button .balance="${e}" .avatar="${o}" data-testid="partial-core-account-button"></w3m-account-button>` : l `<w3m-connect-button label="${it(this.isConnected?"Disconnect":a)}" .icon="${r}" data-testid="partial-core-connect-button"></w3m-connect-button>`
    }
};
wt([f()], et.prototype, "isConnected", 2), wt([c()], et.prototype, "label", 2), wt([c()], et.prototype, "icon", 2), wt([c()], et.prototype, "avatar", 2), wt([c()], et.prototype, "balance", 2), et = wt([h("w3m-core-button")], et);
...
var tr = Object.defineProperty,
    ...
    or = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? er(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let de = class extends m {
    render() {
        const {
            explorerExcludedWalletIds: t,
            enableExplorer: e
        } = L.state, a = t !== "ALL" && e, r = M.manualWalletsTemplate(), o = M.recomendedWalletsTemplate(), i = M.externalWalletsTemplate(), n = M.recentWalletTemplate();
        ...
        v ? y = d.slice(0, 3) : y = d;
        const H = !!y.length;
        return l `<w3m-modal-header .border="${!0}" title="Connect your wallet" .onAction="${s.handleUriCopy}" .actionIcon="${w.COPY_ICON}" data-testid="partial-desktop-wallet-selection-header"></w3m-modal-header><w3m-modal-content data-testid="partial-desktop-wallet-selection-content"><div class="w3m-mobile-title"><div class="w3m-subtitle">${w.MOBILE_ICON}<w3m-text variant="small-regular" color="accent">Mobile</w3m-text></div><div class="w3m-subtitle">${w.SCAN_ICON}<w3m-text variant="small-regular" color="secondary">Scan with your wallet</w3m-text></div></div><w3m-walletconnect-qr></w3m-walletconnect-qr></w3m-modal-content>${H?l`<w3m-modal-footer data-testid="partial-desktop-wallet-selection-footer"><div class="w3m-desktop-title">${w.DESKTOP_ICON}<w3m-text variant="small-regular" color="accent">Desktop</w3m-text></div><div class="w3m-grid">${y} ${v?l`<w3m-view-all-wallets-button></w3m-view-all-wallets-button>`:null}</div></w3m-modal-footer>`:null}`
    }
};
de.styles = [p.globalCss, Ja], de = or([h("w3m-desktop-wallet-selection")], de);
...
var rr = Object.defineProperty,
    ...
    nr = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? ir(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
var sr = Object.defineProperty,
    ...
    dr = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? cr(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let he = class extends m {
    ...
    render() {
        ...
        v ? y = d.slice(0, 7) : y = d;
        const H = !!y.length;
        return l `<w3m-modal-header title="Connect your wallet" .onAction="${this.onQrcode}" .actionIcon="${w.QRCODE_ICON}" data-testid="partial-mobile-wallet-selection-header"></w3m-modal-header>${H?l`<w3m-modal-content data-testid="partial-mobile-wallet-selection-content"><div>${y} ${v?l`<w3m-view-all-wallets-button></w3m-view-all-wallets-button>`:null}</div></w3m-modal-content>`:null}`
    }
};
he.styles = [p.globalCss, lr], he = dr([h("w3m-mobile-wallet-selection")], he);
...
var hr = Object.defineProperty,
    ...
    we = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? wr(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
        return r && o && hr(e, a, o), o
    };
let Pt = class extends m {
    constructor() {
        super(), this.open = !1, this.active = !1, this.unsubscribeModal = void 0, this.abortController = void 0, this.unsubscribeModal = D.subscribe(t => {
    ...
    onOpenModalEvent() {
        this.toggleBodyScroll(!1), this.addKeyboardEvents(), this.open = !0, setTimeout(async () => {
            const t = s.isMobileAnimation() ? {
                ...
                e = .1,
                a = .2;
            await Promise.all([rt(this.overlayEl, {
                opacity: [0, 1]
            }, {
                delay: e,
                duration: a
            }).finished, rt(this.containerEl, t, {
                delay: e,
                duration: a
    ...
    addKeyboardEvents() {
        this.abortController = new AbortController, window.addEventListener("keydown", t => {
            var e;
            t.key === "Escape" ? D.close() : t.key === "Tab" && ((e = t.target) != null && e.tagName.includes("W3M-") || this.containerEl.focus())
...
Pt.styles = [p.globalCss, mr], we([f()], Pt.prototype, "open", 2), we([f()], Pt.prototype, "active", 2), Pt = we([h("w3m-modal")], Pt);
...
var gr = Object.defineProperty,
    ...
    Bt = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? ur(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let pt = class extends m {
    constructor() {
        ...
        this.onSetChainData(t), this.unsubscribeNetwork = O.subscribe(({
            selectedChain: e
        }) => {
    ...
    onSetChainData(t) {
        if (t) {
            const {
                chains: e
            } = O.state, a = e == null ? void 0 : e.map(r => r.id);
...
pt.styles = [p.globalCss, pr], Bt([f()], pt.prototype, "chainId", 2), Bt([f()], pt.prototype, "label", 2), Bt([f()], pt.prototype, "wrongNetwork", 2), pt = Bt([h("w3m-network-switch")], pt);
...
var br = Object.defineProperty,
    ...
    St = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? fr(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let z = class extends m {
    ...
    onMobile() {
        u.isMobile() ? x.replace("MobileConnecting") : x.replace("MobileQrcodeConnecting")
    }
    onInjected() {
        this.isInjectedInstalled ? x.replace("InjectedConnecting") : x.replace("InstallWallet")
    }
    onDesktop() {
...
z.styles = [p.globalCss, xr], ot([c()], z.prototype, "isMobile", 2), ot([c()], z.prototype, "isInjected", 2), ot([c()], z.prototype, "isInjectedInstalled", 2), ot([c()], z.prototype, "isDesktop", 2), ot([c()], z.prototype, "isWeb", 2), ot([c()], z.prototype, "isRetry", 2), z = ot([h("w3m-platform-selection")], z);
...
var $r = Object.defineProperty,
    ...
    Ir = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Or(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let pe = class extends m {
    ...
    render() {
        const {
            recomendedWallets: t
        } = I.state, e = R.manualWallets(), a = [...t, ...e].reverse().slice(0, 4);
        return l `<button @click="${this.onClick}" data-testid="partial-all-wallets-button"><div class="w3m-icons">${a.map(r=>{const o=s.getWalletIcon(r);if(o)return l`<img crossorigin="anonymous" src="${o}">`;const i=s.getWalletIcon({id:r.id});return i?l` < img crossorigin = "anonymous"
        src = "${i}" > `:w.WALLET_PLACEHOLDER})} ${[...Array(4-a.length)].map(()=>w.WALLET_PLACEHOLDER)}</div><w3m-text variant="xsmall-regular">View All</w3m-text></button>`
    }
};
pe.styles = [p.globalCss, kr], pe = Ir([h("w3m-view-all-wallets-button")], pe);
...
var Ar = Object.defineProperty,
    ...
    Ut = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? jr(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let ut = class extends m {
    constructor() {
        super(), this.walletId = "", this.imageId = "", this.uri = "", this.unwatchWcConnection = void 0, setTimeout(() => {
            ...
            this.uri = t
        }, 0), this.unwatchWcConnection = A.subscribe(t => {
    ...
    render() {
        return l `<div class="w3m-qr-container">${this.uri?l`<w3m-qrcode size="${this.overlayEl.offsetWidth}" uri="${this.uri}" walletId="${this.walletId}" imageId="${this.imageId}" data-testid="partial-qr-code"></w3m-qrcode>`:l`<w3m-spinner data-testid="partial-qr-spinner"></w3m-spinner>`}</div>`
    }
};
ut.styles = [p.globalCss, Er], Ut([c()], ut.prototype, "walletId", 2), Ut([c()], ut.prototype, "imageId", 2), Ut([f()], ut.prototype, "uri", 2), ut = Ut([h("w3m-walletconnect-qr")], ut);
...
var Wr = Object.defineProperty,
    ...
    De = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Mr(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let zt = class extends m {
    ...
    async onDisconnect() {
        this.loading || (this.loading = !0, await W.client().disconnect(), this.loading = !1)
    }
    async onCopyAddress() {
        var t;
        try {
            await navigator.clipboard.writeText((t = k.state.address) != null ? t : ""), j.openToast("Address copied", "success")
        } catch {
            j.openToast("Failed to copy", "error")
        }
    }
...
zt.styles = [p.globalCss, Pr], De([f()], zt.prototype, "loading", 2), zt = De([h("w3m-account-view")], zt);
var Lr = Object.defineProperty,
    Tr = Object.getOwnPropertyDescriptor,
    _r = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Tr(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
var Rr = Object.defineProperty,
    ...
    Ze = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Dr(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
        return r && o && Rr(e, a, o), o
    };
let Vt = class extends m {
    constructor() {
        super(), this.isError = !1, this.unwatchConnection = void 0, this.openDesktopApp(), this.unwatchConnection = A.subscribe(t => {
    ...
    onFormatAndRedirect(t) {
        const {
            desktop: e,
            name: a
        } = u.getWalletRouterData(), r = e == null ? void 0 : e.native;
        if (r) {
    ...
    openDesktopApp() {
        ...
        const {
            pairingUri: t
        } = A.state, e = u.getWalletRouterData();
...
var Hr = Object.defineProperty,
    ...
    Sr = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Br(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
        return r && o && Hr(e, a, o), o
    };
...
var zr = Object.defineProperty,
    ...
    Gr = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Vr(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
var qr = Object.defineProperty,
    ...
    He = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Kr(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
        return r && o && qr(e, a, o), o
    };
let Gt = class extends m {
    constructor() {
        super(), this.isError = !1, this.connector = W.client().getConnectorById("injected"), this.openInjectedApp()
    }
...
Gt.styles = [p.globalCss, Fr], He([f()], Gt.prototype, "isError", 2), Gt = He([h("w3m-injected-connecting-view")], Gt);
...
var Qr = Object.defineProperty,
    ...
    Jr = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? Xr(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
        return r && o && Qr(e, a, o), o
    };
...
var ei = Object.defineProperty,
    ...
    Be = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? oi(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
        return r && o && ei(e, a, o), o
    };
let Ft = class extends m {
    constructor() {
        super(), this.isError = !1, this.unwatchConnection = void 0, this.openMobileApp(), this.unwatchConnection = A.subscribe(t => {
            this.isError = t.pairingError
        })
    }
    disconnectedCallback() {
    ...
    onFormatAndRedirect(t, e = !1) {
        const {
            mobile: a,
            name: r
        } = u.getWalletRouterData(), o = a == null ? void 0 : a.native, i = a == null ? void 0 : a.universal;
        if (o && !e) {
    ...
    openMobileApp(t = !1) {
        ...
        const {
            pairingUri: e
        } = A.state, a = u.getWalletRouterData();
...
var ri = Object.defineProperty,
    ...
    ni = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? ii(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let fe = class extends m {
    render() {
        ...
        return l `<w3m-modal-header title="${t}" .onAction="${s.handleUriCopy}" .actionIcon="${w.COPY_ICON}" data-testid="view-mobile-qr-connecting-header"></w3m-modal-header><w3m-modal-content data-testid="view-mobile-qr-connecting-content"><w3m-walletconnect-qr walletId="${e}" imageId="${a}"></w3m-walletconnect-qr></w3m-modal-content><w3m-info-footer data-testid="view-mobile-qr-connecting-footer"><w3m-text color="secondary" variant="small-thin">${`Scan this QR Code with your phone's camera or inside ${t} app`}</w3m-text><w3m-platform-selection .isDesktop="${o}" .isInjected="${r}" .isWeb="${i}"></w3m-platform-selection></w3m-info-footer>`
    }
};
fe.styles = [p.globalCss, ai], fe = ni([h("w3m-mobile-qr-connecting-view")], fe);
var li = Object.defineProperty,
    si = Object.getOwnPropertyDescriptor,
    ci = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? si(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
var Ge = Object.defineProperty,
    ...
    ui = (t, e) => {
        ...
        if (Se)
            for (var a of Se(e)) gi.call(e, a) && Ue(t, a, e[a]);
        return t
    },
    vi = (t, e) => mi(t, wi(e)),
    ye = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? hi(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let Wt = class extends m {
    ...
    async onSelectChain(t) {
        try {
            ...
            r ? (e == null ? void 0 : e.id) === t.id ? x.reset("Account") : s.getWagmiWalletType() === '"walletConnect"' ? (await W.client().switchNetwork({
                chainId: t.id
            }), x.reset("Account")) : x.push("SwitchNetwork", {
                SwitchNetwork: t
            }) : a ? (O.setSelectedChain(t), D.close()) : (O.setSelectedChain(t), x.push("ConnectWallet"))
        } catch (e) {
...
var fi = Object.defineProperty,
    ...
    ze = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? xi(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
...
let qt = class extends m {
    ...
    async onSwitchNetwork() {
        try {
            ...
            await W.client().switchNetwork({
                chainId: t.id
            }), O.setSelectedChain(t), x.reset("Account")
        } catch {
            this.isError = !0
        }
    }
...
qt.styles = [p.globalCss, bi], ze([f()], qt.prototype, "isError", 2), qt = ze([h("w3m-switch-network-view")], qt);
...
var Ci = Object.defineProperty,
    ...
    Mt = (t, e, a, r) => {
        for (var o = r > 1 ? void 0 : r ? ki(e, a) : e, i = t.length - 1, n; i >= 0; i--)(n = t[i]) && (o = (r ? n(e, a, o) : n(o)) || o);
        return r && o && Ci(e, a, o), o
    };
const Ce = 40;
let at = class extends m {
    constructor() {
        super(...arguments), this.loading = !I.state.wallets.listings.length, this.firstFetch = !I.state.wallets.listings.length, this.search = "", this.endReached = !1, this.intersectionObserver = void 0, this.searchDebounce = s.debounce(t => {
            t.length >= 1 ? (this.firstFetch = !0, this.endReached = !1, this.search = t, I.resetSearch(), this.fetchWallets()) : this.search && (this.search = "", this.endReached = this.isLastPage(), I.resetSearch())
        })
    }
    firstUpdated() {
    ...
    async fetchWallets() {
        ...
        if (!this.endReached && (this.firstFetch || o > Ce && r.length < o)) try {
            this.loading = !0;
            const {
                listings: n
            } = await I.getWallets({
                ...
                search: this.search,
                version: 2
            }), d = n.map(y => s.getWalletIcon(y)), v = a.map(y => s.getWalletIcon(y));
            await Promise.all([...d.map(async y => s.preloadImage(y)), ...v.map(async y => s.preloadImage(y)), u.wait(300)]), this.endReached = this.isLastPage()
        } catch (n) {
    ...
    render() {
        const {
            ...
            listings: a
        } = this.search ? e : t, r = this.loading && !a.length, o = this.search.length >= 3;
        let i = M.injectedWalletsTemplate(),
            n = M.manualWalletsTemplate(),
            d = M.recomendedWalletsTemplate(!0);
        o && (i = i.filter(({
            values: Z
        }) => s.caseSafeIncludes(Z[0], this.search)), n = n.filter(({
            values: Z
        ...
        return l `<w3m-modal-header data-testid="view-wallet-explorer-header"><w3m-search-input .onChange="${this.onSearchChange.bind(this)}"></w3m-search-input></w3m-modal-header><w3m-modal-content class="${P(H)}" data-testid="view-wallet-explorer-content"><div class="w3m-grid">${r?null:d} ${r?null:[...Array(y)].map((Z,_)=>l`${n[_]} ${i[_]} ${a[_]?l`<w3m-wallet-button imageId="${a[_].image_id}" name="${a[_].name}" walletId="${a[_].id}" .onClick="${()=>this.onConnect(a[_])}" data-testid="view-wallet-explorer-button-${a[_].id}"></w3m-wallet-button>`:null}`)}</div><div class="w3m-placeholder-block">${v?l`<w3m-text variant="big-bold" color="secondary">No results found</w3m-text>`:null} ${!v&&this.loading?l`<w3m-spinner></w3m-spinner>`:null}</div></w3m-modal-content>`
    }
};
at.styles = [p.globalCss, yi], Mt([f()], at.prototype, "loading", 2), Mt([f()], at.prototype, "firstFetch", 2), Mt([f()], at.prototype, "search", 2), Mt([f()], at.prototype, "endReached", 2), at = Mt([h("w3m-wallet-explorer-view")], at);
...
let Kt = class extends m {
    constructor() {
        super(), this.isError = !1, this.unwatchConnection = void 0, this.openWebWallet(), this.unwatchConnection = A.subscribe(t => {
            this.isError = t.pairingError
        })
    }
    disconnectedCallback() {
    ...
    onFormatAndRedirect(t) {
        const {
            desktop: e,
            name: a
        } = u.getWalletRouterData(), r = e == null ? void 0 : e.universal;
        if (r) {
    ...
    render() {
        const {
            ...
            isInjected: o,
            isDesktop: i
        } = s.getCachedRouterWalletPlatforms(), n = u.isMobile();
        return l `<w3m-modal-header title="${t}" .onAction="${s.handleUriCopy}" .actionIcon="${w.COPY_ICON}" data-testid="view-web-connecting-header"></w3m-modal-header><w3m-modal-content data-testid="view-web-connecting-content"><w3m-connector-waiting walletId="${e}" imageId="${a}" label="${`Continue in ${t}...`}" .isError="${this.isError}" data-testid="view-web-connecting-waiting"></w3m-connector-waiting></w3m-modal-content><w3m-info-footer data-testid="view-web-connecting-footer"><w3m-text color="secondary" variant="small-thin">${`${t} web app has opened in a new tab. Go there, accept the connection, and come back`}</w3m-text><w3m-platform-selection .isMobile="${r}" .isInjected="${n?!1:o}" .isDesktop="${n?!1:i}" .isRetry="${!0}"><w3m-button .onClick="${this.openWebWallet.bind(this)}" .iconRight="${w.RETRY_ICON}" data-testid="view-web-connecting-retry-button">Retry</w3m-button></w3m-platform-selection></w3m-info-footer>`
    }
};
Kt.styles = [p.globalCss, $i], Ve([f()], Kt.prototype, "isError", 2), Kt = Ve([h("w3m-web-connecting-view")], Kt);
export {
    Ot as W3mAccountButton, mt as W3mConnectButton, et as W3mCoreButton, Pt as W3mModal, pt as W3mNetworkSwitch, F as W3mQrCode
};