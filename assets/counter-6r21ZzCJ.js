import {H as X, I as Y, r as B, j as Z} from "./index-IT1gKaF9.js";
import {i as $, a as tt, b as et, S as nt, H as at, v as V, s as st, c as rt, d as it, e as ot, f as lt, g as ut, r as ct, h as O, j as ft, k as mt, p as ht, l as pt, n as U, o as dt} from "./motion-_fLkK2fy.js";
function W(t, e, a) {
    var n;
    if (typeof t == "string") {
        let s = document;
        e && ($(!!e.current),
        s = e.current),
        a ? ((n = a[t]) !== null && n !== void 0 || (a[t] = s.querySelectorAll(t)),
        t = a[t]) : t = s.querySelectorAll(t)
    } else
...
class _ {
    ...
    setAll(e, a) {
        for (let n = 0; n < this.animations.length; n++)
            this.animations[n][e] = a
    }
    attachTimeline(e) {
        const a = this.animations.map(n => {
            if (yt() && n.attachTimeline)
                n.attachTimeline(e);
            else
                return n.pause(),
                gt(s => {
...
const wt = "easeInOut";
function Dt(t, {defaultTransition: e={}, ...a}={}, n) {
    ...
    for (let v = 0; v < t.length; v++) {
        ...
        const E = (d, g, A, M=0, b=0) => {
            const o = Vt(d)
              , {delay: D=0, times: T=ft(o), type: q="keyframes", ...J} = g;
            let {ease: F=e.ease || "easeOut", duration: y} = g;
    ...
    return i.forEach( (v, h) => {
        for (const S in v) {
            ...
            for (let g = 0; g < p.length; g++) {
                const {at: A, value: M, easing: b} = p[g];
                f.push(M),
                m.push(ht(0, w, A)),
                E.push(b || "easeOut")
            }
...
function z(t, e, a, n) {
    ...
    for (let l = 0; l < r; l++) {
        ...
        typeof c.delay == "function" && (c.delay = c.delay(l, r)),
        i.push(...dt(x, {
            ...e,
            transition: c
        }, {}))
...
function Ht(t, e, a) {
    const n = [];
    return Dt(t, e, a).forEach( ({keyframes: r, transition: i}, l) => {
        let u;
        O(l) ? u = U(l, r.default, i.default) : u = z(l, r, i),
        n.push(u)
    }
    ),
    new _(n)
...
const It = t => {
    function e(a, n, s) {
        let r;
        return jt(a) ? r = Ht(a, n, t) : At(n) ? r = z(a, n, s, t) : r = U(a, n, s),
  ...
  , kt = It();
function Bt({from: t, to: e, style: a, fixed: n}) {
    const s = B.useRef();
    return B.useEffect( () => {
        const r = s.current
          , i = kt(t, e, {
