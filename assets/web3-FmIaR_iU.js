...
class q extends Error {
    constructor(e, n) {
        super(e), this.innerError = n, this.name = this.constructor.name, typeof Error.captureStackTrace == "function" ? Error.captureStackTrace(new.target.constructor) : this.stack = new Error().stack
    }
...
class ca extends q {
    constructor() {
        super("Private key must be 32 bytes."), this.code = Zl
    }
}
class Sf extends q {
    constructor() {
        super("Invalid Private Key, Not a valid string or uint8Array"), this.code = Kl
    }
}
class kf extends q {
    constructor(e) {
        super(`"${e}"`), this.code = rf
    }
}
class uc extends q {
    constructor() {
        super("Invalid key derivation function"), this.code = Xl
    }
}
class Af extends q {
    constructor() {
        super("Key derivation failed - possibly wrong password"), this.code = Jl
    }
}
class Pf extends q {
    constructor() {
        super("Unsupported key store version"), this.code = Yl
    }
}
class Rf extends q {
    constructor() {
        super("Password cannot be empty"), this.code = Ql
    }
}
class Bf extends q {
    constructor() {
        super("Initialization vector must be 16 bytes"), this.code = ef
    }
}
class Cf extends q {
    constructor() {
        super("c > 1000, pbkdf2 is less secure with less iterations"), this.code = tf
    }
}
class kr extends q {
    constructor(e, n) {
        super(e), this.code = jl, n && (this.errorCode = n.code, this.errorReason = n.reason)
    }
    toJSON() {
...
class ks extends kr {
    constructor(e) {
        super("Connection not open", e), this.code = Dl
    }
}
class Nf extends kr {
    constructor(e) {
        super(`Maximum number of reconnect attempts reached! (${e})`), this.code = Fl
    }
}
class Of extends kr {
    constructor() {
        super("CONNECTION ERROR: Provider started to reconnect before the response got received!"), this.code = Gl
    }
}
class Lf extends kr {
    constructor(e) {
        super(`Request already sent with following id: ${e}`), this.code = Ul
    }
}
class $e extends q {
    constructor(e, n) {
        super(e), this.code = Yu, this.receipt = n
    }
}
class da extends q {
    constructor(e, n) {
        super(`The resolver at ${e} does not implement requested method: "${n}".`), this.address = e, this.name = n, this.code = Qu
    }
    toJSON() {
        return Object.assign(Object.assign({}, super.toJSON()), {
...
class Oi extends $e {
    constructor(e) {
        if (super(e.message || "Error"), this.name = "name" in e && e.name || this.constructor.name, this.stack = "stack" in e && e.stack || void 0, this.code = e.code, typeof e.data == "object") {
            let n;
            "originalError" in e.data ? n = e.data.originalError : n = e.data, this.data = n.data, this.innerError = new Oi(n)
...
class Qt extends $e {
    constructor(e) {
        super("Error happened while trying to execute a function inside a smart contract"), this.code = el, this.innerError = new Oi(e)
    }
}
class Mf extends J {
    constructor(e) {
        var n, r;
        super(`data: ${(n=e.data)!==null&&n!==void 0?n:"undefined"}, input: ${(r=e.input)!==null&&r!==void 0?r:"undefined"}`, `You can't have "data" and "input" as properties of a contract at the same time, please use either "data" or "input" instead.`), this.code = tl
    }
}
class $f extends q {
    constructor(e) {
        super(`ENS is not supported on network ${e}`), this.code = uf
    }
}
class Hf extends q {
    constructor() {
        super("Network not synced"), this.code = lf
    }
}
class ua extends q {
    constructor(e) {
        super(`Invalid parameters passed. "${typeof e<"u"?e:""}"`), this.hint = e, this.code = Ju
    }
    toJSON() {
        return Object.assign(Object.assign({}, super.toJSON()), {
            hint: this.hint
...
class As extends q {
    constructor() {
        super(...arguments), this.code = zu
    }
}
class dt extends q {
    constructor() {
        super("The method you're trying to call is not implemented."), this.code = Vu
    }
}
class lc extends q {
    constructor() {
        super(...arguments), this.code = Wu
    }
}
class jf extends q {
    constructor() {
...
class ne extends q {
    constructor(e, n) {
        super(e), this.code = Ku, this.props = n ? ? {}
    }
}
class Df extends q {
    constructor(e) {
        super(`A plugin with the namespace: ${e} has already been registered.`), this.code = Xu
    }
}
class jr extends q {
    constructor() {
        super(...arguments), this.code = ql
    }
}
class Ps extends q {
    constructor(e) {
        super(`Client URL "${e}" is invalid.`), this.code = zl
    }
}
class Ke extends q {
    constructor() {
        super(...arguments), this.code = Vl
    }
}
class Ff extends q {
    constructor() {
        super(...arguments), this.code = Wl
    }
}
class Gf extends J {
    constructor() {
        super(...arguments), this.code = nf
    }
}
class ao extends q {
    constructor(e, n) {
        super(e), this.receipt = n, this.code = nl
    }
    toJSON() {
        return Object.assign(Object.assign({}, super.toJSON()), {
...
class fc extends si {
    constructor(e, n, r, i, s, o, a) {
        super(e), this.reason = e, this.customErrorName = n, this.customErrorDecodedSignature = r, this.customErrorArguments = i, this.signature = s, this.receipt = o, this.data = a, this.code = Ll
    }
    toJSON() {
        return Object.assign(Object.assign({}, super.toJSON()), {
            reason: this.reason,
...
class hc extends ao {
 ...
 ${q.convertToString(e)}`}`, e), this.code = il
    }
}
class Uf extends ao {
    constructor() {
        super("Raw transaction undefined"), this.code = sl
    }
}
class la extends ao {
    constructor() {
        super("Transaction not found"), this.code = kl
    }
}
class qf extends J {
    constructor(e) {
        super(e, "invalid transaction with invalid sender"), this.code = ol
    }
}
class zf extends J {
    constructor(e) {
        super(e, "invalid transaction with invalid receiver"), this.code = Ol
    }
}
class Vf extends J {
    constructor() {
        super("MissingCustomChainError", "If tx.common is provided it must have tx.common.customChain"), this.code = al
    }
}
class Wf extends J {
    constructor() {
        super("MissingCustomChainIdError", "If tx.common is provided it must have tx.common.customChain and tx.common.customChain.chainId"), this.code = cl
    }
}
class Zf extends J {
    constructor(e) {
        super(JSON.stringify(e), "Chain Id doesnt match in tx.chainId tx.common.customChain.chainId"), this.code = dl
    }
}
class Kf extends J {
    constructor(e) {
        super(JSON.stringify(e), "Chain doesnt match in tx.chain tx.common.basechain"), this.code = Cl
    }
}
class Xf extends J {
    constructor(e) {
        super(JSON.stringify(e), "hardfork doesnt match in tx.hardfork tx.common.hardfork"), this.code = Nl
    }
}
class Jf extends J {
    constructor() {
        super("CommonOrChainAndHardforkError", "Please provide the common object or the chain and hardfork property but not all together."), this.code = ul
    }
}
class Yf extends J {
    constructor(e) {
        var n, r;
        super("MissingChainOrHardforkError", `When specifying chain and hardfork, both values must be defined. Received "chain": ${(n=e.chain)!==null&&n!==void 0?n:"undefined"}, "hardfork": ${(r=e.hardfork)!==null&&r!==void 0?r:"undefined"}`), this.code = ll
    }
}
class Qf extends q {
    constructor() {
        super('Missing properties in transaction, either define "gas" and "gasPrice" for type 0 transactions or "gas", "maxPriorityFeePerGas" and "maxFeePerGas" for type 2 transactions'), this.code = $l
    }
}
class eh extends J {
    constructor(e) {
        var n, r, i, s;
        super(`gas: ${(n=e.gas)!==null&&n!==void 0?n:"undefined"}, gasPrice: ${(r=e.gasPrice)!==null&&r!==void 0?r:"undefined"}, maxPriorityFeePerGas: ${(i=e.maxPriorityFeePerGas)!==null&&i!==void 0?i:"undefined"}, maxFeePerGas: ${(s=e.maxFeePerGas)!==null&&s!==void 0?s:"undefined"}`, '"gas" is missing'), this.code = fl, this.innerError = new Qf
    }
}
class th extends q {
    constructor() {
        super('Missing properties in transaction, either define "gas" and "gasPrice" for type 0 transactions or "gas", "maxPriorityFeePerGas" and "maxFeePerGas" for type 2 transactions, not both'), this.code = Hl
    }
}
class nh extends J {
    constructor(e) {
        var n, r, i, s;
        super(`gas: ${(n=e.gas)!==null&&n!==void 0?n:"undefined"}, gasPrice: ${(r=e.gasPrice)!==null&&r!==void 0?r:"undefined"}, maxPriorityFeePerGas: ${(i=e.maxPriorityFeePerGas)!==null&&i!==void 0?i:"undefined"}, maxFeePerGas: ${(s=e.maxFeePerGas)!==null&&s!==void 0?s:"undefined"}`, "transaction must specify legacy or fee market gas properties, not both"), this.code = Bl, this.innerError = new th
    }
}
class rh extends J {
    constructor(e) {
...
class ih extends J {
    constructor(e) {
        var n, r;
        super(`maxPriorityFeePerGas: ${(n=e.maxPriorityFeePerGas)!==null&&n!==void 0?n:"undefined"}, maxFeePerGas: ${(r=e.maxFeePerGas)!==null&&r!==void 0?r:"undefined"}`, "maxPriorityFeePerGas or maxFeePerGas is lower than 0"), this.code = ml
    }
}
class sh extends J {
    constructor(e) {
        super(e, "eip-1559 transactions don't support gasPrice"), this.code = pl
    }
}
class mc extends J {
    constructor(e) {
...
class oh extends J {
    constructor(e) {
        super(e, "invalid transaction object"), this.code = yl
    }
}
class ah extends J {
    constructor(e) {
        var n, r;
        super(`nonce: ${(n=e.nonce)!==null&&n!==void 0?n:"undefined"}, chainId: ${(r=e.chainId)!==null&&r!==void 0?r:"undefined"}`, "Nonce or chainId is lower than 0"), this.code = vl
    }
}
class ch extends J {
    constructor() {
        super("UnableToPopulateNonceError", "unable to populate nonce, no from address available"), this.code = bl
    }
}
class dh extends J {
    constructor() {
        super("Eip1559NotSupportedError", "Network doesn't support eip-1559"), this.code = _l
    }
}
class fa extends J {
    constructor(e) {
        super(e, "unsupported transaction type"), this.code = wl
    }
}
class pc extends J {
    constructor(e) {
        var n, r;
        super(`data: ${(n=e.data)!==null&&n!==void 0?n:"undefined"}, input: ${(r=e.input)!==null&&r!==void 0?r:"undefined"}`, `You can't have "data" and "input" as properties of transactions at the same time, please use either "data" or "input" instead.`), this.code = xl
    }
}
class uh extends q {
    constructor(e) {
	...
	Transaction Hash: ${e.transactionHash?e.transactionHash.toString():"not available"}`), this.code = Al
    }
}
...
class lh extends q {
    constructor(e) {
        super(`Transaction was not mined within ${e.numberOfSeconds} seconds. ${gc(e.transactionHash)}`), this.code = El
    }
}
class yc extends q {
    constructor(e) {
        super(`Transaction started at ${e.starterBlockNumber} but was not mined within ${e.numberOfBlocks} blocks. ${gc(e.transactionHash)}`), this.code = Pl
    }
}
class fh extends J {
    constructor(e) {
        var n, r;
        super(`receipt: ${JSON.stringify(e.receipt)}, blockHash: ${(n=e.blockHash)===null||n===void 0?void 0:n.toString()}, transactionHash: ${(r=e.transactionHash)===null||r===void 0?void 0:r.toString()}`, "Receipt missing or blockHash null"), this.code = Il
    }
}
class hh extends J {
    constructor(e) {
        super(`receipt: ${JSON.stringify(e.receipt)}`, "Receipt missing block number"), this.code = Tl
    }
}
class Rs extends q {
    constructor(e) {
        super(`Invalid signature. "${e}"`), this.code = Rl
    }
}
class ha extends J {
    constructor() {
        super("LocalWalletNotAvailableError", "Attempted to index account in local wallet, but no wallet is available"), this.code = Sl
    }
}
class mh extends q {
    constructor(e, n) {
        const r = [];
        e.forEach(i => r.push(i.keyword)), super(`The following properties are invalid for the transaction type ${n}: ${r.join(", ")}`), this.code = Ml
    }
}
class rr extends J {
    constructor(e) {
        super(e, "can not parse as byte data"), this.code = hf
    }
}
class co extends J {
    constructor(e) {
        super(e, "can not parse as number data"), this.code = mf
    }
}
class uo extends J {
    constructor(e) {
        super(e, "invalid ethereum address"), this.code = gf
    }
}
class ph extends J {
    constructor(e) {
        super(e, "not a valid string"), this.code = ff
    }
}
class vc extends J {
    constructor(e) {
        super(e, "invalid unit"), this.code = pf
    }
}
class gh extends J {
    constructor(e) {
        super(e, "can not be converted to hex"), this.code = yf
    }
}
class bc extends J {
    constructor(e) {
        super(e, "value greater than the nibble width"), this.code = Ef
    }
}
class lo extends J {
    constructor(e) {
        super(e, "not a valid boolean."), this.code = vf
    }
}
class yh extends J {
    constructor(e) {
        super(e, "not a valid unsigned integer."), this.code = bf
    }
}
class ma extends J {
    constructor(e) {
        super(e, "invalid size given."), this.code = _f
    }
}
class pa extends J {
    constructor(e) {
        super(e, "value is larger than size."), this.code = wf
    }
}
class vh extends J {
    constructor(e) {
        super(e, "invalid string given"), this.code = xf
    }
}
...
class ht extends q {
    constructor(e, n, r) {
        var i;
        super(n ? ? `Returned error: ${Array.isArray(e)?e.map(o=>ga(o)).join(","):ga(e)}`), this.code = Uu, n || (this.data = Array.isArray(e) ? e.map(o => {
            var a;
            return (a = o.error) === null || a === void 0 ? void 0 : a.data
        }) : (i = e == null ? void 0 : e.error) === null || i === void 0 ? void 0 : i.data), this.request = r;
        let s;
        "error" in e ? s = e.error : e instanceof Array && (s = e.map(o => o.error)), this.innerError = s
    }
    toJSON() {
        return Object.assign(Object.assign({}, super.toJSON()), {
            data: this.data,
...
class ar extends ht {
    constructor(e, n) {
        super(e, void 0, n), this.code = qu;
        let r;
        "error" in e ? r = e.error : e instanceof Array && (r = e.map(i => i.error)), this.innerError = r
    }
}
class ya extends q {
    constructor(e, n) {
        super(`Web3Config hardfork doesnt match in defaultHardfork ${e} and common.hardfork ${n}`), this.code = dc
    }
}
class va extends q {
    constructor(e, n) {
        super(`Web3Config chain doesnt match in defaultHardfork ${e} and common.hardfork ${n}`), this.code = dc
    }
}
...
class De extends q {
    constructor(e, n) {
        super(n ? ? _c.replace("*code*", e.error.code.toString())), this.code = e.error.code, this.id = e.id, this.jsonrpc = e.jsonrpc, this.jsonRpcError = e.error
    }
    toJSON() {
        return Object.assign(Object.assign({}, super.toJSON()), {
...
class _h extends q {
    constructor(e, n) {
        var r, i, s, o;
        if (!e) super();
        else if (!((r = Te[e]) === null || r === void 0) && r.message) super(Te[e].message);
        else {
...
class wh extends De {
    constructor(e) {
        super(e, Te[Wr].message), this.code = Wr
    }
}
class xh extends De {
    constructor(e) {
        super(e, Te[Zr].message), this.code = Zr
    }
}
class Eh extends De {
    constructor(e) {
        super(e, Te[Kr].message), this.code = Kr
    }
}
class Ih extends De {
    constructor(e) {
        super(e, Te[Xr].message), this.code = Xr
    }
}
class Th extends De {
    constructor(e) {
        super(e, Te[Jr].message), this.code = Jr
    }
}
class Sh extends De {
    constructor(e) {
        super(e, Te[Yr].message), this.code = Yr
    }
}
class kh extends De {
    constructor(e) {
        super(e, Te[ni].message), this.code = ni
    }
}
class Ah extends De {
    constructor(e) {
        super(e, Te[ei].message), this.code = ei
    }
}
class Ph extends De {
    constructor(e) {
        super(e, Te[Qr].message), this.code = Qr
    }
}
class Rh extends De {
    constructor(e) {
        super(e, Te[ii].message), this.code = ii
    }
}
class Bh extends De {
    constructor(e) {
        super(e, Te[ti].message), this.code = ti
    }
}
class Ch extends De {
    constructor(e) {
        super(e, Te[ri].message), this.code = ri
    }
}
const Ae = new Map;
Ae.set(Wr, {
...
class Nh extends q {
    constructor(e) {
        super(`Format for the type ${e} is unsupported`), this.type = e, this.code = Tf
    }
    toJSON() {
        return Object.assign(Object.assign({}, super.toJSON()), {
            type: this.type
...
if (!sm) throw new Error("Non little-endian hardware is not supported");
Array.from({
    length: 256
...
function sn(t) {
    if (typeof t == "string" && (t = Ln(t)), !Ec(t)) throw new Error(`expected Uint8Array, got ${typeof t}`);
    return t
}
...
function oi(...t) {
    ...
    let n = 0;
    return t.forEach(r => {
        if (!Ec(r)) throw new Error("Uint8Array expected");
...
function Ic(t, e) {
    if (e !== void 0 && (typeof e != "object" || !om(e))) throw new Error("Options should be object or undefined");
...
const [Sc, kc, Ac] = [
    ...
    [],
    []
], cm = BigInt(0), Xn = BigInt(1), dm = BigInt(2), um = BigInt(7), lm = BigInt(256), fm = BigInt(113);
for (let t = 0, e = Xn, n = 1, r = 0; t < 24; t++) {
    [n, r] = [r, (2 * n + 3 * r) % 5], Sc.push(2 * (5 * r + n)), kc.push((t + 1) * (t + 2) / 2 % 64);
    let i = cm;
    for (let s = 0; s < 7; s++) e = (e << Xn ^ (e >> um) * fm) % lm, e & dm && (i ^= Xn << (Xn << BigInt(s)) - Xn);
    Ac.push(i)
}
const [hm, mm] = G.split(Ac, !0), ba = (t, e, n) => n > 32 ? G.rotlBH(t, e, n) : G.rotlSH(t, e, n), _a = (t, e, n) => n > 32 ? G.rotlBL(t, e, n) : G.rotlSL(t, e, n);
    ...
    for (let r = 24 - e; r < 24; r++) {
        ...
        for (let o = 0; o < 10; o += 2) {
            const a = (o + 8) % 10,
                ...
                l = ba(d, c, 1) ^ n[a],
                f = _a(d, c, 1) ^ n[a + 1];
            for (let h = 0; h < 50; h += 10) t[o + h] ^= l, t[o + h + 1] ^= f
        }
        let i = t[2],
            s = t[3];
        for (let o = 0; o < 24; o++) {
...
class Li extends fo {
    constructor(e, n, r, i = !1, s = 24) {
        if (super(), this.blockLen = e, this.suffix = n, this.outputLen = r, this.enableXOF = i, this.rounds = s, this.pos = 0, this.posOut = 0, this.finished = !1, this.destroyed = !1, le.number(r), 0 >= this.blockLen || this.blockLen >= 200) throw new Error("Sha3 supports only keccak-f1600 function");
        this.state = new Uint8Array(200), this.state32 = Fr(this.state)
    }
    keccak() {
        pm(this.state32, this.rounds), this.posOut = 0, this.pos = 0
    }
    update(e) {
        le.exists(this);
        const {
    ...
    writeInto(e) {
        le.exists(this, !1), le.bytes(e), this.finish();
        const n = this.state,
            {
                blockLen: r
            } = this;
    ...
    xof(e) {
        return le.number(e), this.xofInto(new Uint8Array(e))
    }
    digestInto(e) {
        if (le.output(e, this), this.finished) throw new Error("digest() was already called");
    ...
    _cloneInto(e) {
        ...
        return e || (e = new Li(n, r, i, o, s)), e.state32.set(this.state32), e.pos = this.pos, e.posOut = this.posOut, e.finished = this.finished, e.rounds = s, e.suffix = r, e.outputLen = i, e.enableXOF = o, e.destroyed = this.destroyed, e
    }
}
...
class K {
    ...
    _parseSync(e) {
        ...
        if (ui(n)) throw new Error("Synchronous parse encountered promise.");
        return n
    }
    _parseAsync(e) {
        const n = this._parse(e);
...
class Xe extends K {
    _parse(e) {
        ...
        for (const s of this._def.checks)
            if (s.kind === "min") e.data.length < s.value && (i = this._getOrReturnCtx(e, i), N(i, {
                code: T.too_small,
                minimum: s.value,
                type: "string",
                inclusive: !0,
            ...
            else if (s.kind === "max") e.data.length > s.value && (i = this._getOrReturnCtx(e, i), N(i, {
            code: T.too_big,
            maximum: s.value,
            type: "string",
            inclusive: !0,
            ...
            (o || a) && (i = this._getOrReturnCtx(e, i), o ? N(i, {
                code: T.too_big,
                maximum: s.value,
                type: "string",
                inclusive: !0,
        ...
        } else if (s.kind === "email") Tm.test(e.data) || (i = this._getOrReturnCtx(e, i), N(i, {
            validation: "email",
            code: T.invalid_string,
            message: s.message
        }), r.dirty());
        else if (s.kind === "emoji") ds || (ds = new RegExp(Sm, "u")), ds.test(e.data) || (i = this._getOrReturnCtx(e, i), N(i, {
            validation: "emoji",
            code: T.invalid_string,
            message: s.message
        }), r.dirty());
        else if (s.kind === "uuid") Im.test(e.data) || (i = this._getOrReturnCtx(e, i), N(i, {
            validation: "uuid",
            code: T.invalid_string,
            message: s.message
        }), r.dirty());
        else if (s.kind === "cuid") wm.test(e.data) || (i = this._getOrReturnCtx(e, i), N(i, {
            validation: "cuid",
            code: T.invalid_string,
            message: s.message
        }), r.dirty());
        else if (s.kind === "cuid2") xm.test(e.data) || (i = this._getOrReturnCtx(e, i), N(i, {
            validation: "cuid2",
            code: T.invalid_string,
            message: s.message
        }), r.dirty());
        else if (s.kind === "ulid") Em.test(e.data) || (i = this._getOrReturnCtx(e, i), N(i, {
            validation: "ulid",
            code: T.invalid_string,
            message: s.message
        }), r.dirty());
            ...
            i = this._getOrReturnCtx(e, i), N(i, {
                validation: "url",
                code: T.invalid_string,
                message: s.message
            }), r.dirty()
        } else s.kind === "regex" ? (s.regex.lastIndex = 0, s.regex.test(e.data) || (i = this._getOrReturnCtx(e, i), N(i, {
            validation: "regex",
            code: T.invalid_string,
            message: s.message
        }), r.dirty())) : s.kind === "trim" ? e.data = e.data.trim() : s.kind === "includes" ? e.data.includes(s.value, s.position) || (i = this._getOrReturnCtx(e, i), N(i, {
            code: T.invalid_string,
            validation: {
                includes: s.value,
                position: s.position
            ...
            message: s.message
        }), r.dirty()) : s.kind === "toLowerCase" ? e.data = e.data.toLowerCase() : s.kind === "toUpperCase" ? e.data = e.data.toUpperCase() : s.kind === "startsWith" ? e.data.startsWith(s.value) || (i = this._getOrReturnCtx(e, i), N(i, {
            code: T.invalid_string,
            validation: {
                startsWith: s.value
            },
            message: s.message
        }), r.dirty()) : s.kind === "endsWith" ? e.data.endsWith(s.value) || (i = this._getOrReturnCtx(e, i), N(i, {
            code: T.invalid_string,
            validation: {
                endsWith: s.value
            },
            message: s.message
        }), r.dirty()) : s.kind === "datetime" ? Pm(s).test(e.data) || (i = this._getOrReturnCtx(e, i), N(i, {
            code: T.invalid_string,
            validation: "datetime",
            message: s.message
        }), r.dirty()) : s.kind === "ip" ? Rm(e.data, s.version) || (i = this._getOrReturnCtx(e, i), N(i, {
            validation: "ip",
            code: T.invalid_string,
            message: s.message
...
class Mt extends K {
    ...
    _parse(e) {
        ...
        let r;
        const i = new ke;
        for (const s of this._def.checks) s.kind === "int" ? ie.isInteger(e.data) || (r = this._getOrReturnCtx(e, r), N(r, {
            code: T.invalid_type,
            expected: "integer",
            received: "float",
            message: s.message
        }), i.dirty()) : s.kind === "min" ? (s.inclusive ? e.data < s.value : e.data <= s.value) && (r = this._getOrReturnCtx(e, r), N(r, {
            code: T.too_small,
            minimum: s.value,
            type: "number",
            ...
            exact: !1,
            message: s.message
        }), i.dirty()) : s.kind === "max" ? (s.inclusive ? e.data > s.value : e.data >= s.value) && (r = this._getOrReturnCtx(e, r), N(r, {
            code: T.too_big,
            maximum: s.value,
            type: "number",
            inclusive: s.inclusive,
            exact: !1,
            message: s.message
        }), i.dirty()) : s.kind === "multipleOf" ? Bm(e.data, s.value) !== 0 && (r = this._getOrReturnCtx(e, r), N(r, {
            code: T.not_multiple_of,
            multipleOf: s.value,
            message: s.message
        }), i.dirty()) : s.kind === "finite" ? Number.isFinite(e.data) || (r = this._getOrReturnCtx(e, r), N(r, {
            code: T.not_finite,
            message: s.message
...
class $t extends K {
    ...
    _parse(e) {
        ...
        let r;
        const i = new ke;
        for (const s of this._def.checks) s.kind === "min" ? (s.inclusive ? e.data < s.value : e.data <= s.value) && (r = this._getOrReturnCtx(e, r), N(r, {
            code: T.too_small,
            type: "bigint",
            minimum: s.value,
            inclusive: s.inclusive,
            ...
            inclusive: s.inclusive,
            message: s.message
        }), i.dirty()) : s.kind === "multipleOf" ? e.data % s.value !== BigInt(0) && (r = this._getOrReturnCtx(e, r), N(r, {
            code: T.not_multiple_of,
            multipleOf: s.value,
            message: s.message
        }), i.dirty()) : ie.assertNever(s);
...
class on extends K {
    _parse(e) {
        ...
        const r = new ke;
        let i;
        for (const s of this._def.checks) s.kind === "min" ? e.data.getTime() < s.value && (i = this._getOrReturnCtx(e, i), N(i, {
            code: T.too_small,
            message: s.message,
            inclusive: !0,
            exact: !1,
            minimum: s.value,
            type: "date"
        }), r.dirty()) : s.kind === "max" ? e.data.getTime() > s.value && (i = this._getOrReturnCtx(e, i), N(i, {
            code: T.too_big,
            message: s.message,
            inclusive: !0,
            exact: !1,
...
class Ye extends K {
    _parse(e) {
        ...
        if (n.parsedType !== B.array) return N(n, {
            code: T.invalid_type,
            expected: B.array,
            received: n.parsedType
        }), V;
        ...
        if (i.minLength !== null && n.data.length < i.minLength.value && (N(n, {
            ...
            }), r.dirty()), n.common.async) return Promise.all([...n.data].map((o, a) => i.type._parseAsync(new st(n, o, n.path, a)))).then(o => ke.mergeArray(r, o));
...
function kn(t) {
    if (t instanceof me) {
        ...
        return new me({ ...t._def,
            shape: () => e
        })
    } else return t instanceof Ye ? new Ye({ ...t._def,
        type: kn(t.element)
...
class me extends K {
    ...
    _parse(e) {
        ...
        if (this._def.catchall instanceof _t) {
            ...
            else if (d === "strict") a.length > 0 && (N(i, {
    ...
    strict(e) {
        return M.errToObj, new me({ ...this._def,
            unknownKeys: "strict",
            ...e !== void 0 ? {
                errorMap: (n, r) => {
                    var i, s, o, a;
    ...
    required(e) {
        ...
        return ie.objectKeys(this.shape).forEach(r => {
            if (e && !e[r]) n[r] = this.shape[r];
                ...
                let s = this.shape[r];
                for (; s instanceof bt;) s = s._def.innerType;
                n[r] = s
            }
        }), new me({ ...this._def,
            shape: () => n
...
class Mi extends K {
    _parse(e) {
        ...
        if (n.parsedType !== B.object) return N(n, {
            code: T.invalid_type,
            expected: B.object,
            received: n.parsedType
        }), V;
...
function Ms(t, e) {
    ...
    } else return n === B.date && r === B.date && +t == +e ? {
        valid: !0,
        data: t
    } : {
        valid: !1
...
class ot extends K {
    _parse(e) {
        ...
        if (r.parsedType !== B.array) return N(r, {
            code: T.invalid_type,
            expected: B.array,
            received: r.parsedType
        }), V;
        if (r.data.length < this._def.items.length) return N(r, {
            code: T.too_small,
...
class pr extends K {
    ...
    _parse(e) {
        ...
        if (r.parsedType !== B.object) return N(r, {
            code: T.invalid_type,
            expected: B.object,
            received: r.parsedType
        }), V;
...
class hi extends K {
    ...
    _parse(e) {
        ...
        if (r.parsedType !== B.map) return N(r, {
            code: T.invalid_type,
            expected: B.map,
            received: r.parsedType
        }), V;
        ...
        if (r.common.async) {
            ...
            return Promise.resolve().then(async () => {
                for (const u of o) {
                    const d = await u.key,
                        c = await u.value;
                    if (d.status === "aborted" || c.status === "aborted") return V;
                    (d.status === "dirty" || c.status === "dirty") && n.dirty(), a.set(d.value, c.value)
                }
                return {
                    status: n.value,
                    value: a
...
class an extends K {
    _parse(e) {
        ...
        if (r.parsedType !== B.set) return N(r, {
            code: T.invalid_type,
            expected: B.set,
            received: r.parsedType
        }), V;
        ...
        function o(u) {
            const d = new Set;
            for (const c of u) {
                if (c.status === "aborted") return V;
                c.status === "dirty" && n.dirty(), d.add(c.value)
            }
            return {
                status: n.value,
                value: d
...
class Bn extends K {
    ...
    _parse(e) {
        ...
        if (n.parsedType !== B.function) return N(n, {
            code: T.invalid_type,
            expected: B.function,
            received: n.parsedType
        }), V;
        ...
        if (this._def.returns instanceof $n) {
            ...
            return Pe(function(...u) {
                ...
                if (!d.success) throw new Je([r(u, d.error)]);
                const c = Reflect.apply(o, this, d.data),
                    l = a._def.returns.safeParse(c, s);
                if (!l.success) throw new Je([i(c, l.error)]);
                return l.data
            })
        }
    }
...
class $n extends K {
    ...
    _parse(e) {
        ...
        if (n.parsedType !== B.promise && n.common.async === !1) return N(n, {
            code: T.invalid_type,
            expected: B.promise,
            received: n.parsedType
        }), V;
    ...
    _parse(e) {
        ...
        if (i.type === "refinement") {
            ...
            if (r.common.async === !1) {
                ...
                return a.status === "aborted" ? V : (a.status === "dirty" && n.dirty(), o(a.value), {
                    status: n.value,
                    value: a.value
                })
                ...
                path: r.path,
                parent: r
            }).then(a => a.status === "aborted" ? V : (a.status === "dirty" && n.dirty(), o(a.value).then(() => ({
                status: n.value,
                value: a.value
            }))))
        }
...
class Ar extends K {
    _parse(e) {
        ...
        if (r.common.async) return (async () => {
            ...
            return s.status === "aborted" ? V : s.status === "dirty" ? (n.dirty(), Cc(s.value)) : this._def.out._parseAsync({
                data: s.value,
                path: r.path,
                parent: r
            })
...
class gi extends K {
    _parse(e) {
        ...
        return dr(n) && (n.value = Object.freeze(n.value)), n
    }
}
...
const Om = (t, e = {
    ...
    hp = () => Hc().optional(),
    mp = {
        string: t => Xe.create({ ...t,
            coerce: !0
        }),
        number: t => Mt.create({ ...t,
            coerce: !0
        }),
        boolean: t => ur.create({ ...t,
            coerce: !0
        }),
        bigint: t => $t.create({ ...t,
            coerce: !0
...
class Hn extends q {
    constructor(e) {
        super(), this.code = If, this.errors = e, super.message = `Web3 validator found ${e.length} error[s]:
...
function po(t) {
    if (typeof t != "string") throw new Error(`[isHexPrefixed] input must be type 'string', received type ${typeof t}`);
    return t.startsWith("0x")
}
const go = function(t) {
        for (const [e, n] of Object.entries(t))
            if (n !== void 0 && n.length > 0 && n[0] === 0) throw new Error(`${e} cannot have leading zeroes, received: ${n.toString()}`)
    },
    ...
    gn = t => {
        let e = t.replace(/ /, ""),
            n, r = !1,
            i = [];
        if (t.includes("[") && (e = e.slice(0, e.indexOf("[")), i = [...t.matchAll(/(?:\[(\d*)\])/g)].map(s => parseInt(s[1], 10)).map(s => Number.isNaN(s) ? -1 : s), r = i.length > 0), yp.includes(e)) return {
            baseType: e,
            isArray: r,
            baseTypeSize: n,
            arraySizes: i
        };
        if (e.startsWith("int")) n = parseInt(e.substring(3), 10), e = "int";
        else if (e.startsWith("uint")) n = parseInt(t.substring(4), 10), e = "uint";
        else if (e.startsWith("bytes")) n = parseInt(e.substring(5), 10), e = "bytes";
        else return {
            baseType: void 0,
            isArray: !1,
            baseTypeSize: void 0,
    ...
    us = (t, e = {}) => {
        if (Object.keys(e).includes("type")) throw new Hn([{
            keyword: "eth",
        ...
        if (!r && !vp.includes(t)) throw new Hn([{
            keyword: "eth",
    ...
    yi = (t, e = "/0") => {
        ...
        for (const [r, i] of t.entries()) {
            let s, o, a = [];
            jc(i) ? (s = i.type, o = i.name, a = i.components) : typeof i == "string" ? (s = i, o = `${e}/${r}`) : Array.isArray(i) && (i[0] && typeof i[0] == "string" && i[0].startsWith("tuple") && !Array.isArray(i[0]) && i[1] && Array.isArray(i[1]) ? (s = i[0], o = `${e}/${r}`, a = i[1]) : (s = "tuple", o = `${e}/${r}`, a = i));
            const {
                baseType: u,
                isArray: d,
                arraySizes: c
            ...
            let l, f = n;
            for (let h = c.length - 1; h > 0; h -= 1) l = {
                type: "array",
                items: [],
                maxItems: c[h],
                minItems: c[h]
            }, c[h] < 0 && (delete l.maxItems, delete l.minItems), Array.isArray(f.items) ? f.items.length === 0 ? f.items = l : f.items.push(l) : f.items = [f.items, l], f = l;
            if (u === "tuple" && !d) {
                const h = yi(a, o);
                ...
                h < 0 && (delete p.maxItems, delete p.minItems), f.items.push(p)
            } else if (d) {
                const h = c[0],
                    p = {
                        type: "array",
    ...
    ir = (t, e, n) => {
        ...
        for (const [i, s] of t.entries()) {
            let o, a, u = [];
            jc(s) ? (o = s.type, a = s.name, u = s.components) : typeof s == "string" ? o = s : Array.isArray(s) && (s[1] && Array.isArray(s[1]) ? (o = s[0], u = s[1]) : (o = "tuple", u = s));
            const {
                baseType: d,
                isArray: c,
                arraySizes: l
            } = gn(o), f = Array.isArray(e) ? e[i] : e[a];
            if (d === "tuple" && !c) r.push(ir(u, f, n));
            else if (d === "tuple" && c) {
                const h = [];
                for (const p of f)
                    if (l.length > 1) {
                        const m = vo(p, l.length - 1),
                            g = [];
                        for (const y of m) g.push(ir(u, y, n));
                        h.push(g)
                    } else h.push(ir(u, p, n));
                r.push(h)
            } else r.push(f)
        }
    ...
    $i = t => {
        if (!se(t)) throw new Error("Invalid hex string");
    ...
    Hi = t => {
        if ((typeof t == "number" || typeof t == "bigint") && t < 0) return `-0x${t.toString(16).slice(1)}`;
        if ((typeof t == "number" || typeof t == "bigint") && t >= 0) return `0x${t.toString(16)}`;
        ...
        if (typeof t == "string" && !se(t)) return Hi(BigInt(t));
        throw new co(t)
    },
    vi = (t, e, n = "0") => {
        if (typeof t == "string" && !se(t)) return t.padStart(e, n);
...
function yn(t) {
    let e;
    if (t.toLowerCase().startsWith("0x") ? e = t.slice(2) : e = t, e.length % 2 !== 0) throw new rr(`hex string has odd length: ${t}`);
...
const Gc = Object.freeze(Object.defineProperty({
    ...
    Uc = t => {
        ...
        for (let i = 0; i < 40; i += 1)
            if (parseInt(r[i], 16) > 7 && e[i].toUpperCase() !== e[i] || parseInt(r[i], 16) <= 7 && e[i].toLowerCase() !== e[i]) return !1;
        return !0
    },
    Ve = (t, e = !0) => {
        if (typeof t != "string" && !(t instanceof Uint8Array)) return !1;
        let n;
        return t instanceof Uint8Array ? n = Gt(t) : typeof t == "string" && !se(t) ? n = t.toLowerCase().startsWith("0x") ? t : `0x${t}` : n = t, /^(0x)?[0-9a-f]{40}$/i.test(n) ? /^(0x|0X)?[0-9a-f]{40}$/.test(n) || /^(0x|0X)?[0-9A-F]{40}$/.test(n) ? !0 : e ? Uc(n) : !0 : !1
    };
var ze;
(function(t) {
...
var mt;
(function(t) {
    t.EARLIEST = "earliest", t.LATEST = "latest", t.PENDING = "pending", t.SAFE = "safe", t.FINALIZED = "finalized"
})(mt || (mt = {}));
var sr;
(function(t) {
...
const _r = (t, e) => {
    ...
    dn = (t, e = {
        ...
        if (!["number", "string", "bigint"].includes(typeof t) || typeof t == "string" && t.length === 0) return !1;
        let n;
        if (e != null && e.abiType) {
            const {
                baseTypeSize: i
    ...
    ji = (t, e = {
        ...
        if (!["number", "string", "bigint"].includes(typeof t) || typeof t == "number" && t > Number.MAX_SAFE_INTEGER) return !1;
        let n;
        if (e != null && e.abiType) {
            const {
                baseTypeSize: s,
    ...
    Di = (t, e) => {
        if (typeof e == "string" && !se(e) || !Vn(t)) return !1;
    ...
    Ut = (t, e = {
        ...
        if (typeof t != "string" && !Array.isArray(t) && !(t instanceof Uint8Array) || typeof t == "string" && se(t) && t.startsWith("-") || typeof t == "string" && !se(t)) return !1;
        let n;
        if (typeof t == "string") {
    ...
    Ip = t => {
        ...
        if (b(t) || typeof t != "object" || !Object.keys(t).every(n => e.includes(n)) || !b(t.fromBlock) && !$s(t.fromBlock) || !b(t.toBlock) && !$s(t.toBlock)) return !1;
        if (!b(t.address)) {
            if (Array.isArray(t.address)) {
                if (!t.address.every(n => Ve(n))) return !1
            } else if (!Ve(t.address)) return !1
        }
...
for (let t = 8; t <= 256; t += 8) un[`int${t}`] = e => ji(e, {
    bitSize: t
}), un[`uint${t}`] = e => dn(e, {
    bitSize: t
});
for (let t = 1; t <= 32; t += 1) un[`bytes${t}`] = e => Ut(e, {
    size: t
});
...
const tr = t => {
    ...
    if (t.oneOf && Array.isArray(t.oneOf)) return nt.union(t.oneOf.map(e => tr(e)));
    if (t != null && t.format) {
        if (!un[t.format]) throw new Nh(t.format);
...
class Rn {
    static factory() {
        return Rn.validatorInstance || (Rn.validatorInstance = new Rn), Rn.validatorInstance
    }
    validate(e, n, r) {
        var i, s;
    ...
    convertErrors(e) {
        if (e && Array.isArray(e) && e.length > 0) return e.map(n => {
            var r;
            let i, s, o, a;
            a = n.path.join("/");
            const u = String(n.path[n.path.length - 1]),
                d = n.path.join("/");
            if (n.code === T.too_big) s = "maxItems", a = `${d}/maxItems`, o = {
                limit: n.maximum
            }, i = `must NOT have more than ${n.maximum} items`;
            else if (n.code === T.too_small) s = "minItems", a = `${d}/minItems`, o = {
                limit: n.minimum
                ...
                typeof c > "u" ? i = `value at "/${a}" is required` : i = `value "${typeof c=="object"?JSON.stringify(c):c}" at "/${a}" must pass "${l}" validation`, o = {
                    value: c
                }
            }
            return {
...
class Tp {
    ...
    validate(e, n, r = {
        ...
        if (!(Array.isArray(o.items) && ((i = o.items) === null || i === void 0 ? void 0 : i.length) === 0 && n.length === 0)) {
            if (Array.isArray(o.items) && ((s = o.items) === null || s === void 0 ? void 0 : s.length) === 0 && n.length !== 0) throw new Hn([{
                instancePath: "/0",
                schemaPath: "/",
                keyword: "required",
...
const H = new Tp,
    ...
    at = t => {
        if (H.validate(["bytes"], [t]), t instanceof Uint8Array) return t;
        if (Array.isArray(t)) return new Uint8Array(t);
        if (typeof t == "string") return yn(t);
        throw new rr(t)
    },
    {
        uint8ArrayToHexString: Sp
    } = Gc,
    X = t => Sp(at(t)),
    ue = t => typeof t == "string" && t.slice(0, 2).toLowerCase() !== "0x" ? at(`0x${t}`) : at(t),
    Rr = t => (H.validate(["hex"], [t]), $i(t)),
    kp = Rr,
    He = (t, e) => {
    ...
    et = t => {
        H.validate(["string"], [t]);
        let e = t.replace(/^(?:\u0000)/, "");
        return e = e.replace(/(?:\u0000)$/, ""), X(new TextEncoder().encode(e))
    },
    Vc = et,
    Rp = et,
    Fi = t => Rc(ue(t)),
    Bp = t => typeof t == "string" ? Fi(t) : (H.validate(["bytes"], [t]), Rc(t)),
    wo = Ln,
    Cp = Fi,
    Wc = t => {
        H.validate(["string"], [t]);
    ...
    Op = Zc,
    jt = (t, e) => {
        if (typeof t == "string" && Ve(t)) return e ? "address" : `0x${t.toLowerCase().replace(/^0x/i,"")}`;
        if (typeof t == "boolean") return e ? "bool" : t ? "0x01" : "0x00";
        if (typeof t == "number") return e ? t < 0 ? "int256" : "uint256" : He(t);
        if (typeof t == "bigint") return e ? "bigint" : He(t);
        if (typeof t == "object" && t) return e ? "string" : et(JSON.stringify(t));
        if (typeof t == "string") {
            if (t.startsWith("-0x") || t.startsWith("-0X")) return e ? "int256" : He(t);
            if (se(t)) return e ? "bytes" : t;
            if (mo(t) && !ji(t)) return e ? "bytes" : `0x${t}`;
            if (!Number.isFinite(t)) return e ? "string" : et(t)
        }
        throw new gh(t)
    },
    Ne = t => {
        if (typeof t == "number") return t;
        if (typeof t == "bigint") return t >= Number.MIN_SAFE_INTEGER && t <= Number.MAX_SAFE_INTEGER ? Number(t) : t;
        if (typeof t == "string" && se(t)) return Rr(t);
        try {
            return Ne(BigInt(t))
        } catch {
            throw new co(t)
    ...
    Zt = t => {
        ...
        if (typeof t == "string" && mo(t)) return t.startsWith("-") ? -BigInt(t.substring(1)) : BigInt(t);
        throw new co(t)
    },
    Lp = (t, e) => {
        const n = _o[e];
    ...
    Mp = (t, e) => {
        ...
        const n = _o[e];
        if (!n) throw new vc(e);
        const [r, i] = String(typeof t == "string" && !se(t) ? t : Ne(t)).split(".").concat(""), o = BigInt(`${r}${i}`) * n, a = n.toString().length - 1, u = Math.min(i.length, a);
        return u === 0 ? o.toString() : o.toString().padStart(u, "0").slice(0, -u)
    },
    ct = t => {
        if (!Ve(t, !1)) throw new uo(t);
        const e = t.toLowerCase().replace(/^0x/i, ""),
            n = Gt(Se(wo(e)));
        if (b(n) || n === "0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470") return "";
        let r = "0x";
        const i = n.replace(/^0x/i, "");
        for (let s = 0; s < e.length; s += 1) parseInt(i[s], 16) > 7 ? r += e[s].toUpperCase() : r += e[s];
        return r
    },
    Kc = t => {
        if (typeof t == "boolean") return t;
        if (typeof t == "number" && (t === 0 || t === 1) || typeof t == "bigint" && (t === BigInt(0) || t === BigInt(1))) return !!t;
        if (typeof t == "string" && !se(t) && (t === "1" || t === "0" || t === "false" || t === "true")) return t === "true" ? !0 : t === "false" ? !1 : !!Number(t);
        if (typeof t == "string" && se(t) && (t === "0x1" || t === "0x0")) return !!Ne(t);
        throw new lo(t)
    };
...
class jp extends EventTarget {
    ...
    on(e, n) {
        return this.addEventListener(e, n), this
    }
    once(e, n) {
        const r = i => $p(this, void 0, void 0, function*() {
            this.off(e, r), yield n(i)
        });
        return this.on(e, r)
    }
    off(e, n) {
        return this.removeEventListener(e, n), this
    }
    emit(e, n) {
    ...
    addEventListener(e, n) {
        const r = Hp(n);
        super.addEventListener(e, r), this._listeners[e] || (this._listeners[e] = []), this._listeners[e].push([n, r])
    }
    removeEventListener(e, n) {
        const r = this._listeners[e];
        if (r) {
            const i = r.findIndex(s => s[0] === n);
            i !== -1 && (super.removeEventListener(e, r[i][1]), r.splice(i, 1))
        }
    }
}
let Hs;
...
const Dp = se,
    ...
    Xp = (t, e) => {
        ...
        if (t === e || (t === "earliest" || t === 0) && (e === "earliest" || e === 0)) return 0;
        ...
        if (n && !r || !n && r) throw new vh("Cannot compare blocktag with provided non-blocktag input.");
        const i = BigInt(t),
            s = BigInt(e);
    ...
    qt = (t, ...e) => {
        ...
        if (!Sa(n)) return n;
        for (const r of e)
            for (const i in r) Sa(r[i]) ? (n[i] || (n[i] = {}), qt(n[i], r[i])) : !b(r[i]) && Object.hasOwnProperty.call(r, i) && (Array.isArray(r[i]) || r[i] instanceof bo ? n[i] = r[i].slice(0) : n[i] = r[i]);
        return n
    },
    jn = (t, e, n = "0") => typeof t == "string" ? se(t) ? vi(t, e, n) : t.padStart(e, n) : (H.validate(["int"], [t]), vi(t, e, n)),
    Xc = (t, e, n = "0") => {
        if (typeof t == "string" && !se(t)) return t.padEnd(e, n);
        H.validate(["int"], [t]);
    ...
    Yc = (t, e = 64) => {
        H.validate(["int"], [t]);
        const n = Ne(t);
        if (n >= 0) return jn(jt(n), e);
        const r = _r(BigInt(2), BigInt(e * 4));
        if (-n >= r) throw new bc(`value: ${t}, nibbleWidth: ${e}`);
        const s = BigInt(n) + r;
        return jn(He(s), e)
    },
    Jp = (t, e = 64) => {
        ...
        if (r > e * 4) throw new bc(`value: "${t}", nibbleWidth: "${e}"`);
        if (e * 4 !== r) return n;
...
const {
    parseBaseType: Yp
} = Gc, ft = t => typeof t == "object" && !b(t) && "number" in t && "bytes" in t, Qp = (t, e, n = []) => {
    ...
    for (const s of e) {
        ...
        if (r.properties) r = r.properties[s];
            ...
            if (!o) return;
            r = o[s]
        } else r.items && Cn(r.items) ? r = r.items : r.items && Array.isArray(r.items) && (r = r.items[parseInt(s, 10)]);
        r && s && (i = s)
    }
    return r
}, nr = (t, e, n) => {
    try {
        ...
        if (r === "bytes") {
            let s;
            switch (i ? typeof t == "string" ? s = jn(t, i * 2) : t instanceof Uint8Array && (s = Re(new Uint8Array(i - t.length), t)) : s = t, n.bytes) {
                case wt.HEX:
                    return X(at(s));
                case wt.UINT8ARRAY:
                    return at(s);
    ...
    var s, o;
    if (!Cn(t) && !Array.isArray(t)) return nr(t, e == null ? void 0 : e.format, r);
    const a = t;
    for (const [u, d] of Object.entries(a)) {
        ...
        if (Array.isArray(d)) {
            ...
            if ((c == null ? void 0 : c.oneOf) !== void 0 && c.oneOf.forEach((f, h) => {
                    var p, m;
                    !Array.isArray(c == null ? void 0 : c.items) && (typeof d[0] == "object" && ((p = f == null ? void 0 : f.items) === null || p === void 0 ? void 0 : p.type) === "object" || typeof d[0] == "string" && ((m = f == null ? void 0 : f.items) === null || m === void 0 ? void 0 : m.type) !== "object") && (l = f, i.push([u, h]))
                }), b(l == null ? void 0 : l.items)) {
                delete a[u], n.pop();
                continue
            }
            if (Cn(l.items) && !b(l.items.format)) {
                for (let f = 0; f < d.length; f += 1) a[u][f] = nr(d[f], (s = l == null ? void 0 : l.items) === null || s === void 0 ? void 0 : s.format, r);
                n.pop();
                continue
            }
            if (!Array.isArray(l == null ? void 0 : l.items) && ((o = l == null ? void 0 : l.items) === null || o === void 0 ? void 0 : o.type) === "object") {
                for (const f of d) _i(f, e, n, r, i);
                n.pop();
                continue
            }
            if (Array.isArray(l == null ? void 0 : l.items)) {
                for (let f = 0; f < d.length; f += 1) a[u][f] = nr(d[f], l.items[f].format, r);
                n.pop();
                continue
            }
        }
        a[u] = nr(d, c.format, r), n.pop()
    }
    return a
}, I = (t, e, n) => {
    let r;
    ...
    const i = Cn(t) ? t : yo(t);
    if (!i.properties && !i.items && !i.format) throw new As("Invalid json schema for formatting");
    return _i(r, i, [], n)
}, Qc = "0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470", Br = t => {
    let e;
    ...
    let e;
    return typeof t == "bigint" || typeof t == "number" ? e = Ln(t.toString()) : Array.isArray(t) ? e = new Uint8Array(t) : typeof t == "string" && !se(t) ? e = Ln(t) : e = at(t), X(Se(e))
}, e0 = t => {
    if (Array.isArray(t)) throw new Error("Autodetection of array types is not supported.");
    let e, n;
    if (typeof t == "object" && ("t" in t || "type" in t) && ("v" in t || "value" in t)) e = "t" in t ? t.t : t.type, n = "v" in t ? t.v : t.value, e = e.toLowerCase() === "bigint" ? "int" : e;
    else {
        if (typeof t == "bigint") return ["int", t];
        e = jt(t, !0), n = jt(t), !e.startsWith("int") && !e.startsWith("uint") && (e = "bytes")
    }
    return (e.startsWith("int") || e.startsWith("uint")) && typeof n == "string" && !/^(-)?0x/i.test(n) && (n = Zt(n)), [e, n]
}, t0 = t => t.startsWith("int[") ? `int256${t.slice(3)}` : t === "int" ? "int256" : t.startsWith("uint[") ? `uint256'${t.slice(4)}` : t === "uint" ? "uint256" : t, ls = (t, e) => {
    const n = /^(\d+).*$/.exec(t.slice(e));
    return n ? parseInt(n[1], 10) : 0
}, ka = t => t.toString(2).length, Aa = (t, e) => {
    const n = e.toString();
    if (t === "string") {
    ...
    if (t === "address") {
        if (!Ve(n)) throw new uo(n);
        return n
    }
    const r = t0(t);
    if (t.startsWith("uint")) {
        const i = ls(r, 4);
        if (i % 8 || i < 8 || i > 256) throw new ma(n);
        const s = Ne(n);
        if (ka(s) > i) throw new pa(n);
        if (s < BigInt(0)) throw new yh(n);
        return i ? wr(s.toString(16), i / 8 * 2) : s.toString(16)
    }
    if (t.startsWith("int")) {
        const i = ls(r, 3);
        if (i % 8 || i < 8 || i > 256) throw new ma(t);
        const s = Ne(n);
        if (ka(s) > i) throw new pa(n);
        return s < BigInt(0) ? Yc(s.toString(), i / 8 * 2) : i ? wr(s.toString(16), i / 4) : s.toString(16)
    }
    if (r === "bytes") {
        if (n.replace(/^0x/i, "").length % 2 !== 0) throw new rr(n);
        return n
    }
    if (t.startsWith("bytes")) {
        if (n.replace(/^0x/i, "").length % 2 !== 0) throw new rr(n);
        const i = ls(t, 5);
        if (!i || i < 1 || i > 64 || i < n.replace(/^0x/i, "").length / 2) throw new rr(n);
        return Jc(n, i * 2)
    }
    return ""
}, ed = t => {
...
}, Eo = (...t) => `0x${t.map(ed).join("").toLowerCase()}`, n0 = (...t) => Br(Eo(...t)), r0 = (...t) => je(Eo(...t)), i0 = t => Br(`0x${(typeof t=="number"?t.toString():t).padStart(64,"0")}`);
...
class xi {
    constructor({
        ...
        this[od] = "Promise", this._state = "pending", this._promise = new Promise((i, s) => {
...
class ad {
    constructor(e, n) {
        this.eventEmitter = e, this.autoReconnect = n
    }
    clearQueues() {
...
class cd extends Pr {
    constructor() {
        super(...arguments), this._eventEmitter = new ac.EventEmitter, this._chainId = "", this._accounts = []
    }
    _getChainId() {
        var e;
...
class dd extends cd {
    constructor(e, n, r) {
        if (super(), this._connectionStatus = "connecting", this._onMessageHandler = this._onMessage.bind(this), this._onOpenHandler = this._onConnect.bind(this), this._onCloseHandler = this._onCloseEvent.bind(this), this._onErrorHandler = this._onError.bind(this), !this._validateProviderPath(e)) throw new Ps(e);
        this._socketPath = e, this._socketOptions = n, this._reconnectOptions = Object.assign(Object.assign({}, d0), r ? ? {}), this._pendingRequestsQueue = new Map, this._sentRequestsQueue = new Map, this._init(), this.connect(), this.chunkResponseParser = new ad(this._eventEmitter, this._reconnectOptions.autoReconnect), this.chunkResponseParser.onError(() => {
            this._clearQueues()
    ...
    connect() {
        try {
            ...
            else throw this._connectionStatus = "disconnected", e && e.message ? new kr(`Error while connecting to ${this._socketPath}. Reason: ${e.message}`) : new Ps(this._socketPath)
        }
    }
        ...
        return hs(this, void 0, void 0, function*() {
            ...
            yield hs(this, void 0, void 0, function*() {
                return new Promise(a => {
                    const u = setInterval(() => {
                        r && s === 5 && this.clearQueues(), this.getPendingRequestQueueSize() === 0 && this.getSentRequestsQueueSize() === 0 && (clearInterval(u), a(!0)), s += 1
                    }, i)
                })
            }), this.disconnect(e, n)
        })
    ...
    _reconnect() {
        this.isReconnecting || (this.isReconnecting = !0, this._sentRequestsQueue.size > 0 && this._sentRequestsQueue.forEach((e, n) => {
            e.deferredPromise.reject(new Of), this._sentRequestsQueue.delete(n)
        ...
        }, this._reconnectOptions.delay)) : (this.isReconnecting = !1, this._clearQueues(), this._removeSocketListeners(), this._eventEmitter.emit("error", new Nf(this._reconnectOptions.maxAttempts))))
    }
    request(e) {
        return hs(this, void 0, void 0, function*() {
            if (z(this._socketConnection)) throw new Error("Connection is undefined");
            this.getStatus() === "disconnected" && this.connect();
            const n = Ze(e) ? e[0].id : e.id;
            if (!n) throw new Ff("Request Id not defined");
            if (this._sentRequestsQueue.has(n)) throw new Lf(n);
            const r = new xi;
            r.catch(s => {
    ...
    _sendPendingRequests() {
        for (const [e, n] of this._pendingRequestsQueue.entries()) this._sendToSocket(n.payload), this._pendingRequestsQueue.delete(e), this._sentRequestsQueue.set(e, n)
    }
    _onMessage(e) {
        ...
        if (!(z(n) || n.length === 0))
            for (const r of n) {
                ...
                if (!s) return;
                (Ir(r) || gt(r) || yt(r)) && (this._eventEmitter.emit("message", r), s.deferredPromise.resolve(r)), this._sentRequestsQueue.delete(i)
            }
    }
    clearQueues(e) {
        this._clearQueues(e)
    ...
    _clearQueues(e) {
        this._pendingRequestsQueue.size > 0 && this._pendingRequestsQueue.forEach((n, r) => {
            n.deferredPromise.reject(new ks(e)), this._pendingRequestsQueue.delete(r)
        }), this._sentRequestsQueue.size > 0 && this._sentRequestsQueue.forEach((n, r) => {
            n.deferredPromise.reject(new ks(e)), this._sentRequestsQueue.delete(r)
...
class l0 extends zi {
    ...
    setConfig(e) {
        ...
        for (const r of n) this._triggerConfigChange(r, e[r]);
    ...
    set defaultChain(e) {
        if (!z(this.config.defaultCommon) && !z(this.config.defaultCommon.baseChain) && e !== this.config.defaultCommon.baseChain) throw new va(this.config.defaultChain, e);
    ...
    set defaultHardfork(e) {
        if (!z(this.config.defaultCommon) && !z(this.config.defaultCommon.hardfork) && e !== this.config.defaultCommon.hardfork) throw new ya(this.config.defaultCommon.hardfork, e);
    ...
    set defaultCommon(e) {
        if (!z(this.config.defaultHardfork) && !z(e) && !z(e.hardfork) && this.config.defaultHardfork !== e.hardfork) throw new ya(this.config.defaultHardfork, e.hardfork);
        if (!z(this.config.defaultChain) && !z(e) && !z(e.baseChain) && this.config.defaultChain !== e.baseChain) throw new va(this.config.defaultChain, e.baseChain);
...
class Ro extends Pr {
    constructor(e, n) {
        if (super(), !Ro.validateClientUrl(e)) throw new Ps(e);
    ...
    request(e, n) {
        ...
        return m0(this, void 0, void 0, function*() {
            ...
            if (!s.ok) throw new ht(yield s.json());
            return yield s.json()
        })
    }
    on() {
...
class g0 extends dd {
    ...
    getStatus() {
        if (this._socketConnection && !z(this._socketConnection)) switch (this._socketConnection.readyState) {
    ...
    _sendToSocket(e) {
        var n;
        if (this.getStatus() === "disconnected") throw new ks;
...
class tn extends zi {
    constructor(e, n) {
        super(), z(e) || this.setProvider(e), this.useRpcCallSpecification = n
    }
    ...
    setProvider(e) {
        ...
        if (e && typeof e == "string" && this.providers)
            ...
            else if (/^ws(s)?:\/\//i.test(e)) n = new this.providers.WebsocketProvider(e);
        else throw new jr(`Can't autodetect provider for "${e}"`);
        else z(e) ? n = void 0 : n = e;
        return this.emit(Dn.BEFORE_PROVIDER_CHANGE, this._provider), this._provider = n, this.emit(Dn.PROVIDER_CHANGED, this._provider), !0
    }
    send(e) {
        return ms(this, void 0, void 0, function*() {
            const n = yield this._sendRequest(e);
            if (gt(n)) return n.result;
            throw new ht(n)
        })
    }
    sendBatch(e) {
    ...
    _sendRequest(e) {
        return ms(this, void 0, void 0, function*() {
            ...
            if (z(n)) throw new jr("Provider not available. Use `.setProvider` or `.provider=` to initialize the provider.");
            ...
            if (hd(n)) return n.request(r).then(i => this._processJsonRpcResponse(r, i, {
                legacy: !0,
                error: !1
            ...
            if (fd(n)) return new Promise((i, s) => {
            ...
            if (md(n)) return new Promise((i, s) => {
                n.send(r, (o, a) => {
                    if (o) return s(this._processJsonRpcResponse(r, o, {
                        legacy: !0,
                        error: !0
                    }));
                    if (z(a)) throw new ht("", 'Got a "nullish" response from provider.');
            ...
            if (pd(n)) return n.sendAsync(r).then(i => this._processJsonRpcResponse(r, i, {
                legacy: !0,
                error: !1
            })).catch(i => this._processJsonRpcResponse(r, i, {
                legacy: !0,
    ...
    _processJsonRpcResponse(e, n, {
        legacy: r,
        error: i
    }) {
        if (z(n)) return this._buildResponse(e, null, i);
        if (yt(n)) {
            ...
            } else if (!tn._isReverted(n)) throw new ar(n, e)
        }
        if (gt(n)) return n;
        if (n instanceof Error) throw tn._isReverted(n), n;
        if (!r && Ze(e) && Ir(n) || r && !i && Ze(e)) return n;
        if (r && i && Ze(e)) throw n;
        if (r && !yt(n) && !gt(n)) return this._buildResponse(e, n, i);
    ...
    static _isReverted(e) {
        let n;
        if (yt(e) ? n = e.error : e instanceof Error && (n = e), n != null && n.message.includes("revert")) throw new Qt(n);
        return !1
    }
...
class js {
    constructor(e, n, r = !1) {
        this.requestManager = e, this.registeredSubscriptions = n, this.tolerateUnlinkedSubscription = r, this._subscriptions = new Map, this.requestManager.on(Dn.BEFORE_PROVIDER_CHANGE, () => Jn(this, void 0, void 0, function*() {
    ...
    messageListener(e) {
        var n, r, i;
        if (!e) throw new Ke("Should not call messageListener with no data. Type was");
    ...
    subscribe(e, n, r = O) {
        return Jn(this, void 0, void 0, function*() {
            ...
            if (!i) throw new Ke("Invalid subscription type");
    ...
    addSubscription(e) {
        return Jn(this, void 0, void 0, function*() {
            if (!this.requestManager.provider) throw new jr("Provider not available");
            if (!this.supportsSubscriptions()) throw new Ke("The current provider does not support subscriptions");
            if (e.id && this._subscriptions.has(e.id)) throw new Ke(`Subscription with id "${e.id}" already exists`);
            if (yield e.sendSubscriptionRequest(), z(e.id)) throw new Ke("Subscription is not subscribed yet.");
    ...
    removeSubscription(e) {
        return Jn(this, void 0, void 0, function*() {
            ...
            if (z(n)) throw new Ke("Subscription is not subscribed yet. Or, had already been unsubscribed but not through the Subscription Manager.");
            if (!this._subscriptions.has(n) && !this.tolerateUnlinkedSubscription) throw new Ke(`Subscription with id "${n.toString()}" does not exists`);
    ...
    unsubscribe(e) {
        return Jn(this, void 0, void 0, function*() {
            const n = [];
            for (const [r, i] of this.subscriptions.entries())(!e || typeof e == "function" && e({
                id: r,
                sub: i
...
class Cr extends zi {
    constructor(e, n) {
        ...
        if (i && s) throw new Ke("Only requestManager or subscriptionManager should be provided at Subscription constructor");
        if (!i && !s) throw new Ke("Either requestManager or subscriptionManager should be provided at Subscription constructor");
        i ? this._subscriptionManager = new js(i, {}, !0) : this._subscriptionManager = s, this._returnFormat = (r = n == null ? void 0 : n.returnFormat) !== null && r !== void 0 ? r : O
    }
    get id() {
        return this._id
    }
...
class Ii extends bp {
    ...
    add(e) {
        var n;
        if (typeof e == "string") return this.add(this._accountProvider.privateKeyToAccount(e));
        let r = this.length;
    ...
    remove(e) {
        if (typeof e == "string") {
            const n = this._addressMap.get(e.toLowerCase());
            return b(n) ? !1 : (this._addressMap.delete(e.toLowerCase()), this.splice(n, 1), !0)
        }
...
function gd(t, e, n) {
    ...
    if (n.startsWith("aes-128") && t.length !== 16 || n.startsWith("aes-256") && t.length !== 32) throw new Error("AES: wrong key length")
}
async function yd(t, e, n) {
    if (!it.web) throw new Error("Browser crypto not available.");
    let r;
    if (["aes-128-cbc", "aes-256-cbc"].includes(t) && (r = "cbc"), ["aes-128-ctr", "aes-256-ctr"].includes(t) && (r = "ctr"), !r) throw new Error("AES: unsupported mode");
...
async function Bo(t, e, n, r = "aes-128-ctr", i = !0) {
    if (gd(e, n, r), it.web) {
        const [s, o] = await yd(r, e, n), a = await it.web.subtle.encrypt(o, s, t);
        let u = new Uint8Array(a);
        return !i && o.name === "aes-cbc" && !(t.length % 16) && (u = u.slice(0, -16)), u
    } else if (it.node) {
        const s = it.node.createCipheriv(r, e, n);
        return s.setAutoPadding(i), oi(s.update(t), s.final())
...
async function b0(t, e, n, r = "aes-128-ctr", i = !0) {
    if (gd(e, n, r), it.web) {
        ...
        if (o.name === "aes-cbc") {
            ...
            if (!gm(d, t)) throw new Error("AES: wrong padding")
        }
        return u
    } else if (it.node) {
...
function _0(t, e, n, r) {
    ...
    if (le.number(s), le.number(o), le.number(a), s < 1) throw new Error("PBKDF2: iterations (c) should be >= 1");
    const u = sn(e),
        d = sn(n),
        c = new Uint8Array(o),
        l = Co.create(t, u),
...
function No(t, e, n, r) {
    ...
    for (let h = 1, p = 0; p < s; h++, p += a.outputLen) {
        ...
        l.setInt32(0, h, !1), (d = u._cloneInto(d)).update(c).digestInto(f), m.set(f.subarray(0, m.length));
        for (let g = 1; g < i; g++) {
            a._cloneInto(d).update(f).digestInto(f);
            for (let y = 0; y < m.length; y++) m[y] ^= f[y]
        }
    }
    return w0(a, u, o, d, f)
}
...
function x0(t, e, n, r) {
    ...
    const i = BigInt(32),
        ...
        u = r ? 4 : 0,
        d = r ? 0 : 4;
    t.setUint32(e + u, o, r), t.setUint32(e + d, a, r)
}
class bd extends fo {
    constructor(e, n, r, i) {
        super(), this.blockLen = e, this.outputLen = n, this.padOffset = r, this.isLE = i, this.finished = !1, this.length = 0, this.pos = 0, this.destroyed = !1, this.buffer = new Uint8Array(e), this.view = Gr(this.buffer)
    }
    update(e) {
        le.exists(this);
        const {
    ...
    digestInto(e) {
        ...
        x0(r, i - 8, BigInt(this.length * 8), s), this.process(r, 0);
        const a = Gr(e),
            u = this.outputLen;
        ...
        for (let l = 0; l < d; l++) a.setUint32(4 * l, c[l], s)
    }
    digest() {
        const {
            buffer: e,
...
class _d extends bd {
    ...
    set(e, n, r, i, s, o, a, u) {
        this.A = e | 0, this.B = n | 0, this.C = r | 0, this.D = i | 0, this.E = s | 0, this.F = o | 0, this.G = a | 0, this.H = u | 0
    }
    process(e, n) {
        for (let l = 0; l < 16; l++, n += 4) Pt[l] = e.getUint32(n, !1);
        for (let l = 16; l < 64; l++) {
            const f = Pt[l - 15],
                h = Pt[l - 2],
        ...
        for (let l = 0; l < 64; l++) {
            ...
            c = d, d = u, u = a, a = o + h | 0, o = s, s = i, i = r, r = h + m | 0
        }
        r = r + this.A | 0, i = i + this.B | 0, s = s + this.C | 0, o = o + this.D | 0, a = a + this.E | 0, u = u + this.F | 0, d = d + this.G | 0, c = c + this.H | 0, this.set(r, i, s, o, a, u, d, c)
    }
    roundClean() {
        Pt.fill(0)
    }
...
class Wi extends bd {
    ...
    set(e, n, r, i, s, o, a, u, d, c, l, f, h, p, m, g) {
        this.Ah = e | 0, this.Al = n | 0, this.Bh = r | 0, this.Bl = i | 0, this.Ch = s | 0, this.Cl = o | 0, this.Dh = a | 0, this.Dl = u | 0, this.Eh = d | 0, this.El = c | 0, this.Fh = l | 0, this.Fl = f | 0, this.Gh = h | 0, this.Gl = p | 0, this.Hh = m | 0, this.Hl = g | 0
    }
    process(e, n) {
        for (let w = 0; w < 16; w++, n += 4) Rt[w] = e.getUint32(n), Bt[w] = e.getUint32(n += 4);
        for (let w = 16; w < 80; w++) {
            const S = Rt[w - 15] | 0,
                E = Bt[w - 15] | 0,
        ...
        for (let w = 0; w < 80; w++) {
            const S = G.rotrSH(l, f, 14) ^ G.rotrSH(l, f, 18) ^ G.rotrBH(l, f, 41),
                ...
                D = r & s ^ r & a ^ s & a,
                pe = i & o ^ i & u ^ o & u;
            y = m | 0, _ = g | 0, m = h | 0, g = p | 0, h = l | 0, p = f | 0, {
                h: l,
                l: f
            } = G.add(d | 0, c | 0, j | 0, x | 0), d = a | 0, c = u | 0, a = s | 0, u = o | 0, s = r | 0, o = i | 0;
            const k = G.add3L(x, L, pe);
            r = G.add3H(k, j, P, D), i = k | 0
        }({
            h: r,
            l: i
        } = G.add(this.Ah | 0, this.Al | 0, r | 0, i | 0)), {
            h: s,
            l: o
        } = G.add(this.Bh | 0, this.Bl | 0, s | 0, o | 0), {
            h: a,
            l: u
        } = G.add(this.Ch | 0, this.Cl | 0, a | 0, u | 0), {
            h: d,
            l: c
        } = G.add(this.Dh | 0, this.Dl | 0, d | 0, c | 0), {
            h: l,
            l: f
        } = G.add(this.Eh | 0, this.El | 0, l | 0, f | 0), {
            h,
            l: p
        } = G.add(this.Fh | 0, this.Fl | 0, h | 0, p | 0), {
            h: m,
            l: g
        } = G.add(this.Gh | 0, this.Gl | 0, m | 0, g | 0), {
            h: y,
            l: _
        } = G.add(this.Hh | 0, this.Hl | 0, y | 0, _ | 0), this.set(r, i, s, o, a, u, d, c, l, f, h, p, m, g, y, _)
    }
    roundClean() {
        Rt.fill(0), Bt.fill(0)
    }
...
function wd(t, e, n, r, i) {
    ...
    return ai(t), ai(e), No(i === "sha256" ? Vi : C0, t, e, {
        c: n,
        dkLen: r
    })
}
...
function Ba(t, e, n, r, i, s) {
    let o = t[e++] ^ n[r++],
        ...
        ce = S,
        ye = E;
    for (let Ee = 0; Ee < 8; Ee += 2) x ^= re(A + te | 0, 7), pe ^= re(x + A | 0, 9), te ^= re(pe + x | 0, 13), A ^= re(te + pe | 0, 18), k ^= re(P + C | 0, 7), Q ^= re(k + P | 0, 9), C ^= re(Q + k | 0, 13), P ^= re(C + Q | 0, 18), ce ^= re(R + L | 0, 7), v ^= re(ce + R | 0, 9), L ^= re(v + ce | 0, 13), R ^= re(L + v | 0, 18), j ^= re(ye + F | 0, 7), D ^= re(j + ye | 0, 9), F ^= re(D + j | 0, 13), ye ^= re(F + D | 0, 18), C ^= re(A + j | 0, 7), v ^= re(C + A | 0, 9), j ^= re(v + C | 0, 13), A ^= re(j + v | 0, 18), L ^= re(P + x | 0, 7), D ^= re(L + P | 0, 9), x ^= re(D + L | 0, 13), P ^= re(x + D | 0, 18), F ^= re(R + k | 0, 7), pe ^= re(F + R | 0, 9), k ^= re(pe + F | 0, 13), R ^= re(k + pe | 0, 18), te ^= re(ye + ce | 0, 7), Q ^= re(te + ye | 0, 9), ce ^= re(Q + te | 0, 13), ye ^= re(ce + Q | 0, 18);
    i[s++] = o + A | 0, i[s++] = a + C | 0, i[s++] = u + v | 0, i[s++] = d + j | 0, i[s++] = c + x | 0, i[s++] = l + P | 0, i[s++] = f + L | 0, i[s++] = h + D | 0, i[s++] = p + pe | 0, i[s++] = m + k | 0, i[s++] = g + R | 0, i[s++] = y + F | 0, i[s++] = _ + te | 0, i[s++] = w + Q | 0, i[s++] = S + ce | 0, i[s++] = E + ye | 0
}
...
function ps(t, e, n, r, i) {
    ...
    for (let a = 0; a < i; a++, s += 16, e += 16) Ba(n, o, t, e, n, s), a > 0 && (o += 16), Ba(n, s, t, e += 16, n, o)
}
...
function N0(t, e, n) {
    ...
    if (le.number(i), le.number(s), le.number(o), le.number(a), le.number(u), le.number(d), c !== void 0 && typeof c != "function") throw new Error("progressCb should be function");
    const l = 128 * s,
        f = l / 4;
    if (i <= 1 || i & i - 1 || i >= 2 ** (l / 8) || i > 2 ** 32) throw new Error("Scrypt: N must be larger than 1, a power of 2, less than 2^(128 * r / 8) and less than 2^32");
    if (o < 0 || o > (2 ** 32 - 1) * 32 / l) throw new Error("Scrypt: p must be a positive integer less than or equal to ((2^32 - 1) * 32) / (128 * r)");
    if (a < 0 || a > (2 ** 32 - 1) * 32) throw new Error("Scrypt: dkLen should be positive integer less than or equal to (2^32 - 1) * 32");
    const h = l * (i + o);
    if (h > d) throw new Error(`Scrypt: parameters too large, ${h} (128 * r * (N + p)) > ${d} (maxmem)`);
    const p = No(Vi, t, e, {
            c: 1,
            dkLen: l * o
        }),
...
function L0(t, e, n) {
    ...
    for (let h = 0; h < s; h++) {
        const p = a * h;
        for (let m = 0; m < a; m++) u[m] = d[p + m];
        for (let m = 0, g = 0; m < r - 1; m++) ps(u, g, u, g += a, i), f();
        ps(u, (r - 1) * a, d, p, i), f();
        for (let m = 0; m < r; m++) {
            const g = d[p + a - 16] % r;
            for (let y = 0; y < a; y++) l[y] = d[p + y] ^ u[g * a + y];
            ps(l, 0, d, p, i), f()
        }
    }
    return O0(t, o, c, u, l)
...
function Fn(t) {
    ...
    let e = "";
    for (let n = 0; n < t.length; n++) e += $0[t[n]];
    return e
}
...
function Ge(t, e, n) {
    ...
    if (typeof e == "string") try {
        ...
        } else if (Ki(e)) r = Uint8Array.from(e);
...
function Tr(...t) {
    ...
    let n = 0;
    return t.forEach(r => {
        if (!Ki(r)) throw new Error("Uint8Array expected");
        e.set(r, n), n += r.length
    }), e
}
...
function Sd(t, e, n) {
    ...
    const o = () => {
        ...
        a = (...l) => n(i, r, ...l),
        u = (l = gs()) => {
            i = a(Ca([0]), l), r = a(), l.length !== 0 && (i = a(Ca([1]), l), r = a())
        },
        d = () => {
...
function Nr(t, e, n = {}) {
    const r = (i, s, o) => {
        ...
        const u = t[i];
        if (!(o && u === void 0) && !a(u, t)) throw new Error(`Invalid param ${String(i)}=${u} (${typeof u}), expected ${s}`)
    };
...
function W0(t, e, n) {
    if (n <= we || e < we) throw new Error("Expected power/modulo > 0");
    if (n === ve) return we;
    let r = ve;
    for (; e > we;) e & ve && (r = r * t % n), t = t * t % n, e >>= ve;
    return r
}
...
function Fs(t, e) {
    if (t === we || e <= we) throw new Error(`invert: expected positive integers, got n=${t} mod=${e}`);
    let n = Be(t, e),
        r = e,
        i = we,
        s = ve;
...
function Z0(t) {
    const e = (t - ve) / Wt;
    let n, r, i;
    for (n = t - ve, r = 0; n % Wt === we; n /= Wt, r++);
    for (i = Wt; i < t && W0(i, e, t) !== t - ve; i++);
    if (r === 1) {
        const o = (t + ve) / Ds;
        return function(u, d) {
            const c = u.pow(d, o);
            if (!u.eql(u.sqr(c), d)) throw new Error("Cannot find square root");
            return c
        }
    }
    const s = (n + ve) / Wt;
    return function(a, u) {
        if (a.pow(u, e) === a.neg(a.ONE)) throw new Error("Cannot find square root");
        let d = r,
        ...
        for (; !a.eql(f, a.ONE);) {
            ...
            let h = 1;
            for (let m = a.sqr(f); h < d && !a.eql(m, a.ONE); h++) m = a.sqr(m);
            const p = a.pow(c, ve << BigInt(d - h - 1));
            c = a.sqr(p), l = a.mul(l, p), f = a.mul(f, c), d = h
        }
        return l
    }
}
...
function K0(t) {
    ...
    if (t % Oa === Na) {
        ...
        return function(r, i) {
            ...
            if (!r.eql(r.sqr(d), i)) throw new Error("Cannot find square root");
            return d
        }
    }
    return Z0(t)
...
function J0(t) {
    const e = {
        ...
        n = X0.reduce((r, i) => (r[i] = "function", r), e);
    return Nr(t, n)
}

function Y0(t, e, n) {
    if (n < we) throw new Error("Expected power > 0");
    if (n === we) return t.ONE;
    if (n === ve) return e;
    let r = t.ONE,
        i = e;
    for (; n > we;) n & ve && (r = t.mul(r, i)), i = t.sqr(i), n >>= ve;
    return r
}
...
function eg(t, e, n = !1, r = {}) {
    if (t <= we) throw new Error(`Expected Fp ORDER > 0, got ${t}`);
    const {
        nBitLength: i,
        nByteLength: s
    } = $o(t, e);
    ...
    const o = K0(t),
        a = Object.freeze({
            ...
            fromBytes: u => {
                if (u.length !== s) throw new Error(`Fp.fromBytes: expected ${s}, got ${u.length}`);
                return n ? Lo(u) : nn(u)
            }
        });
...
function rg(t, e) {
    ...
    return {
        ...
        unsafeLadder(i, s) {
            let o = t.ZERO,
                a = i;
            for (; s > ng;) s & ys && (o = o.add(a)), a = a.double(), s >>= ys;
            return o
        },
        precomputeWindow(i, s) {
            ...
            for (let l = 0; l < o; l++) {
                c = d, u.push(c);
                for (let f = 1; f < a; f++) c = c.add(d), u.push(c);
                d = c.double()
            }
            return u
        },
        ...
        wNAFCached(i, s, o, a) {
            ...
            let d = s.get(i);
            return d || (d = this.precomputeWindow(i, u), u !== 1 && s.set(i, a(d))), this.wNAF(u, d, o)
        }
    }
}
...
function kd(t) {
    ...
    }), Object.freeze({ ...$o(t.n, t.nBitLength),
        ...t,
        p: t.Fp.ORDER
    })
} /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */
...
function ag(t) {
    ...
    function u(p) {
        ...
        if (m && typeof p != "bigint") {
            if (p instanceof Uint8Array && (p = Fn(p)), typeof p != "string" || !m.includes(p.length)) throw new Error("Invalid key");
            p = p.padStart(g * 2, "0")
        }
        let w;
        try {
    ...
    class l {
        constructor(m, g, y) {
            if (this.px = m, this.py = g, this.pz = y, m == null || !n.isValid(m)) throw new Error("x required");
        ...
        static fromAffine(m) {
            ...
            if (!m || !n.isValid(g) || !n.isValid(y)) throw new Error("invalid affine point");
            if (m instanceof l) throw new Error("projective point not allowed");
        ...
        _setWindowSize(m) {
            this._WINDOW_SIZE = m, d.delete(this)
        }
        assertValidity() {
            if (this.is0()) {
            ...
            if (!n.isValid(m) || !n.isValid(g)) throw new Error("bad point: x or y not FE");
            const y = n.sqr(g),
                _ = s(m);
            if (!n.eql(y, _)) throw new Error("bad point: equation left != right");
        ...
        equals(m) {
            ...
            const {
                ...
                py: S,
                pz: E
            } = m, A = n.eql(n.mul(g, E), n.mul(w, _)), C = n.eql(n.mul(y, E), n.mul(S, _));
            return A && C
        }
        negate() {
        ...
        double() {
            ...
            let E = n.ZERO,
                ...
                x = n.mul(S, S),
                P = n.mul(_, w);
            return P = n.add(P, P), C = n.mul(_, S), C = n.add(C, C), E = n.mul(m, C), A = n.mul(y, x), A = n.add(E, A), E = n.sub(j, A), A = n.add(j, A), A = n.mul(E, A), E = n.mul(P, E), C = n.mul(y, C), x = n.mul(m, x), P = n.sub(v, x), P = n.mul(m, P), P = n.add(P, C), C = n.add(v, v), v = n.add(C, v), v = n.add(v, x), v = n.mul(v, P), A = n.add(A, v), x = n.mul(w, S), x = n.add(x, x), v = n.mul(x, P), E = n.sub(E, v), C = n.mul(x, j), C = n.add(C, C), C = n.add(C, C), new l(E, A, C)
        }
        add(m) {
            c(m);
            const {
            ...
            let P = n.mul(g, w),
                ...
                pe = n.add(g, y),
                k = n.add(w, S);
            pe = n.mul(pe, k), k = n.add(P, L), pe = n.sub(pe, k), k = n.add(g, _);
            let R = n.add(w, E);
            return k = n.mul(k, R), R = n.add(P, D), k = n.sub(k, R), R = n.add(y, _), A = n.add(S, E), R = n.mul(R, A), A = n.add(L, D), R = n.sub(R, A), v = n.mul(j, k), A = n.mul(x, D), v = n.add(A, v), A = n.sub(L, v), v = n.add(L, v), C = n.mul(A, v), L = n.add(P, P), L = n.add(L, P), D = n.mul(j, D), k = n.mul(x, k), L = n.add(L, D), D = n.sub(P, D), D = n.mul(j, D), k = n.add(k, D), P = n.mul(L, k), C = n.add(C, P), P = n.mul(R, k), A = n.mul(pe, A), A = n.sub(A, P), P = n.mul(pe, L), v = n.mul(R, v), v = n.add(v, P), new l(A, C, v)
        }
        subtract(m) {
        ...
        multiplyUnsafe(m) {
            const g = l.ZERO;
            if (m === pt) return g;
            if (a(m), m === Ue) return this;
            const {
                endo: y
            } = e;
            if (!y) return h.unsafeLadder(this, m);
            let {
                k1neg: _,
                k1: w,
                k2neg: S,
                k2: E
            } = y.splitScalar(m), A = g, C = g, v = this;
            for (; w > pt || E > pt;) w & Ue && (A = A.add(v)), E & Ue && (C = C.add(v)), v = v.double(), w >>= Ue, E >>= Ue;
            return _ && (A = A.negate()), S && (C = C.negate()), C = new l(n.mul(C.px, y.beta), C.py, C.pz), A.add(C)
        }
        multiply(m) {
            a(m);
            let g = m,
            ...
            if (w) {
                ...
                v = h.constTimeNegate(S, v), x = h.constTimeNegate(A, x), x = new l(n.mul(x.px, w.beta), x.py, x.pz), y = v.add(x), _ = j.add(P)
            } else {
                const {
                    p: S,
                    f: E
        ...
        toRawBytes(m = !0) {
            return this.assertValidity(), r(l, this, m)
        }
        toHex(m = !0) {
...
function dg(t) {
    ...
    class y {
        constructor(R, F, te) {
            this.r = R, this.s = F, this.recovery = te, this.assertValidity()
        }
        static fromCompact(R) {
            const F = e.nByteLength;
            return R = Ge("compactSignature", R, F * 2), new y(g(R, 0, F), g(R, F, 2 * F))
        }
        static fromDER(R) {
            const {
                r: F,
        ...
        recoverPublicKey(R) {
            ...
            if (!kt) throw new Error("point at infinify");
    ...
    function j(k) {
        ...
        if (!(pt <= k && k < v)) throw new Error(`bigint expected < 2^${e.nBitLength}`);
        return Nn(k, e.nByteLength)
    }

    function x(k, R, F = P) {
        if (["recovered", "canonical"].some(zt => zt in F)) throw new Error("sign() legacy options not supported");
        const {
            hash: te,
            randomBytes: Q
        } = e;
        ...
        ce == null && (ce = !0), k = Ge("msgHash", k), ye && (k = Ge("prehashed msgHash", te(k)));
        const Tt = C(k),
            St = c(R),
            vn = [j(St), j(Tt)];
        if (Ee != null) {
        ...
        function as(zt) {
            ...
            let oa = (_n.x === We ? 0 : 2) | Number(_n.y & Ue),
                aa = wn;
            return ce && p(wn) && (aa = m(wn), oa ^= 1), new y(We, aa, oa)
        }
        return {
            seed: Kn,
            k2sig: as
    ...
    function pe(k, R, F, te = L) {
        var _n;
        const Q = k;
        if (R = Ge("msgHash", R), F = Ge("publicKey", F), "strict" in te) throw new Error("options.strict was renamed to lowS");
        const {
            lowS: ce,
            prehash: ye
        } = te;
        ...
        try {
            if (typeof Q == "string" || Q instanceof Uint8Array) try {
                ...
                if (!(We instanceof Kt.Err)) throw We;
                Ee = y.fromCompact(Q)
            ...
            if (We.message === "PARSE") throw new Error("signature must be Signature instance, Uint8Array or hex string");
            return !1
        }
        if (ce && Ee.hasHighS()) return !1;
        ye && (R = e.hash(R));
        const {
            r: St,
            s: vn
        } = Ee, Kn = C(R), kt = u(vn), as = a(Kn * kt), zt = a(St * kt), bn = (_n = d.BASE.multiplyAndAddUnsafe(Tt, as, zt)) == null ? void 0 : _n.toAffine();
...
function hg(t) {
    const e = Ad,
        ...
        E = Fe(S, r, e) * d % e,
        A = Fe(E, Gs, e);
    if (!Us.eql(Us.sqr(A), t)) throw new Error("Cannot find square root");
    return A
}
    ...
    Ho = lg({
        ...
        endo: {
            ...
            splitScalar: t => {
                ...
                const l = d > o,
                    f = c > o;
                if (l && (d = e - d), f && (c = e - c), d > o || c > o) throw new Error("splitScalar: Endomorphism failed, k=" + t);
                return {
                    k1neg: l,
                    k1: d,
                    k2neg: f,
...
const Pd = t => {
    if (typeof t != "string") throw new Error(`[stripHexPrefix] input must be type 'string', received ${typeof t}`);
...
const Rd = function(t) {
    if (!Number.isSafeInteger(t) || t < 0) throw new Error(`Received an invalid integer type: ${t}`);
...
function bg(t, e = !0) {
    ...
    if (l === "" && (l = "0x"), po(f) || (f = Rd(parseInt(f))), h.length !== 18 && (h = vg(h)), s.eip155Block !== s.eip158Block) throw new Error("EIP155 block number must equal EIP 158 block number since both are part of SpuriousDragon hardfork and the client only supports activating the full hardfork");
    const g = {
            name: i,
            chainId: m,
            networkId: m,
        ...
        _ = Object.keys(y).reduce((E, A) => (E[y[A].name] = A, E), {}),
    ...
    if (g.hardforks = w.map(E => ({
        ...
        })).filter(E => E.block !== null || E.timestamp !== void 0), g.hardforks.sort((E, A) => {
            var C, v;
    ...
    return g.hardfork = S == null ? void 0 : S.name, g.hardforks.unshift({
        name: de.Chainstart,
        block: 0
    }), g
}
...
function _g(t, e, n) {
    try {
        if (["config", "difficulty", "gasLimit", "alloc"].some(r => !(r in t))) throw new Error("Invalid format, expected geth genesis fields missing");
        return e !== void 0 && (t.name = e), bg(t, n)
    } catch (r) {
...
function Bd(t) {
    let e = t;
    if (typeof e != "string") throw new Error(`[padToEven] value must be type 'string', received ${typeof e}`);
...
const wg = function(t) {
    ...
    fe = function(t) {
        ...
        if (typeof t == "string") {
            if (!Dc(t)) throw new Error(`Cannot convert string to Uint8Array. only supports 0x-prefixed hex strings and this string was given: ${t}`);
            return ue(Bd(Pd(t)))
        }
        if (typeof t == "number") return fe(He(t));
        if (typeof t == "bigint") {
            if (t < BigInt(0)) throw new Error(`Cannot convert negative bigint to Uint8Array. Given: ${t}`);
            let e = t.toString(16);
            return e.length % 2 && (e = `0${e}`), fe(`0x${e}`)
        }
...
const Cd = function(t) {
    ...
    Eg = function(t, e, n) {
        const r = Cd(e);
        return n ? t.length < e ? (r.set(t), r) : t.subarray(0, e) : t.length < e ? (r.set(t, e - t.length), r) : t.subarray(-e)
    };
...
const Fa = function(t, e) {
    return jo(t), Eg(t, e, !1)
};

function Ig(t) {
    let e = t[0];
    for (; t.length > 0 && e.toString() === "0";) t = t.slice(1), e = t[0];
    return t
}
const Si = function(t) {
        return jo(t), Ig(t)
...
const Do = function(t, e, n, r, i) {
    const s = Tg(e, i);
    if (!Sg(s)) throw new Error("Invalid signature v value");
...
function En(t, e) {
    ...
    if (t === void 0) return;
    if (typeof t == "string" && !Dc(t)) throw new Error(`A string must be provided with a 0x-prefix, given: ${t}`);
    if (typeof t == "number" && !Number.isSafeInteger(t)) throw new Error("The provided number is greater than MAX_SAFE_INTEGER (please use an alternative input type)");
    const n = fe(t);
    switch (e) {
        case qe.Uint8Array:
            return n;
...
function In(t, e, n) {
    if (n > t.length) throw new Error("invalid RLP (safeSlice): end slice of Uint8Array out-of-bounds");
    return t.slice(e, n)
}
...
function Nd(t, e = !1) {
    if (typeof t > "u" || t === null || t.length === 0) return Uint8Array.from([]);
    const n = Hd(t),
        r = qs(n);
    if (e) return r;
...
function qs(t) {
    ...
    if (a <= 183) {
        if (e = a - 127, a === 128 ? r = Uint8Array.from([]) : r = In(t, 1, e), e === 2 && r[0] < 128) throw new Error("invalid RLP encoding: invalid prefix, single byte < 0x80 are not prefixed");
        return {
            data: r,
            remainder: t.slice(e)
        }
    } else if (a <= 191) {
        if (n = a - 182, t.length - 1 < n) throw new Error("invalid RLP: not enough bytes for string length");
        if (e = Ga(In(t, 1, n)), e <= 55) throw new Error("invalid RLP: expected string length to be greater than 55");
        return r = In(t, n, e + n), {
            data: r,
            remainder: t.slice(e + n)
        }
    } else if (a <= 247) {
        for (e = a - 191, i = In(t, 1, e); i.length;) s = qs(i), o.push(s.data), i = s.remainder;
        return {
            data: o,
            remainder: t.slice(e)
        }
    } else {
        if (n = a - 246, e = Ga(In(t, 1, n)), e < 56) throw new Error("invalid RLP: encoded list too short");
        const u = n + e;
        if (u > t.length) throw new Error("invalid RLP: total length is larger than the data");
        for (i = In(t, n, u); i.length;) s = qs(i), o.push(s.data), i = s.remainder;
        return {
            data: o,
            remainder: t.slice(u)
        }
...
function Od(t) {
    let e = "";
    for (let n = 0; n < t.length; n++) e += kg[t[n]];
    return e
}
...
function Hd(t) {
    if (t instanceof Uint8Array) return t;
    if (typeof t == "string") return $d(t) ? ki(Ag(Pg(t))) : Md(t);
    if (typeof t == "number" || typeof t == "bigint") return t ? ki(Vs(t)) : Uint8Array.from([]);
...
var jd = {}; /*! crc32.js (C) 2014-present SheetJS -- http://sheetjs.com */
(function(t) {
    (function(e) {
        ...
        function n() {
            for (var v = 0, j = new Array(256), x = 0; x != 256; ++x) v = x, v = v & 1 ? -306674912 ^ v >>> 1 : v >>> 1, v = v & 1 ? -306674912 ^ v >>> 1 : v >>> 1, v = v & 1 ? -306674912 ^ v >>> 1 : v >>> 1, v = v & 1 ? -306674912 ^ v >>> 1 : v >>> 1, v = v & 1 ? -306674912 ^ v >>> 1 : v >>> 1, v = v & 1 ? -306674912 ^ v >>> 1 : v >>> 1, v = v & 1 ? -306674912 ^ v >>> 1 : v >>> 1, v = v & 1 ? -306674912 ^ v >>> 1 : v >>> 1, j[x] = v;
        ...
        function i(v) {
            ...
            for (P = 0; P != 256; ++P) L[P] = v[P];
            for (P = 0; P != 256; ++P)
                for (x = v[P], j = 256 + P; j < 4096; j += 256) x = L[j] = x >>> 8 ^ v[x & 255];
            var D = [];
            for (P = 1; P != 16; ++P) D[P - 1] = typeof Int32Array < "u" ? L.subarray(P * 256, P * 256 + 256) : L.slice(P * 256, P * 256 + 256);
            return D
        }
        var s = i(r),
            o = s[0],
        ...
        function E(v, j) {
            for (var x = j ^ -1, P = 0, L = v.length; P < L;) x = x >>> 8 ^ r[(x ^ v.charCodeAt(P++)) & 255];
            return ~x
        }

        function A(v, j) {
            for (var x = j ^ -1, P = v.length - 15, L = 0; L < P;) x = S[v[L++] ^ x & 255] ^ w[v[L++] ^ x >> 8 & 255] ^ _[v[L++] ^ x >> 16 & 255] ^ y[v[L++] ^ x >>> 24] ^ g[v[L++]] ^ m[v[L++]] ^ p[v[L++]] ^ h[v[L++]] ^ f[v[L++]] ^ l[v[L++]] ^ c[v[L++]] ^ d[v[L++]] ^ u[v[L++]] ^ a[v[L++]] ^ o[v[L++]] ^ r[v[L++]];
            for (P += 15; L < P;) x = x >>> 8 ^ r[(x ^ v[L++]) & 255];
            return ~x
        }

        function C(v, j) {
            for (var x = j ^ -1, P = 0, L = v.length, D = 0, pe = 0; P < L;) D = v.charCodeAt(P++), D < 128 ? x = x >>> 8 ^ r[(x ^ D) & 255] : D < 2048 ? (x = x >>> 8 ^ r[(x ^ (192 | D >> 6 & 31)) & 255], x = x >>> 8 ^ r[(x ^ (128 | D & 63)) & 255]) : D >= 55296 && D < 57344 ? (D = (D & 1023) + 64, pe = v.charCodeAt(P++) & 1023, x = x >>> 8 ^ r[(x ^ (240 | D >> 8 & 7)) & 255], x = x >>> 8 ^ r[(x ^ (128 | D >> 2 & 63)) & 255], x = x >>> 8 ^ r[(x ^ (128 | pe >> 6 & 15 | (D & 3) << 4)) & 255], x = x >>> 8 ^ r[(x ^ (128 | pe & 63)) & 255]) : (x = x >>> 8 ^ r[(x ^ (224 | D >> 12 & 15)) & 255], x = x >>> 8 ^ r[(x ^ (128 | D >> 6 & 63)) & 255], x = x >>> 8 ^ r[(x ^ (128 | D & 63)) & 255]);
            return ~x
        }
        e.table = r, e.bstr = E, e.buf = A, e.str = C
    })
})(jd);
const Rg = cc(jd),
    Bg = {
...
class _e extends xo {
    constructor(e) {
        var n, r;
        super(), this._eips = [], this._customChains = (n = e.customChains) !== null && n !== void 0 ? n : [], this._chainParams = this.setChain(e.chain), this.DEFAULT_HARDFORK = (r = this._chainParams.defaultHardfork) !== null && r !== void 0 ? r : de.Merge, this.HARDFORK_CHANGES = this.hardforks().map(i => [i.name, by[i.name]]), this._hardfork = this.DEFAULT_HARDFORK, e.hardfork !== void 0 && this.setHardfork(e.hardfork), e.eips && this.setEIPs(e.eips)
    }
    static custom(e, n = {}) {
        var r;
        const i = (r = n.baseChain) !== null && r !== void 0 ? r : "mainnet",
            s = Object.assign({}, _e._getChainParams(i));
        if (s.name = "custom-chain", typeof e != "string") return new _e(Object.assign({
            chain: Object.assign(Object.assign({}, s), e)
        }, n));
        if (e === Ie.PolygonMainnet) return _e.custom({
            name: Ie.PolygonMainnet,
            chainId: 137,
            networkId: 137
        }, n);
        if (e === Ie.PolygonMumbai) return _e.custom({
            name: Ie.PolygonMumbai,
            chainId: 80001,
            networkId: 80001
        }, n);
        if (e === Ie.ArbitrumRinkebyTestnet) return _e.custom({
            name: Ie.ArbitrumRinkebyTestnet,
            chainId: 421611,
            networkId: 421611
        }, n);
        if (e === Ie.ArbitrumOne) return _e.custom({
            name: Ie.ArbitrumOne,
            chainId: 42161,
            networkId: 42161
        }, n);
        if (e === Ie.xDaiChain) return _e.custom({
            name: Ie.xDaiChain,
            chainId: 100,
            networkId: 100
        }, n);
        if (e === Ie.OptimisticKovan) return _e.custom({
        ...
        if (e === Ie.OptimisticEthereum) return _e.custom({
    ...
    static fromGethGenesis(e, {
        ...
        return i !== void 0 && d.setForkHashes(i), d
    }
    ...
    setChain(e) {
        if (typeof e == "number" || typeof e == "bigint" || typeof e == "string") this._chainParams = _e._getChainParams(e, this._customChains);
            ...
            for (const r of n)
                if (!(r in e)) throw new Error(`Missing required chain parameter: ${r}`);
            this._chainParams = e
    ...
    setHardfork(e) {
        let n = !1;
        for (const r of this.HARDFORK_CHANGES) r[0] === e && (this._hardfork !== e && (this._hardfork = e, this.emit("hardforkChanged", e)), n = !0);
    ...
    getHardforkByBlockNumber(e, n, r) {
        ...
        if (a.slice(u + 1).findIndex(h => h.ttd !== null && h.ttd !== void 0) >= 0) throw Error("More than one merge hardforks found with ttd specified");
        ...
        if (c -= 1, a[c].block === null && a[c].timestamp === void 0)(s == null || BigInt(a[c].ttd) > s) && (c -= 1);
        else if (u >= 0 && s !== void 0 && s !== null) {
            if (c >= u && BigInt(a[u].ttd) > s) throw Error("Maximum HF determined by total difficulty is lower than the block number HF");
            if (c < u && BigInt(a[u].ttd) <= s) throw Error("HF determined by block number is lower than the minimum total difficulty HF")
        }
        const l = c;
    ...
    setEIPs(e = []) {
        for (const n of e) {
            if (!(n in Tn)) throw new Error(`${n} not supported`);
            ...
            if (Tn[n].requiredEIPs !== void 0) {
                for (const i of Tn[n].requiredEIPs)
                    if (!(e.includes(i) || this.isActivatedEIP(i))) throw new Error(`${n} requires EIP ${i}, but is not included in the EIP list`)
            }
        }
        this._eips = e
    }
    ...
    paramByEIP(e, n, r) {
        if (!(r in Tn)) throw new Error(`${r} not supported`);
        const i = Tn[r];
    ...
    hardforkGteHardfork(e, n) {
        ...
        let s = -1,
            o = -1,
            a = 0;
        for (const u of i) u.name === r && (s = a), u.name === n && (o = a), a += 1;
        return s >= o && o !== -1
    }
    gteHardfork(e) {
    ...
    eipBlock(e) {
        for (const n of this.HARDFORK_CHANGES) {
            const r = n[1];
            if ("eips" in r && r.eips.includes(e)) return this.hardforkBlock(typeof n[0] == "number" ? String(n[0]) : n[0])
        }
        return null
    }
    hardforkTTD(e) {
    ...
    nextHardforkBlockOrTimestamp(e) {
        ...
        if (i === de.Merge && (o -= 1), o < 0) return null;
        ...
        const u = s.slice(o + 1).find(c => {
            ...
            return f = f != null ? Number(f) : null, c.name !== de.Merge && f !== null && f !== void 0 && f !== a
        });
    ...
    _calcForkHash(e, n) {
        ...
        for (const a of this.hardforks()) {
            ...
            let l = d ? ? u;
            if (l = l !== null ? Number(l) : null, typeof l == "number" && l !== 0 && l !== i && c !== de.Merge) {
    ...
    consensusType() {
        ...
        for (const r of this.HARDFORK_CHANGES)
            if ("consensus" in r[1] && (n = r[1].consensus.type), r[0] === e) break;
    ...
    consensusAlgorithm() {
        ...
        let n;
        for (const r of this.HARDFORK_CHANGES)
            if ("consensus" in r[1] && (n = r[1].consensus.algorithm), r[0] === e) break;
    ...
    static _getInitializedChains(e) {
        const n = {};
        for (const [i, s] of Object.entries(Ti)) n[s] = i.toLowerCase();
        const r = {
            mainnet: Cg,
            goerli: Bg,
            sepolia: Ng
...
class On {
    ...
    static publicToAddress(e, n = !1) {
        let r = e;
        if (jo(r), n && r.length !== 64 && (r = xt.ProjectivePoint.fromHex(r).toRawBytes(!1).slice(1)), r.length !== 64) throw new Error("Expected pubKey to be of length 64");
        ...
        if (xy(t)) {
            ...
            for (let i = 0; i < t.length; i += 1) {
                const s = t[i],
                    o = fe(s.address),
                    a = [];
                for (let u = 0; u < s.storageKeys.length; u += 1) a.push(fe(s.storageKeys[u]));
                r.push([o, a])
            }
            n = r
        } else {
            ...
            for (let i = 0; i < n.length; i += 1) {
                const s = n[i],
                    o = X(s[0]),
                    a = [];
                for (let d = 0; d < s[1].length; d += 1) a.push(X(s[1][d]));
                const u = {
                    address: o,
                    storageKeys: a
                };
    ...
    Fd = t => {
        for (let e = 0; e < t.length; e += 1) {
            ...
            for (let s = 0; s < i.length; s += 1)
                if (i[s].length !== 32) throw new Error("Invalid EIP-2930 transaction: storage slot length should be 32 bytes")
        }
    },
    Gd = t => {
        const e = [];
...
class Un {
    constructor(e, n) {
        ...
        this.cache = {
            hash: void 0,
            dataFee: void 0
        }, this.activeCapabilities = [], this.DEFAULT_CHAIN = Ti.Mainnet, this.DEFAULT_HARDFORK = de.Merge;
        const {
            nonce: s,
            gasLimit: o,
            to: a,
        ...
        this._type = Number(ae(fe(h))), this.txOptions = n;
        const p = fe(a === "" ? "0x" : a),
            m = fe(c === "" ? "0x" : c),
            g = fe(l === "" ? "0x" : l),
            y = fe(f === "" ? "0x" : f);
        this.nonce = ae(fe(s === "" ? "0x" : s)), this.gasLimit = ae(fe(o === "" ? "0x" : o)), this.to = p.length > 0 ? new On(p) : void 0, this.value = ae(fe(u === "" ? "0x" : u)), this.data = fe(d === "" ? "0x" : d), this.v = m.length > 0 ? ae(m) : void 0, this.r = g.length > 0 ? ae(g) : void 0, this.s = y.length > 0 ? ae(y) : void 0, this._validateCannotExceedMaxInteger({
            value: this.value,
            r: this.r,
            s: this.s
    ...
    getDataFee() {
        ...
        let r = BigInt(0);
        for (let i = 0; i < this.data.length; i += 1) this.data[i] === 0 ? r += e : r += n;
    ...
    sign(e) {
        ...
        let n = !1;
        this.type === 0 && this.common.gteHardfork("spuriousDragon") && !this.supports(rt.EIP155ReplayProtection) && (this.activeCapabilities.push(rt.EIP155ReplayProtection), n = !0);
    ...
    _validateCannotExceedMaxInteger(e, n = 256, r = !1) {
        for (const [i, s] of Object.entries(e)) switch (n) {
            case 64:
                if (r) {
                    if (s !== void 0 && s >= Ha) {
...
class Xt extends Un {
    constructor(e, n = {}) {
        ...
        const u = Dd(s ? ? []);
        if (this.accessList = u.accessList, this.AccessListJSON = u.AccessListJSON, Fd(this.accessList), this.maxFeePerGas = ae(fe(o === "" ? "0x" : o)), this.maxPriorityFeePerGas = ae(fe(a === "" ? "0x" : a)), this._validateCannotExceedMaxInteger({
                maxFeePerGas: this.maxFeePerGas,
                maxPriorityFeePerGas: this.maxPriorityFeePerGas
            }), Un._validateNotArray(e), this.gasLimit * this.maxFeePerGas > Sr) {
    ...
    static fromSerializedTx(e, n = {}) {
        if (!Gi(e.subarray(0, 1), bs)) throw new Error(`Invalid serialized tx input: not an EIP-1559 transaction (wrong tx type, expected: ${Ws}, received: ${X(e.subarray(0,1))}`);
    ...
    static fromValuesArray(e, n = {}) {
        if (e.length !== 9 && e.length !== 12) throw new Error("Invalid EIP-1559 transaction. Only expecting 9 values (for unsigned tx) or 12 values (for signed tx).");
    ...
    getDataFee() {
        ...
        return e += BigInt(Ud(this.accessList, this.common)), Object.isFrozen(this) && (this.cache.dataFee = {
            value: e,
    ...
    hash() {
        ...
        return Object.isFrozen(this) ? (this.cache.hash || (this.cache.hash = Se(this.serialize())), this.cache.hash) : Se(this.serialize())
    }
...
class Jt extends Un {
    constructor(e, n = {}) {
        ...
        const a = Dd(s ? ? []);
        if (this.accessList = a.accessList, this.AccessListJSON = a.AccessListJSON, Fd(this.accessList), this.gasPrice = ae(fe(o === "" ? "0x" : o)), this._validateCannotExceedMaxInteger({
                gasPrice: this.gasPrice
            }), Un._validateNotArray(e), this.gasPrice * this.gasLimit > Sr) {
    ...
    static fromSerializedTx(e, n = {}) {
        if (!Gi(e.subarray(0, 1), _s)) throw new Error(`Invalid serialized tx input: not an EIP-2930 transaction (wrong tx type, expected: ${Zs}, received: ${X(e.subarray(0,1))}`);
        const r = Me.decode(Uint8Array.from(e.subarray(1)));
        if (!Array.isArray(r)) throw new Error("Invalid serialized tx input: must be array");
        return Jt.fromValuesArray(r, n)
    }
    static fromValuesArray(e, n = {}) {
        if (e.length !== 8 && e.length !== 11) throw new Error("Invalid EIP-2930 transaction. Only expecting 8 values (for unsigned tx) or 11 values (for signed tx).");
...
class Lt extends Un {
    constructor(e, n = {}) {
        ...
        if (super(Object.assign(Object.assign({}, e), {
                type: Iy
            }), n), this.common = this._validateTxV(this.v, n.common), this.gasPrice = ae(fe(e.gasPrice === "" ? "0x" : e.gasPrice)), this.gasPrice * this.gasLimit > Sr) {
            const s = this._errorMsg("gas limit * gasPrice cannot exceed MAX_INTEGER (2^256-1)");
            throw new Error(s)
        }
        this._validateCannotExceedMaxInteger({
            gasPrice: this.gasPrice
        }), Un._validateNotArray(e), this.common.gteHardfork("spuriousDragon") && (this.isSigned() ? qa(this.v, this.common.chainId()) && this.activeCapabilities.push(rt.EIP155ReplayProtection) : this.activeCapabilities.push(rt.EIP155ReplayProtection)), ((r = n == null ? void 0 : n.freeze) !== null && r !== void 0 ? r : !0) && Object.freeze(this)
    }
    static fromTxData(e, n = {}) {
        return new Lt(e, n)
    }
    ...
    static fromValuesArray(e, n = {}) {
        if (e.length !== 6 && e.length !== 9) throw new Error("Invalid transaction. Only expecting 6 values (for unsigned tx) or 9 values (for signed tx).");
    ...
    _getMessageToSign() {
        ...
        return this.supports(rt.EIP155ReplayProtection) && (e.push(fe(this.common.chainId())), e.push(Si(fe(0))), e.push(Si(fe(0)))), e
    }
    getMessageToSign(e = !0) {
    ...
    hash() {
        ...
        return Object.isFrozen(this) ? (this.cache.hash || (this.cache.hash = Se(Me.encode(this.raw()))), this.cache.hash) : Se(Me.encode(this.raw()))
    }
    getMessageToVerifySignature() {
        if (!this.isSigned()) {
    ...
    _validateTxV(e, n) {
        ...
        if (i !== void 0 && i !== 0 && (!n || n.gteHardfork("spuriousDragon")) && i !== 27 && i !== 28)
            if (n) {
                if (!qa(BigInt(i), n.chainId())) throw new Error(`Incompatible EIP155-based V ${i} and chain id ${n.chainId()}. See the Common parameter of the Transaction constructor to set the chain id.`)
            } else {
                let s;
...
class hn {
    ...
    static fromTxData(e, n = {}) {
        if (!("type" in e) || e.type === void 0) return Lt.fromTxData(e, n);
        const r = hn.typeToInt(e.type);
        if (r === 0) return Lt.fromTxData(e, n);
        if (r === 1) return Jt.fromTxData(e, n);
        if (r === 2) return Xt.fromTxData(e, n);
        const i = ws.get(r);
            ...
            default:
                {
                    ...
                    if (r != null && r.fromSerializedTx) return r.fromSerializedTx(e, n);
                    throw new Error(`TypedTransaction with ID ${e[0]} unknown`)
                }
        } else return Lt.fromSerializedTx(e, n)
    }
    static fromBlockBodyData(e, n = {}) {
        if (e instanceof Uint8Array) return this.fromSerializedData(e, n);
        if (Array.isArray(e)) return Lt.fromValuesArray(e, n);
...
const Wn = (t, e) => {
        let n;
        if (!e && typeof t == "string" && se(t) && t.length !== 66) throw new ca;
        try {
            n = t instanceof Uint8Array ? t : at(t)
        } catch {
            throw new Sf
        }
        if (!e && n.byteLength !== 32) throw new ca;
        return n
    },
    Go = t => {
        const e = se(t) ? t : et(t),
...
${n.byteLength}`)),
    ...
    Ty = (t, e) => Xi(void 0, void 0, void 0, function*() {
        const n = t.sign(ue(e));
        if (b(n.v) || b(n.r) || b(n.s)) throw new Rs("Signer Error");
    ...
    Ks = (t, e, n, r, i) => {
        ...
        if (b(e)) throw new kf("signature string undefined");
        const s = 130,
            o = n ? t : Go(t);
    ...
    zd = (t, e, n) => Xi(void 0, void 0, void 0, function*() {
        ...
        const c = Wn(t);
        let l;
        if (n != null && n.salt ? l = typeof n.salt == "string" ? ue(n.salt) : n.salt : l = Er(32), !(ho(e) || e instanceof Uint8Array)) throw new Rf;
        const f = typeof e == "string" ? ue(et(e)) : e;
        let h;
        if (n != null && n.iv) {
            if (h = typeof n.iv == "string" ? ue(n.iv) : n.iv, h.length !== 16) throw new Bf
        } else h = Er(16);
        ...
        const y = yield Bo(c, m.slice(0, 16), h, "aes-128-ctr"), _ = X(y).slice(2), w = je(Re(m.slice(16, 32), y)).replace("0x", "");
        return {
            version: 3,
            id: So(),
    ...
    Py = (t, e, n) => Xi(void 0, void 0, void 0, function*() {
        ...
        if (H.validateJSONSchema(yg, r), r.version !== 3) throw new Pf;
        ...
        if (je(Re(s.slice(16, 32), o)).replace("0x", "") !== r.crypto.mac) throw new Af;
...
class By {
    ...
    execute(e) {
        ...
        return za(this, void 0, void 0, function*() {
            ...
            return this._processBatchRequest(r).catch(i => r.reject(i)), r.catch(i => {
                i instanceof lc && this._abortAllRequests("Batch request timeout"), r.reject(i)
            }), r
        })
    }
    _processBatchRequest(e) {
        ...
        return za(this, void 0, void 0, function*() {
            ...
            if (i.length !== this._requests.size) throw this._abortAllRequests("Invalid batch response"), new ht(i, `Batch request size mismatch the results size. Requests: ${this._requests.size}, Responses: ${i.length}`);
            const s = this.requests.map(a => a.id).map(Number).sort((a, u) => a - u),
                o = i.map(a => a.id).map(Number).sort((a, u) => a - u);
            if (JSON.stringify(s) !== JSON.stringify(o)) throw this._abortAllRequests("Invalid batch response"), new ht(i, `Batch request mismatch the results. Requests: [${s.join()}], Responses: [${o.join()}]`);
            for (const a of i) gt(a) ? (n = this._requests.get(a.id)) === null || n === void 0 || n.promise.resolve(a.result) : yt(a) && ((r = this._requests.get(a.id)) === null || r === void 0 || r.promise.reject(a.error));
            e.resolve(i)
        })
    }
    _abortAllRequests(e) {
        for (const {
                promise: n
            } of this._requests.values()) n.reject(new jf(e))
    }
}
...
class Oe extends l0 {
    constructor(e) {
        var n;
        if (super(), this.providers = tn.providers, z(e) || typeof e == "string" && e.trim() !== "" || Ei(e)) {
            this._requestManager = new tn(e), this._subscriptionManager = new js(this._requestManager, {});
            return
        }
        const {
            config: r,
        ...
        this.setConfig(r ? ? {}), this._requestManager = s ? ? new tn(i, (n = r == null ? void 0 : r.enableExperimentalFeatures) === null || n === void 0 ? void 0 : n.useSubscriptionWhenCheckingBlockTimeout), o ? this._subscriptionManager = o : this._subscriptionManager = new js(this.requestManager, a ? ? {}), u && (this._accountProvider = u), d && (this._wallet = d)
    }
    get requestManager() {
    ...
    link(e) {
        this.setConfig(e.config), this._requestManager = e.requestManager, this.provider = e.provider, this._subscriptionManager = e.subscriptionManager, this._wallet = e.wallet, this._accountProvider = e._accountProvider, e.on(fn.CONFIG_CHANGE, n => {
            this.setConfig({
                [n.name]: n.newValue
            })
        })
    ...
    registerPlugin(e) {
        if (this[e.pluginNamespace] !== void 0) throw new Df(e.pluginNamespace);
        const n = {
            [e.pluginNamespace]: e
        };
...
class be {
    constructor(e) {
        if (this.toAddress = () => {
            ...
            }, be.isIndirect(e) || be.isDirect(e)) this._iban = e;
...
be._mod9710 = t => {
    let e = t,
        n;
    for (; e.length > 2;) n = e.slice(0, 9), e = `${(parseInt(n,10)%97).toString()}${e.slice(n.length)}`;
...
class Wd extends zi {
    constructor(e) {
        super(), this[Vd] = "Promise", this._promise = new Promise(e)
    }
    then(e, n) {
...
(function(t, e) {
    ...
    function a(_) {
        ...
        for (var w = new Array(arguments.length - 1), S = 0; S < w.length; S++) w[S] = arguments[S + 1];
        var E = {
            callback: _,
            args: w
        };
    ...
    function h() {
        ...
        t.addEventListener ? t.addEventListener("message", w, !1) : t.attachEvent("onmessage", w), o = function(S) {
            t.postMessage(_ + S, "*")
        }
    }
    ...
    function m() {
        ...
        o = function(w) {
            ...
            S.onreadystatechange = function() {
                c(w), S.onreadystatechange = null, _.removeChild(S), S = null
            }, _.appendChild(S)
        }
    }
    ...
    y = y && y.setTimeout ? y : t, {}.toString.call(t.process) === "[object process]" ? l() : f() ? h() : t.MessageChannel ? p() : s && "onreadystatechange" in s.createElement("script") ? m() : g(), y.setImmediate = a, y.clearImmediate = u
...
function Dy(t, e, n) {
    return Z(this, void 0, void 0, function*() {
        return H.validate(["address", "blockNumberOrTag"], [e, n]), t.send({
...
function Fy(t, e, n, r) {
    return Z(this, void 0, void 0, function*() {
        return H.validate(["address", "hex", "blockNumberOrTag"], [e, n, r]), t.send({
...
function Uy(t, e) {
    return Z(this, void 0, void 0, function*() {
        return H.validate(["bytes32"], [e]), t.send({
...
function qy(t, e) {
    return Z(this, void 0, void 0, function*() {
        return H.validate(["blockNumberOrTag"], [e]), t.send({
...
function Zy(t, e, n) {
    return Z(this, void 0, void 0, function*() {
        return H.validate(["address", "hex"], [e, n]), t.send({
            method: "eth_sign",
            params: [e, n]
        })
    })
...
function Kd(t, e) {
    return Z(this, void 0, void 0, function*() {
        return H.validate(["hex"], [e]), t.send({
...
function Jy(t, e, n) {
    return Z(this, void 0, void 0, function*() {
        return H.validate(["blockNumberOrTag"], [n]), t.send({
            method: "eth_call",
            params: [e, n]
        })
    })
...
function Qy(t, e, n) {
    return Z(this, void 0, void 0, function*() {
        return H.validate(["bytes32", "bool"], [e, n]), t.send({
...
function Xd(t, e, n) {
    return Z(this, void 0, void 0, function*() {
        return H.validate(["blockNumberOrTag", "bool"], [e, n]), t.send({
...
function tv(t, e, n) {
    return Z(this, void 0, void 0, function*() {
        return H.validate(["bytes32", "hex"], [e, n]), t.send({
...
function nv(t, e, n) {
    return Z(this, void 0, void 0, function*() {
        return H.validate(["blockNumberOrTag", "hex"], [e, n]), t.send({
...
function ov(t, e) {
    return Z(this, void 0, void 0, function*() {
        return H.validate(["filter"], [e]), t.send({
            method: "eth_getLogs",
            params: [e]
        })
    })
...
function cv(t, e, n, r) {
    return Z(this, void 0, void 0, function*() {
        return H.validate(["bytes8", "bytes32", "bytes32"], [e, n, r]), t.send({
...
function dv(t, e, n, r) {
    return Z(this, void 0, void 0, function*() {
        ...
        for (const i of r) H.validate(["number"], [i]);
        return t.send({
...
function hv(t, e, n, r) {
    return Z(this, void 0, void 0, function*() {
        return H.validate(["address", "bytes32[]", "blockNumberOrTag"], [e, n, r]), t.send({
            method: "eth_getProof",
            params: [e, n, r]
        })
    })
...
function gv(t, e, n, r = !1) {
    return Z(this, void 0, void 0, function*() {
        return H.validate(["address"], [e]), t.send({
...
const _v = t => Et(void 0, void 0, void 0, function*() {
    ...
    Pv = t => {
        ...
        if (!b(r.type)) {
            ...
            return Mr(s, r, r.type), I({
                format: "uint"
            }, r.type, U)
        }
        if (!b(r.maxFeePerGas) || !b(r.maxPriorityFeePerGas)) return Mr(Za, r, "0x2"), "0x2";
        if (!b(r.accessList)) return Mr(Wa, r, "0x1"), "0x1";
        const i = (e = r.hardfork) !== null && e !== void 0 ? e : (n = r.common) === null || n === void 0 ? void 0 : n.hardfork;
        if (!b(i)) {
            const s = Object.keys(sr).indexOf(i);
            if (s >= Object.keys(sr).indexOf("london")) return b(r.gasPrice) ? "0x2" : "0x0";
            if (s === Object.keys(sr).indexOf("berlin")) return "0x0"
        }
        if (!b(r.gasPrice)) return Mr(Va, r, "0x0"), "0x0"
    },
    Rv = (t, e) => {
        var n;
...
function Le(t, e = O, n = {
    ...
    var r, i;
    let s = qt({}, t);
    if (b(t == null ? void 0 : t.common) || (s.common = Object.assign({}, t.common), b((r = t.common) === null || r === void 0 ? void 0 : r.customChain) || (s.common.customChain = Object.assign({}, t.common.customChain))), s = I((i = n.transactionSchema) !== null && i !== void 0 ? i : Xs, s, e), !b(s.data) && !b(s.input) && jt(s.data) !== jt(s.input)) throw new pc({
        data: X(s.data),
        input: X(s.input)
    });
    return n.fillInputAndData && (b(s.data) ? b(s.input) || (s.data = s.input) : s.input = s.data), b(s.gasLimit) || (s.gas = s.gasLimit, delete s.gasLimit), s
}
...
function zv(t, e, n) {
    ...
    return Qd(this, void 0, void 0, function*() {
        ...
        if (b(o.baseFeePerGas)) throw new dh;
        if (!b(t.gasPrice)) {
            const a = I({
                format: "uint"
            }, t.gasPrice, n);
...
function eu(t, e, n) {
    return Qd(this, void 0, void 0, function*() {
        const r = tu(t, e);
        if (!b(r)) {
            if (r.startsWith("-")) throw new fa(r);
            if (Number(r) < 0 || Number(r) > 127) throw new fa(r);
            if (b(t.gasPrice) && (r === "0x0" || r === "0x1")) return {
                gasPrice: yield Pu(e, n), maxPriorityFeePerGas: void 0, maxFeePerGas: void 0
            };
...
const Ys = (t, e, n, r) => {
        if (n !== void 0 && t in n && n[t] !== void 0) {
            if (typeof n[t] == "string" && Ve(n[t])) return n[t];
            if (!se(n[t]) && qc(n[t])) {
                if (e.wallet) {
                    const i = e.wallet.get(I({
                        format: "uint"
                    }, n[t], Qi));
                    if (!b(i)) return i.address;
                    throw new ha
                }
                throw new ha
            } else throw t === "from" ? new qf(n.from) : new zf(n.to)
        }
        if (t === "from") {
            if (!b(r)) return Ji(r);
            if (!b(e.defaultAccount)) return e.defaultAccount
        }
    },
    ...
    tu = (t, e) => {
        const n = Rv(t, e);
        if (!b(n)) return n;
        if (!b(e.defaultTransactionType)) return I({
            format: "uint"
...
function Wv(t) {
    ...
    return Zo(this, void 0, void 0, function*() {
        ...
        if (b(r.from) && (r.from = Ys("from", t.web3Context, void 0, t.privateKey)), b(r.nonce) && (r.nonce = yield Vv(t.web3Context, r.from, U)), b(r.value) && (r.value = "0x0"), b(r.data)) b(r.input) ? r.input = "0x" : r.input.startsWith("0x") || (r.input = `0x${r.input}`);
        else {
            if (!b(r.input) && r.data !== r.input) throw new pc({
                data: X(r.data),
                input: X(r.input)
            });
        ...
        if (b(r.common)) {
            ...
            b(r.chain) && (r.chain = t.web3Context.defaultChain), b(r.hardfork) && (r.hardfork = t.web3Context.defaultHardfork)
        }
        if (b(r.chainId) && b((e = r.common) === null || e === void 0 ? void 0 : e.customChain.chainId) && (r.chainId = yield Ou(t.web3Context, U)), b(r.networkId) && (r.networkId = (n = t.web3Context.defaultNetworkId) !== null && n !== void 0 ? n : yield Wo(t.web3Context, U)), b(r.gasLimit) && !b(r.gas) && (r.gasLimit = r.gas), r.type = tu(r, t.web3Context), b(r.accessList) && (r.type === "0x1" || r.type === "0x2") && (r.accessList = []), t.fillGasPrice && (r = Object.assign(Object.assign({}, r), yield eu(r, t.web3Context, U))), b(r.gas) && b(r.gasLimit) && t.fillGasLimit) {
...
function Qs(t, e, n) {
    const r = t.transactionPollingInterval,
        [i, s] = rd(() => Ko(this, void 0, void 0, function*() {
            ...
            const u = a - e;
            if (u >= t.transactionBlockTimeout) return new yc({
...
function Kv(t, e, n) {
    ...
    return Ko(this, void 0, void 0, function*() {
        ...
        function a(d, c) {
            ...
            const [l, f] = Qs(t, e, n);
            o.clean = f.clean, l.catch(h => d(h))
        }
        try {
            s = yield(r = t.subscriptionManager) === null || r === void 0 ? void 0 : r.subscribe("newHeads"), o = {
                clean: () => {
                    var d;
                    s.id && ((d = t.subscriptionManager) === null || d === void 0 || d.removeSubscription(s).then(() => {}).catch(() => {}))
                }
            }
        } catch {
            return Qs(t, e, n)
...
function nu(t, e) {
    ...
    return Ko(this, void 0, void 0, function*() {
        ...
        return !((r = (n = i).supportsSubscriptions) === null || r === void 0) && r.call(n) && t.enableExperimentalFeatures.useSubscriptionWhenCheckingBlockTimeout ? s = yield Kv(t, o, e): s = Qs(t, o, e), s
    })
}
...
const zr = ({
    ...
    const o = setInterval(() => {
        Jv(void 0, void 0, void 0, function*() {
            ...
            a != null && a.hash && (s += 1, n.emit("confirmation", {
                confirmations: I({
                    format: "uint"
                }, s, r),
                receipt: I(Zn, e, r),
    ...
    setImmediate(() => {
        ...
        (o = t.subscriptionManager) === null || o === void 0 || o.subscribe("newHeads").then(a => {
            a.on("data", u => Ya(void 0, void 0, void 0, function*() {
                var d;
                if (i = !1, !(u != null && u.number) || s === (u == null ? void 0 : u.parentHash)) return;
                ...
                var u;
                yield(u = t.subscriptionManager) === null || u === void 0 ? void 0 : u.removeSubscription(a), i = !1, zr({
                    web3Context: t,
                    transactionReceipt: e,
                    transactionPromiEvent: n,
                    returnFormat: r
...
function Qv(t, e, n, r, i) {
    if (b(n) || b(n.blockHash)) throw new fh({
        receipt: n,
        blockHash: I({
            format: "bytes32"
...
const es = t => !z(t) && typeof t == "object" && !z(t.type) && t.type === "error",
    ...
    to = (t, e) => {
        ...
        return e.forEach(r => {
            if (typeof r.components == "object") {
                if (!r.type.startsWith("tuple")) throw new ne(`Invalid value given "${r.type}". Error: components found but type is not tuple.`);
    ...
    nb = t => {
        if (typeof t != "string" && !es(t)) throw new ne("Invalid parameter value in encodeErrorSignature");
        let e;
        return t && (typeof t == "function" || typeof t == "object") ? e = mn(t) : e = t, je(e)
    },
    Jo = t => {
        if (typeof t != "string" && !Xo(t)) throw new ne("Invalid parameter value in encodeEventSignature");
        let e;
        return t && (typeof t == "function" || typeof t == "object") ? e = mn(t) : e = t, je(e)
    };
...
var ou = /^bytes([1-9]|1[0-9]|2[0-9]|3[0-2])?$/,
    ...
    Qn = (t, e, n) => (ib(t, typeof e != "symbol" ? e + "" : e, n), n),
    sb = "abitype",
    ob = "0.7.1",
...
`);
            super(i), Qn(this, "details"), Qn(this, "docsPath"), Qn(this, "metaMessages"), Qn(this, "shortMessage"), Qn(this, "name", "AbiTypeError"), e.cause && (this.cause = e.cause), this.details = n, this.docsPath = r, this.metaMessages = e.metaMessages, this.shortMessage = t
        }
    },
...
function Pi(t, e) {
    ...
    if (Is.has(n)) return Is.get(n);
    const r = cu.test(t),
        i = Yo(r ? lb : ub, t);
    if (!i) throw new Ce("Invalid ABI parameter.", {
        details: t
    });
    if (i.name && mb(i.name)) throw new Ce("Invalid ABI parameter.", {
        details: t,
    ...
    if (r) {
        ...
        const h = Pn(i.type),
            p = [],
            m = h.length;
        for (let g = 0; g < m; g++) p.push(Pi(h[g], {
            structs: a
        }));
        d = {
            components: p
        }
    } else if (i.type in a) u = "tuple", d = {
        components: a[i.type]
    };
    else if (fb.test(i.type)) u = `${i.type}256`;
    else if (u = i.type, (e == null ? void 0 : e.type) !== "struct" && !lu(u)) throw new Ce("Unknown type.", {
        metaMessages: [`Type "${u}" is not a valid ABI type.`]
    });
    if (i.modifier) {
        if (!((f = (l = e == null ? void 0 : e.modifiers) == null ? void 0 : l.has) != null && f.call(l, i.modifier))) throw new Ce("Invalid ABI parameter.", {
            details: t,
            metaMessages: [`Modifier "${i.modifier}" not allowed${e!=null&&e.type?` in "${e.type}" type`:""}.`]
        });
        if (cb.has(i.modifier) && !pb(u, !!i.array)) throw new Ce("Invalid ABI parameter.", {
            details: t,
...
function Pn(t, e = [], n = "", r = 0) {
    if (t === "") {
        if (n === "") return e;
        if (r !== 0) throw new Ce("Unbalanced parentheses.", {
...
function gb(t) {
    ...
    for (let o = 0; o < n; o++) {
        ...
        if (!uu(a)) continue;
        const u = ab(a);
        if (!u) throw new Ce("Invalid struct signature.", {
            details: a
        });
        ...
        if (!c.length) throw new Ce("Invalid struct signature.", {
            details: a,
...
function fu(t, e, n = new Set) {
    ...
    for (let s = 0; s < i; s++) {
        const o = t[s];
        if (cu.test(o.type)) r.push(o);
        else {
            const u = Yo(yb, o.type);
            if (!(u != null && u.type)) throw new Ce("Invalid ABI parameter.", {
            ...
            if (c in e) {
                if (n.has(c)) throw new Ce("Circular reference detected.", {
            ...
            } else if (lu(c)) r.push(o);
            else throw new Ce("Unknown type.", {
...
function vb(t) {
    ...
    if (!e) throw new Ce("Failed to parse ABI parameter.", {
...
function mu(t) {
    return t.map(e => {
        var n;
        if (bb(e)) return e;
        if (typeof e == "string") return hu(vb(e.replace(/tuple/, "")));
        if (tb(e)) {
...
function Qo(t) {
    ...
    let i = -1;
    if (r !== "[]" && (i = Number(r.slice(1, -1)), isNaN(i))) throw new ne("Invalid fixed array size", {
        size: r
    });
    return {
        param: {
...
function _b(t, e) {
    if (typeof e != "string") throw new ne("address type expects string as input type", {
        value: e,
        name: t.name,
        type: t.type
    });
    let n = e.toLowerCase();
    if (n.startsWith("0x") || (n = `0x${n}`), !Ve(n)) throw new ne("provided input is not valid address", {
        value: e,
        name: t.name,
        type: t.type
    });
...
function wb(t, e) {
    ...
    if (n.length !== pu) throw new ne("Invalid decoding input, not enough bytes to decode address", {
        bytes: e
    });
    const r = Gt(n);
    return {
...
const Dt = new Map;
let $r = BigInt(256);
for (let t = 8; t <= 256; t += 8) Dt.set(`uint${t}`, {
    min: BigInt(0),
    max: $r - BigInt(1)
}), Dt.set(`int${t}`, {
    min: -$r / BigInt(2),
...
function xb(t, e = ge) {
    let n;
    return t < 0 ? n = (yu + t).toString(16) : n = t.toString(16), n = jn(n, e * 2), yn(n)
}
...
function Or(t, e) {
    ...
    if (!r) throw new ne("provided abi contains invalid number datatype", {
        type: t.type
    });
    if (n < r.min) throw new ne("provided input is less then minimum for given type", {
        type: t.type,
        value: e,
        name: t.name,
        minimum: r.min.toString()
    });
    if (n > r.max) throw new ne("provided input is greater then maximum for given type", {
        type: t.type,
        value: e,
        name: t.name,
...
function zn(t, e) {
    if (e.length < ge) throw new ne("Not enough bytes left to decode", {
        param: t,
        bytesLeft: e.length
    });
    ...
    const i = Eb(n, r.max);
    if (i < r.min) throw new ne("decoded value is less then minimum for given type", {
        type: t.type,
        value: i,
        name: t.name,
        minimum: r.min.toString()
    });
    if (i > r.max) throw new ne("decoded value is greater then maximum for given type", {
        type: t.type,
        value: i,
        name: t.name,
        maximum: r.max.toString()
...
function Ib(t, e) {
    ...
    try {
        ...
        if (r instanceof lo) throw new ne("provided input is not valid boolean value", {
            type: t.type,
            value: e,
            name: t.name
        })
...
function Tb(t, e) {
    ...
    if (n.result > 1 || n.result < 0) throw new ne("Invalid boolean value encoded", {
...
function vu(t, e) {
    if (typeof e == "string" && e.length % 2 !== 0 && (e += "0"), !Ut(e)) throw new ne("provided input is not valid bytes value", {
        type: t.type,
        value: e,
        name: t.name
    });
    ...
    if (r) {
        if (Number(r) > Sb || Number(r) < 1) throw new ne("invalid bytes type. Static byte type can have between 1 and 32 bytes", {
            type: t.type
        });
        if (Number(r) < n.length) throw new ne("provided input size is different than type size", {
            type: t.type,
            value: e,
            name: t.name
        });
...
function bu(t, e) {
    ...
    if (r > e.length) throw new ne("there is not enough data to decode", {
        type: t.type,
        encoded: e,
        size: r
    });
...
function kb(t, e) {
    if (typeof e != "string") throw new ne("invalid input, should be string", {
        input: e
    });
    const n = wo(e);
    return vu({
...
function _u(t) {
    ...
    const r = [],
        i = [];
    for (const s of t) s.dynamic ? e += ge : e += s.encoded.length;
    for (const s of t) s.dynamic ? (r.push(Or({
        type: "uint256",
        name: ""
    }, e + n)), i.push(s), n += s.encoded.length) : r.push(s);
    return Re(...r.map(s => s.encoded), ...i.map(s => s.encoded))
}

function Pb(t, e) {
    if (!Array.isArray(e)) throw new ne("Expected value to be array", {
        abi: t,
        values: e
    });
    const {
        size: n,
        param: r
    } = Qo(t), i = e.map(a => ro(r, a)), s = n === -1, o = i.length > 0 && i[0].dynamic;
    if (!s && e.length !== n) throw new ne("Given arguments count doesn't match array length", {
        arrayLength: n,
...
function Rb(t, e) {
    ...
    if (i) {
        ...
        n = Number(d.result), s = d.consumed, a = d.encoded
    }
    if (Ri(r)) {
        for (let d = 0; d < n; d += 1) {
            const c = zn({
...
function ro(t, e) {
    if (t.type === "string") return kb(t, e);
    if (t.type === "bool") return Ib(t, e);
    if (t.type === "address") return _b(t, e);
    if (t.type === "tuple") return wu(t, e);
    if (t.type.endsWith("]")) return Pb(t, e);
    if (t.type.startsWith("bytes")) return vu(t, e);
    if (t.type.startsWith("uint") || t.type.startsWith("int")) return Or(t, e);
    throw new Error("Unsupported")
}

function Bi(t, e) {
    if (t.type === "string") return Ab(t, e);
    if (t.type === "bool") return Tb(t, e);
    if (t.type === "address") return wb(t, e);
    if (t.type === "tuple") return xu(t, e);
    if (t.type.endsWith("]")) return Rb(t, e);
    if (t.type.startsWith("bytes")) return bu(t, e);
    if (t.type.startsWith("uint") || t.type.startsWith("int")) return zn(t, e);
    throw new Error("Unsupported")
}
...
function wu(t, e) {
    var n, r, i;
    let s = !1;
    if (!Array.isArray(e) && typeof e != "object") throw new ne("param must be either Array or Object", {
        param: t,
        input: e
    });
    const o = e,
    ...
    for (let u = 0; u < ((r = (n = t.components) === null || n === void 0 ? void 0 : n.length) !== null && r !== void 0 ? r : 0); u += 1) {
        ...
        let c;
        if (Array.isArray(o)) {
            if (u >= o.length) throw new ne("input param length missmatch", {
                param: t,
                input: e
            });
            c = ro(d, o[u])
            ...
            if (l == null) throw new ne("missing input defined in abi", {
                param: t,
                input: e,
                paramName: d.name
            });
...
function xu(t, e) {
    ...
    for (const [s, o] of t.components.entries()) {
        ...
        if (Ri(o)) {
            ...
            a = Bi(o, e.subarray(Number(u.result))), r += u.consumed, i += a.consumed
        } else a = Bi(o, e.subarray(r)), r += a.consumed;
...
function Cb(t, e) {
    if (t.length !== e.length) throw new ne("Invalid number of values received for given ABI", {
        expected: t.length,
        received: e.length
    });
    const n = mu(t);
...
const ns = (t, e) => Cb(t, e),
    ...
    Eu = (t, e, n) => {
        try {
            if (t.length > 0 && (!e || e === "0x" || e === "0X")) throw new ne("Returned values aren't valid, did it run Out of Gas? You might also see this error if you are not using the correct ABI for the contract you are retrieving data from, requesting data from a block number that does not exist, or querying a node which is not fully synced.");
    ...
    Iu = (t, e) => rs([t], e)[0],
    is = t => {
        if (typeof t != "string" && !ts(t)) throw new ne("Invalid parameter value in encodeFunctionSignature");
        let e;
        return t && (typeof t == "function" || typeof t == "object") ? e = mn(t) : e = t, je(e).slice(0, 10)
    },
    Nb = (t, e) => {
        var n;
        if (!ts(t)) throw new ne("Invalid parameter value in encodeFunctionCall");
    ...
    Tu = (t, e, n) => {
        ...
        let c = 0,
            l = 0;
        for (const [f, h] of t.entries()) d[f] = h.type === "string" ? "" : void 0, i[f] && (d[f] = u[c], c += 1), s[f] && (d[f] = o[String(l)], l += 1), h.name && (d[h.name] = d[f]), d.__length__ += 1;
        return d
    },
    Vr = (t, e) => {
        if (e != null && e.data) {
            ...
            try {
                ...
                o != null && o.inputs && (n = o.name, r = mn(o), i = rs([...o.inputs], e.data.substring(10)))
            } catch (s) {
                console.error(s)
            }
...
const Su = (t, e) => {
    ...
    if (t instanceof ar && !Array.isArray(t.innerError) && t.innerError !== void 0) return t.innerError.message;
    throw t
};
...
function Ts(t, e, n, r, i, s) {
    return $b(this, void 0, void 0, function*() {
        ...
        let a;
        if (o === void 0) a = new hc(n);
        else if (typeof o == "string") a = new si(o, void 0, n);
        ...
        } else a = new si(o.reason, o.signature, n, o.data);
        return a
    })
}
const ea = (t, e, n, r = O) => {
    ...
    if (d.inputs = (s = (i = d.inputs) !== null && i !== void 0 ? i : t.inputs) !== null && s !== void 0 ? s : [], !d.anonymous) {
        let f = 0;
...
class Au {
    ...
    checkRevertBeforeSending(e) {
        return Vt(this, void 0, void 0, function*() {
            if (this.options.checkRevertBeforeSending !== !1) {
                ...
                if (n !== void 0) throw yield Ts(this.web3Context, e, void 0, void 0, this.options.contractAbi, n)
            }
        })
    }
    emitSending(e) {
    ...
    populateGasPrice({
        ...
        return Vt(this, void 0, void 0, function*() {
            let i = e;
            return !(!((r = this.options) === null || r === void 0) && r.ignoreGasPricing) && b(e.gasPrice) && (b(n.maxPriorityFeePerGas) || b(n.maxFeePerGas)) && (i = Object.assign(Object.assign({}, e), yield eu(e, this.web3Context, U))), i
        })
    }
    signAndSend({
        wallet: e,
    ...
    handleError({
        ...
        return Vt(this, void 0, void 0, function*() {
            let i = e;
            return i instanceof Qt && this.web3Context.handleRevert && (i = yield Ts(this.web3Context, n, void 0, void 0, (r = this.options) === null || r === void 0 ? void 0 : r.contractAbi)), (i instanceof ar || i instanceof Qt || i instanceof fc || i instanceof hc || i instanceof si) && this.promiEvent.listenerCount("error") > 0 && this.promiEvent.emit("error", i), i
        })
    }
    emitConfirmation({
        receipt: e,
    ...
    handleResolve({
        ...
        var r, i, s;
        return Vt(this, void 0, void 0, function*() {
            if (!((r = this.options) === null || r === void 0) && r.transactionResolver) return (i = this.options) === null || i === void 0 ? void 0 : i.transactionResolver(e);
            if (e.status === BigInt(0)) {
                const o = yield Ts(this.web3Context, n, e, void 0, (s = this.options) === null || s === void 0 ? void 0 : s.contractAbi);
                throw this.promiEvent.listenerCount("error") > 0 && this.promiEvent.emit("error", o), o
            } else return e
        })
    }
}
        ...
        setImmediate(() => {
            oe(this, void 0, void 0, function*() {
                ...
                try {
                    ...
                    }), yield a.checkRevertBeforeSending(u), a.emitSending(u);
                    let d;
                    ...
                    a.emitSent(u), a.emitTransactionHash(l);
                    const f = yield ru(t, c, n), h = a.getReceiptWithEvents(I(Zn, f, n));
                    a.emitReceipt(h), s(yield a.handleResolve({
                        receipt: h,
                        tx: u
                    })), a.emitConfirmation({
                        receipt: h,
        ...
        setImmediate(() => {
            oe(this, void 0, void 0, function*() {
                ...
                try {
                    ...
                    yield a.checkRevertBeforeSending(p), a.emitSending(u);
                    ...
                    const y = yield ru(t, m, n), _ = a.getReceiptWithEvents(I(Zn, y, n));
                    a.emitReceipt(_), s(yield a.handleResolve({
                        receipt: _,
                        tx: c
                    })), a.emitConfirmation({
                        receipt: _,
...
function Jb(t, e, n, r) {
    ...
    return oe(this, void 0, void 0, function*() {
        ...
        if (typeof n == "number") throw new Gf(e, 'RPC method "eth_sign" does not support index signatures');
...
function Nu(t, e, n) {
    return oe(this, void 0, void 0, function*() {
        ...
        b(r) || (typeof r == "number" || typeof r == "bigint") && (r = He(r)), b(i) || (typeof i == "number" || typeof i == "bigint") && (i = He(i));
...
class $u extends Cr {
    ...
    _processSubscriptionResult(e) {
        if (typeof e == "boolean") this.emit("changed", e);
            ...
            this.emit("changed", e.syncing), this.emit("data", I($v, n, super.returnFormat))
        }
    }
}
...
const n_ = t => {
        if (!b(t.common)) {
            if (b(t.common.customChain)) throw new Vf;
            if (b(t.common.customChain.chainId)) throw new Wf;
            if (!b(t.chainId) && t.chainId !== t.common.customChain.chainId) throw new Zf({
                txChainId: t.chainId,
    ...
    r_ = t => {
        if (!b(t.common) && !b(t.chain) && !b(t.hardfork)) throw new Jf;
        if (!b(t.chain) && b(t.hardfork) || !b(t.hardfork) && b(t.chain)) throw new Yf({
            chain: t.chain,
            hardfork: t.hardfork
        })
    },
    i_ = t => {
        if (!b(t.common) && !b(t.common.baseChain) && !b(t.chain) && t.chain !== t.common.baseChain) throw new Kf({
            txChain: t.chain,
            baseChain: t.common.baseChain
        })
    },
    s_ = t => {
        if (!b(t.common) && !b(t.common.hardfork) && !b(t.hardfork) && t.hardfork !== t.common.hardfork) throw new Xf({
            txHardfork: t.hardfork,
            commonHardfork: t.common.hardfork
        })
    },
    tc = t => {
        if (b(t.gas) || !dn(t.gas) || b(t.gasPrice) || !dn(t.gasPrice)) throw new rh({
            gas: t.gas,
            gasPrice: t.gasPrice
        });
        if (!b(t.maxFeePerGas) || !b(t.maxPriorityFeePerGas)) throw new mc({
            maxFeePerGas: t.maxFeePerGas,
            maxPriorityFeePerGas: t.maxPriorityFeePerGas
        })
    },
    nc = t => {
        if (!b(t.gasPrice) && t.type === "0x2") throw new sh(t.gasPrice);
        if (t.type === "0x0" || t.type === "0x1") throw new mc({
            maxFeePerGas: t.maxFeePerGas,
            maxPriorityFeePerGas: t.maxPriorityFeePerGas
        });
        if (b(t.maxFeePerGas) || !dn(t.maxFeePerGas) || b(t.maxPriorityFeePerGas) || !dn(t.maxPriorityFeePerGas)) throw new ih({
            maxPriorityFeePerGas: t.maxPriorityFeePerGas,
            maxFeePerGas: t.maxFeePerGas
        })
    },
    o_ = t => {
        ...
        (n ? tc : nc)(t), (!b(t.type) && t.type > "0x1" ? nc : tc)(t)
    },
    a_ = (t, e) => {
        if (!b(e)) {
            e(t);
        ...
        if (typeof t != "object" || b(t)) throw new oh(t);
        n_(t), r_(t), i_(t), s_(t);
        const n = Le(t, U);
        if (o_(n), b(n.nonce) || b(n.chainId) || n.nonce.startsWith("-") || n.chainId.startsWith("-")) throw new ah({
            nonce: t.nonce,
            chainId: t.chainId
        })
    };
...
const d_ = t => {
    ...
    u_ = (t, e) => {
        ...
        let E;
        if (!S) e.defaultCommon ? (E = e.defaultCommon, b(E.hardfork) && (E.hardfork = (n = t.hardfork) !== null && n !== void 0 ? n : e.defaultHardfork), b(E.baseChain) && (E.baseChain = e.defaultChain)) : E = _e.custom({
            name: "custom-network",
    ...
    l_ = (t, e, n, r = !1, i = !0) => c_(void 0, void 0, void 0, function*() {
        ...
        return a_(o), hn.fromTxData(d_(o), u_(o, e))
    }),
    rc = ({
        address: t
    }, e, n) => {
        ...
        if (z(n == null ? void 0 : n.fromBlock) || (a.fromBlock = I(Ai.properties.number, n == null ? void 0 : n.fromBlock, {
                ...
                number: ze.HEX,
                bytes: wt.HEX
            })), s && Array.isArray(s)) a.topics = [...s];
        else if (a.topics = [], e && !e.anonymous && ![qn, "allEvents"].includes(e.name) && a.topics.push((i = e.signature) !== null && i !== void 0 ? i : Jo(mn(e))), ![qn, "allEvents"].includes(e.name) && e.inputs)
    ...
    or = (t, e, n) => {
        ...
        if (r !== e.length) throw new $e(`The number of arguments is not matching the methods required number. You need to pass ${r} arguments.`);
        const i = ns(Array.isArray(t.inputs) ? t.inputs : [], e).replace("0x", "");
        if (eb(t)) {
            if (!n) throw new $e("The contract has no contract data option set. This is necessary to append the constructor parameters.");
...
const os = (t, e, n, r) => {
        var i, s;
        const o = {};
        return (!z(t.data) || r === "both") && (o.data = or(e, n, (i = t.data) !== null && i !== void 0 ? i : t.input)), (!z(t.input) || r === "both") && (o.input = or(e, n, (s = t.input) !== null && s !== void 0 ? s : t.data)), z(o.input) && z(o.data) && (o[r] = or(e, n)), {
            data: o.data,
            input: o.input
        }
    },
    ic = ({
        ...
        var i, s, o;
        if (!((o = (s = (i = n == null ? void 0 : n.input) !== null && i !== void 0 ? i : n == null ? void 0 : n.data) !== null && s !== void 0 ? s : r.input) !== null && o !== void 0 ? o : r.data) && !(n != null && n.to) && !r.address) throw new $e("Contract address not specified");
        if (!(n != null && n.from) && !r.from) throw new $e('Contract "from" address not specified');
        let u = qt({
            to: r.address,
            gas: r.gas,
            gasPrice: r.gasPrice,
    ...
    h_ = ({
        ...
        if (!(n != null && n.to) && !r.address) throw new $e("Contract address not specified");
        let i = qt({
            to: r.address,
            gas: r.gas,
            gasPrice: r.gasPrice,
...
class rn extends Oe {
    constructor(e, n, r, i, s) {
        ...
        let l;
        if (typeof n == "object" && "provider" in n ? l = n.provider : typeof r == "object" && "provider" in r ? l = r.provider : typeof i == "object" && "provider" in i ? l = i.provider : l = rn.givenProvider, super(Object.assign(Object.assign({}, c), {
                provider: l,
                registeredSubscriptions: g_
            })), this.syncWithContext = !1, this._functions = {}, !b(d) && !b(d.data) && !b(d.input) && this.config.contractDataInputFill !== "both") throw new Mf({
            data: d.data,
            input: d.input
        });
        ...
        this.config.contractDataInputFill = (o = d == null ? void 0 : d.dataInputFill) !== null && o !== void 0 ? o : this.config.contractDataInputFill, this._parseAndSetJsonInterface(e, f), b(h) || this._parseAndSetAddress(h, f), this.options = {
            address: h,
        ...
        }, this.syncWithContext = (u = d == null ? void 0 : d.syncWithContext) !== null && u !== void 0 ? u : !1, c instanceof Oe && this.subscribeToContextEvents(c), Object.defineProperty(this.options, "address", {
    ...
    deploy(e) {
        ...
        if ((!o || o.trim() === "0x") && (!a || a.trim() === "0x")) throw new $e("contract creation without any data provided.");
    ...
    getPastEvents(e, n, r) {
        ...
        return Ct(this, void 0, void 0, function*() {
            ...
            if (!u) throw new $e(`Event ${s} not found.`);
            const {
                fromBlock: d,
                toBlock: c,
                topics: l,
                address: f
            } = rc(this.options, u, o ? ? {}), p = (yield Nu(this, {
                fromBlock: d,
                toBlock: c,
                topics: l,
                address: f
            }, a)).map(y => typeof y == "string" ? y : ea(u, y, this._jsonInterface, a)), m = (i = o == null ? void 0 : o.filter) !== null && i !== void 0 ? i : {}, g = Object.keys(m);
            return g.length > 0 ? p.filter(y => typeof y == "string" ? !0 : g.every(_ => {
                var w;
                if (Array.isArray(m[_])) return m[_].some(E => String(y.returnValues[_]).toUpperCase() === String(E).toUpperCase());
    ...
    _parseAndSetJsonInterface(e, n = O) {
        ...
        for (const l of d) {
            ...
            if (ts(f)) {
                const h = mn(f),
                    p = is(h);
                f.signature = p, f.constant = (i = (r = f.stateMutability === "view") !== null && r !== void 0 ? r : f.stateMutability === "pure") !== null && i !== void 0 ? i : f.constant, f.payable = (s = f.stateMutability === "payable") !== null && s !== void 0 ? s : f.payable, this._overloadedMethodAbis.set(f.name, [...(o = this._overloadedMethodAbis.get(f.name)) !== null && o !== void 0 ? o : [], f]);
                const m = (a = this._overloadedMethodAbis.get(f.name)) !== null && a !== void 0 ? a : [],
                    g = this._createContractMethod(m, c);
                this._functions[h] = {
                    signature: p,
                    method: g
                }, this._methods[f.name] = this._functions[h].method, this._methods[h] = this._functions[h].method, this._methods[p] = this._functions[h].method
            } else if (Xo(f)) {
                const h = mn(f),
                    p = Jo(h),
                    m = this._createContractEvent(f, n);
                f.signature = p, (!(h in this._events) || f.name === "bound") && (this._events[h] = m), this._events[f.name] = m, this._events[p] = m
            }
            u = [...u, f]
        }
        this._events.allEvents = this._createContractEvent(Js, n), this._jsonInterface = [...u], this._errorsInterface = c
    }
    _getAbiParams(e, n) {
        var r;
        try {
    ...
    _createContractMethod(e, n) {
        ...
        return (...i) => {
            ...
            if (u.length === 1 || l.length === 0) a = this._getAbiParams(d, i), H.validate((o = r.inputs) !== null && o !== void 0 ? o : [], a);
            else {
                const h = [];
                for (const p of l) try {
                    a = this._getAbiParams(p, i), H.validate(p.inputs, a), d = p;
                    break
                } catch (m) {
                    h.push(m)
                }
                if (h.length === l.length) throw new Hn(h)
            }
            const f = {
                arguments: a,
            ...
            return d.stateMutability === "payable", f
        }
    }
    _contractMethodCall(e, n, r, i, s) {
        ...
        return Ct(this, void 0, void 0, function*() {
            ...
            try {
                ...
                throw u instanceof Qt && Vr(r, u.innerError), u
            }
        })
    }
    ...
    _contractMethodDeploySend(e, n, r, i) {
        ...
        return so(this, u, O, {
            transactionResolver: d => {
                if (d.status === BigInt(0)) throw new $e("code couldn't be stored", d);
                const c = this.clone();
    ...
    _createContractEvent(e, n = O) {
        return (...r) => {
            ...
            const {
                topics: s,
                fromBlock: o
            } = rc(this.options, e, r[0]), a = new Hu({
    ...
    subscribeToContextEvents(e) {
        const n = this;
        this.context = e, n.syncWithContext && e.on(fn.CONFIG_CHANGE, r => {
            n.setConfig({
                [r.name]: r.newValue
            })
        })
...
class w_ {
    constructor(e, n) {
        this.contract = new rn(v_, n ? ? Ni.main, e), this.context = e
    }
    getOwner(e) {
        ...
        return Hr(this, void 0, void 0, function*() {
            try {
                return this.contract.methods.resolver(Yt(e)).call().then(n => {
                    if (typeof n == "string") return new rn(b_, n, this.context);
                    throw new Error
                })
            } catch {
                throw new Error
...
class x_ {
    ...
    checkInterfaceSupport(e, n) {
        var r, i;
        return Sn(this, void 0, void 0, function*() {
            if (z(oc[n])) throw new da((r = e.options.address) !== null && r !== void 0 ? r : "", n);
            if (!(yield e.methods.supportsInterface(oc[n]).call())) throw new da((i = e.options.address) !== null && i !== void 0 ? i : "", n)
        })
    }
    supportsInterface(e, n) {
        ...
        return Sn(this, void 0, void 0, function*() {
            ...
            let s = n;
            if (!se(s)) {
                if (s = (r = Br(n)) !== null && r !== void 0 ? r : "", n === "") throw new Error("Invalid interface Id");
                s = s.slice(0, 10)
            }
    ...
    getAddress(e, n = 60) {
        return Sn(this, void 0, void 0, function*() {
            ...
            return yield this.checkInterfaceSupport(r, Ss.addr), r.methods.addr(Yt(e), n).call()
        })
    }
    getPubkey(e) {
        return Sn(this, void 0, void 0, function*() {
            const n = yield this.getResolverContractAdapter(e);
            return yield this.checkInterfaceSupport(n, Ss.pubkey), n.methods.pubkey(Yt(e)).call()
        })
    }
    getContenthash(e) {
        return Sn(this, void 0, void 0, function*() {
            const n = yield this.getResolverContractAdapter(e);
            return yield this.checkInterfaceSupport(n, Ss.contenthash), n.methods.contenthash(Yt(e)).call()
        })
    }
}
...
class ju extends Oe {
    constructor(e, n) {
        super(n ? ? ""), this.registryAddress = e ? ? Ni.main, this._registry = new w_(this.getContextObject(), e), this._resolver = new x_(this._registry)
    }
    getResolver(e) {
    ...
    checkNetwork() {
        return ut(this, void 0, void 0, function*() {
            ...
            if (!this._lastSyncCheck || e - this._lastSyncCheck > 3600) {
                ...
                if (!(typeof i == "boolean" && !i)) throw new Hf;
...
const E_ = t => It(void 0, void 0, void 0, function*() {
    ...
    T_ = (t, e, n, r) => It(void 0, void 0, void 0, function*() {
        return H.validate(["address", "string", "uint"], [e, n, r]), xv(t, e, n, r)
    }),
    S_ = (t, e) => It(void 0, void 0, void 0, function*() {
        return H.validate(["address"], [e]), Ev(t, e)
    }),
    k_ = (t, e, n) => It(void 0, void 0, void 0, function*() {
        return H.validate(["string", "string"], [e, n]), Iv(t, e, n)
    }),
...
class ia extends Oe {
    constructor(e) {
        ...
        let r = {};
        typeof e == "string" || Ei(e) ? r.provider = e : e ? r = e : r = {}, r.registeredSubscriptions = Object.assign(Object.assign({}, oo), (n = r.registeredSubscriptions) !== null && n !== void 0 ? n : {}), super(r);
        const i = N_(this);
        this._wallet = i.wallet, this._accountProvider = i, this.utils = ud;
        const s = this;
        class o extends rn {
            constructor(d, c, l, f, h) {
                if (Ot(c) && Ot(l)) throw new ua("Should not provide options at both 2nd and 3rd parameters");
                let p, m = {},
                    g, y = O;
                if (!z(c) && typeof c != "object" && typeof c != "string") throw new ua;
                typeof c == "string" && (p = c), Ot(c) ? m = c : Ot(l) ? m = l : m = {}, c instanceof Oe ? g = c : l instanceof Oe ? g = l : f instanceof Oe ? g = f : g = s.getContextObject(), h ? y = h : ft(l) ? y = l : ft(f) && (y = f), super(d, p, m, g, y), super.subscribeToContextEvents(s)
            }
        }
        const a = s.use(ss);
